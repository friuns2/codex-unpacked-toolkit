import { g as Ge } from "./chunk-55IACEB6-D8dgPtuT.js";
import { s as ze } from "./chunk-QN33PNHL-C4LLq_9I.js";
import {
  a2 as f,
  a6 as Xe,
  a5 as Je,
...
var Ae = (function () {
  var e = f(function (P, i, n, c) {
    ...
    Se = {
      ...
      performAction: f(function (i, n, c, s, E, t, Ee) {
        var a = t.length - 1;
        switch (E) {
          case 4:
      ...
      table: [
        ...
        e(d, [2, 19]),
        e(d, [2, 20]),
        { 30: 60, 33: 62, 75: $, 89: p, 90: R },
        { 30: 63, 33: 62, 75: $, 89: p, 90: R },
        { 30: 64, 33: 62, 75: $, 89: p, 90: R },
        e(X, [2, 29]),
        e(X, [2, 30]),
        e(X, [2, 31]),
        e(X, [2, 32]),
        ...
        { 30: 94, 33: 62, 75: $, 76: U, 89: p, 90: R },
        { 5: [1, 95] },
        { 30: 96, 33: 62, 75: $, 89: p, 90: R },
        { 5: [1, 97] },
        { 30: 98, 33: 62, 75: $, 89: p, 90: R },
        { 63: [1, 99] },
        e(Y, [2, 50]),
        e(Y, [2, 51]),
        e(Y, [2, 52]),
            ...
            case 2:
              if (
                ...
                (Te = this.performAction.apply(
                  J,
                  [a, Pe, ye, G.yy, k[1], E, t].concat(Ke),
                )),
                typeof Te < "u")
              )
                return Te;
              (F &&
                ...
                E.push(J.$),
                t.push(J._$),
                (Ye = Ee[c[c.length - 2]][c[c.length - 1]]),
                c.push(Ye));
              break;
            case 3:
              return !0;
      ...
      var P = {
        ...
        unput: f(function (i) {
          ...
          return (
            ...
            this.options.ranges &&
              (this.yylloc.range = [E[0], E[0] + this.yyleng - n]),
...
` +
        ...
        next: f(function () {
          ...
          for (var E = this._currentRules(), t = 0; t < E.length; t++)
            if (
              ((c = this._input.match(this.rules[E[t]])),
              c && (!n || c[0].length > n[0].length))
            ) {
              if (((n = c), (s = t), this.options.backtrack_lexer)) {
                if (((i = this.test_match(c, E[t])), i !== !1)) return i;
                if (this._backtrack) {
                  n = !1;
                  continue;
                } else return !1;
          ...
          return n
            ? ((i = this.test_match(n, E[s])), i !== !1 ? i : !1)
            : this._input === ""
              ? this.EOF
              : this.parseError(
                  "Lexical error on line " +
...
` +
        ...
        performAction: f(function (n, c, s, E) {
          switch (s) {
            case 0:
              return "title";
            case 1:
...
//# sourceMappingURL=requirementDiagram-UZGBJVZJ-DofDcKGf.js.map
