const e = {
  ...
  "appSunset.body":
    "Diese App-Version wird nicht mehr unterstützt. Bitte lade <here>hier</here> die neueste Version herunter.",
  "appSunset.title": "Update erforderlich",
  "automation.updateDirective.create": "Erstellen",
  "automation.updateDirective.open": "Öffnen",
  "automation.updateDirective.untitled": "Unbenannte Automation",
  "automation.updateDirective.update": "Aktualisieren",
  "bestOfNIcon.attemptsTooltip":
    "{attempts, plural, one {# Versuch} other {# Versuche}}",
  ...
  "codeReviewAssistant.noFindings": "Es wurden keine Ergebnisse gemeldet.",
  "codex.alert.closeAriaLabel": "Schließen",
  "codex.appUpsellBanner.cbpApi.message":
    "Schneller entwickeln mit der Codex-App. Jetzt herunterladen oder {learnMoreLink}.",
  "codex.appUpsellBanner.download": "Herunterladen",
  "codex.appUpsellBanner.freeGo.message":
    "Codex ist bis zum 2. März in deinem Plan enthalten. Teste die Codex-App und entwickle schneller.",
  "codex.appUpsellBanner.later": "Später",
  "codex.appUpsellBanner.learnMoreLowercase": "mehr erfahren",
  "codex.appUpsellBanner.new": "Neu",
  "codex.appUpsellBanner.proPlusBusiness.message":
    "Teste die Codex-App bis zum 2. April mit doppelt so hohen Ratenlimits. Jetzt herunterladen oder {learnMoreLink}.",
  ...
  "codex.archiveInfo": "Archivierte Chats in {dataControlsLink} anzeigen.",
  "codex.archiveInfo.dataControlsLink": "Datenkontrollen",
  ...
  "codex.command.manageTasks": "Aufgaben verwalten",
  "codex.command.navigateBack": "Zurück",
  "codex.command.navigateForward": "Vorwärts",
  "codex.command.newThread": "Neuer Thread",
  "codex.command.nextThread": "Nächster Thread",
  "codex.command.openFolder": "Ordner öffnen",
  "codex.command.openSkills": "Zu Fähigkeiten gehen",
  "codex.command.openThreadOverlay": "Thread ausklappen",
  "codex.command.previousThread": "Vorheriger Thread",
  "codex.command.settings": "Einstellungen",
  "codex.command.toggleDiffPanel": "Diff-Panel umschalten",
  ...
  "codex.commandMenu.searchPlaceholder": "Suchbefehle",
  ...
  "codex.diffView.failedToDecodeBase64Diff":
    "base64-Diff konnte nicht dekodiert werden",
  ...
  "codex.diffView.noDiffData": "Keine Diff-Daten",
  ...
  "codex.localTaskRow.archiveTask": "Thread archivieren",
  ...
  "codex.loggedOut.cloudTasksDisabledWithCopilotAndApiKey":
    "Cloud-Aufgaben mit Copilot und API-Schlüssel deaktiviert",
  ...
  "codex.mcpTool.collapsedLabel.details": "{server} MCP {tool} Tool",
  "codex.mcpTool.collapsedLabel.verb.called": "Aufgerufen",
  "codex.mcpTool.collapsedLabel.verb.calling": "Wird aufgerufen",
  ...
  "codex.menu.recent": "Aktuell",
  "codex.menu.seeAllHistory": "Gesamten Verlauf ansehen",
  ...
  "codex.profileDropdown.enterBehavior":
    "{modifierSymbol} + Eingabetaste, um lange Prompts zu senden",
  ...
  "codex.profileDropdown.language": "Sprache",
  "codex.profileDropdown.languageDefault": "Automatisch erkennen",
  "codex.profileDropdown.languageSearchPlaceholder": "Sprachen suchen",
  "codex.profileDropdown.languageUpdateError":
    "Aktualisieren der Sprache fehlgeschlagen",
  "codex.profileDropdown.logOut": "Abmelden",
  "codex.profileDropdown.mcp": "MCP-Einstellungen",
  ...
  "codex.profileDropdown.openExtensionSettings": "Einstellungen öffnen",
  "codex.profileDropdown.openMcpSettings": "MCP-Einstellungen öffnen",
  "codex.profileDropdown.openOnStartup": "Beim Start öffnen",
  "codex.profileDropdown.openOnStartupError":
    "Aktualisieren der Einstellungen fehlgeschlagen",
  "codex.profileDropdown.openSkillsSettings": "Fähigkeitseinstellungen öffnen",
  "codex.profileDropdown.personalAccountTitle": "Persönliches Konto",
  "codex.profileDropdown.queueFollowUps":
    "Folgeaufforderungen in Warteschlange einreihen",
  "codex.profileDropdown.queueFollowUpsError":
    "Aktualisieren der Einstellungen fehlgeschlagen",
  "codex.profileDropdown.readDocs": "Dokumentation lesen",
  "codex.profileDropdown.readSkillsDocs": "Dokumentation lesen",
  "codex.profileDropdown.runInWsl": "In WSL ausführen",
  "codex.profileDropdown.runInWslError":
    "Aktualisieren der Einstellungen fehlgeschlagen",
  "codex.profileDropdown.runInWslTooltip":
    "Codex wird in WSL ausgeführt. Empfohlen für bessere Sandbox-Sicherheit und höhere Performance.",
  "codex.profileDropdown.settings": "IDE-Einstellungen",
  "codex.profileDropdown.settingsPage": "Einstellungen",
  "codex.profileDropdown.signInWithOpenAI": "Mit ChatGPT anmelden",
  "codex.profileDropdown.skills": "Fähigkeitseinstellungen",
  ...
  "codex.profileDropdown.todoCodelens": "TODO-Kommentare beheben",
  "codex.profileDropdown.todoCodelensError":
    "Aktualisieren der Einstellungen fehlgeschlagen",
  "codex.profileDropdown.windowsDocumentation": "Windows-Dokumentation",
  "codex.profileFooter.signedInFallback": "Angemeldet",
  ...
  "codex.recentTasksMenu.empty": "Noch keine Threads",
  ...
  "codex.remoteConversation.streaming": "Wird gestartet",
  ...
  "codex.review.diffTooLarge.description":
    "Dieser Diff ist zu groß, um ihn in der Überprüfung anzuzeigen.",
  "codex.review.diffTooLarge.title": "Diff ist zu groß zur Anzeige",
  "codex.review.expandOrCollapseDiffButton.collapse": "Alle Diffs einklappen",
  "codex.review.expandOrCollapseDiffButton.expand": "Alle Diffs ausklappen",
  ...
  "codex.review.fileSearch.clear": "Dateifilter löschen",
  "codex.review.fileSearch.empty":
    "Es gibt keine Dateien, die mit dem aktuellen Filter übereinstimmen.",
  "codex.review.fileSearch.label": "Dateien filtern",
  "codex.review.fileSearch.placeholder": "Dateien filtern...",
  "codex.review.filesChanged":
    "{num, plural, =0 {Keine Dateien geändert} one {# Datei geändert} other {# Dateien geändert}}",
  "codex.review.find.loadMore": "Weitere Übereinstimmungen laden",
  "codex.review.fullReview.hideFileTree": "Dateibaum ausblenden",
  "codex.review.fullReview.showFileTree": "Dateibaum einblenden",
  "codex.review.header.moreOptions": "Optionen überprüfen",
  "codex.review.largeDiff.banner":
    "Große Diff erkannt — Dateien werden nacheinander angezeigt",
  ...
  "codex.review.noDiff": "Dateiänderungen werden hier angezeigt",
  ...
  "codex.review.noDiff.gitRepoRequired.description":
    "Änderungen in diesem Projekt verfolgen und rückgängig machen",
  "codex.review.noDiff.gitRepoRequired.title": "Git-Repository erstellen",
  "codex.review.noDiff.orNoLongerAvailable":
    "oder•die•neuesten•Diffs•sind•nicht•mehr•verfügbar",
  "codex.review.noDiff.reverted": "Der letzte Schritt wurde rückgängig gemacht",
  "codex.review.noDiff.revertedOrCommitted":
    "Der letzte Durchlauf wurde entweder zurückgesetzt oder übernommen",
  ...
  "codex.review.source.local.all": "Alle Branch-Änderungen",
  "codex.review.source.local.lastTurn": "Änderungen der letzten Runde",
  "codex.review.source.local.uncommitted": "Nicht übernommene Änderungen",
  "codex.review.source.worktree": "Nicht committete Worktree-Änderungen",
  ...
  "codex.review.stageFilter.staged.count": "Gestagt: {count}",
  "codex.review.stageFilter.unstaged": "Nicht gestagt",
  "codex.review.stageFilter.unstaged.count": "Nicht gestagt: {count}",
  "codex.review.switchToSplit": "Zu geteiltem Diff wechseln",
  "codex.review.switchToUnified": "Zu Unified-Diff wechseln",
  "codex.review.toggleDiffView": "Diff-Ansicht umschalten",
  ...
  "codex.taskRow.title": "Neuer Thread",
  ...
  "codex.threadFindBar.label": "Im Thread suchen",
  "codex.threadFindBar.nextResult": "Nächstes Ergebnis",
  "codex.threadFindBar.noResults": "0 Ergebnisse",
  "codex.threadFindBar.placeholder": "Thread durchsuchen…",
  "codex.threadFindBar.placeholder.extension": "Thread durchsuchen…",
  ...
  "codex.unifiedDiff.revertPatchSuccess": "Änderungen zurückgesetzt",
  "codex.unifiedDiff.reviewChangesSuffix": "Änderungen",
  "codex.unifiedDiff.reviewShort": "Überprüfen",
  ...
  "codex.windowsInstallWslBanner.dismiss": "Verwerfen",
  "codex.windowsInstallWslBanner.installWslCta": "Sandbox aktivieren",
  "codex.windowsInstallWslBanner.learnMore": "Mehr erfahren",
  "codex.windowsSandboxBanner.content":
    "Der Agent-Modus verwendet unter Windows eine experimentelle Sandbox, um den Zugriff auf Dateisystem und Netzwerk einzuschränken. {sandboxLink}",
  "codex.windowsSandboxBanner.title": "Sandbox für den Agent-Modus aktivieren",
  "codex.windowsSubDropdown.windowsSandbox": "Windows Sandbox",
  "codex.windowsSubDropdown.windowsSettings": "Windows-Einstellungen",
  "codexUpgradeModal.body":
    "Codex wird jetzt von GPT-5.2-Codex unterstützt, unserem neuesten agentischen Frontier-Coding-Modell. Beim Programmieren ist es {link}; eine weitere Verbesserung gegenüber GPT-5.2.",
  "codexUpgradeModal.close": "Schließen",
  "codexUpgradeModal.image.altText": "GPT-5.2-Codex",
  "codexUpgradeModal.smarterAndFaster": "intelligenter und schneller",
  "codexUpgradeModal.title": "Codex hat soeben ein Upgrade erhalten",
  "codexUpgradeModal.tryNewModel": "GPT-5.2-Codex jetzt ausprobieren",
  ...
  "composer.attemptsSelector.option":
    "{count, plural, one {# Version} other {# Versionen}}",
  "composer.attemptsSelector.tooltip":
    "Anzahl der parallelen Versuche, die Codex ausführen soll",
  ...
  "composer.cloudTaskCreationError": "Fehler beim Erstellen der Cloud-Aufgabe",
  "composer.cloudTaskError": "Fehler beim Erstellen der Aufgabe",
  "composer.collaborationMode.code": "Code",
  "composer.collaborationMode.modelReasoning.editLabel":
    "Modell und Reasoning auswählen",
  "composer.collaborationMode.modelReasoning.title":
    "Modell und Reasoning für {mode}",
  "composer.collaborationMode.plan": "Plan",
  "composer.collaborationMode.reasoning.default": "Standard",
  "composer.collaborationMode.tooltip.line1": "{mode} verwendet {model}",
  "composer.collaborationMode.tooltip.line2": "mit {reasoningEffort}",
  "composer.contextWindow.autoCompactionTooltipLine1":
    "Codex komprimiert seinen Kontext automatisch.",
  ...
  "composer.dictation.tooltip": "Zum Diktieren halten",
  ...
  "composer.followerTooltip":
    "Um fortzufahren, kehre zu dem Fenster zurück, in dem dieses Gespräch gestartet wurde.",
  "composer.footer.branchSwitch.createDialog.ariaLabel": "Branch-Name",
  "composer.footer.branchSwitch.createDialog.branchName": "Branch-Name",
  ...
  "composer.localCwdDropdown.title": "Wähle dein Projekt aus.",
  "composer.localTaskError": "Fehler beim Starten des Gesprächs",
  ...
  "composer.mode.agentMode.changePermission": "Modus wechseln",
  "composer.mode.agentMode.custom": "Individuell",
  "composer.mode.agentMode.custom.dropdownLabel": "Individuell",
  "composer.mode.agentMode.custom.option": "Benutzerdefiniert (config.toml)",
  "composer.mode.agentMode.custom.optionLabel":
  ...
  "composer.mode.agentMode.fullAccess": "Agent (voller Zugriff)",
  "composer.mode.agentMode.fullAccess.dropdownLabel": "Agent (voller Zugriff)",
  "composer.mode.agentMode.fullAccess.optionLabel": "Agent (voller Zugriff)",
  "composer.mode.agentMode.fullAccessConfirm.caution":
    "Sei vorsichtig, wenn du vollen Zugriff aktivierst. Dadurch steigt das Risiko von Datenverlust, Lecks oder unerwartetem Verhalten deutlich.",
  ...
  "composer.mode.agentMode.fullAccessConfirm.description":
    "Wenn Codex mit vollem Zugriff läuft, kann es jede Datei auf deinem Computer bearbeiten und Befehle mit Netzwerk ausführen – ohne deine Genehmigung.",
  "composer.mode.agentMode.fullAccessConfirm.goBack": "Abbrechen",
  "composer.mode.agentMode.fullAccessConfirm.title":
    "Vollen Zugriff aktivieren?",
  ...
  "composer.mode.agentMode.tooltip": "Modus wechseln",
  "composer.mode.agentMode.tooltip.auto":
    "Dateien lesen und bearbeiten sowie Befehle ausführen.",
  "composer.mode.agentMode.tooltip.custom":
    "Die neuesten in der config.toml definierten Genehmigungs- und Sandbox-Richtlinien verwenden.",
  "composer.mode.agentMode.tooltip.fullAccess":
    "Codex kann Dateien außerhalb des Projekts bearbeiten und Befehle mit Netzwerkzugang ausführen. Gehe also vorsichtig vor.",
  "composer.mode.agentMode.tooltip.readOnly":
    "Erfordert Genehmigung zum Bearbeiten von Dateien und Ausführen von Befehlen.",
  ...
  "composer.mode.local.model.loadingModel": "Modell wird geladen",
  "composer.mode.local.model.selecrReasoningEffort": "Reasoning auswählen",
  "composer.mode.local.model.selectModel": "Modell auswählen",
  "composer.mode.local.model.tooltip": "Modell auswählen",
  ...
  "composer.mode.rateLimit.heading": "Verbleibende Ratenlimits",
  ...
  "composer.mode.rateLimit.weeklyDynamicTitle":
    "{weeks, plural, one {Wöchentlich} other {Woche {weeks}}}",
  ...
  "composer.newChat.heading.browser": "Was programmieren wir als Nächstes?",
  ...
  "composer.permissionsDropdown.fullAccess.disabled":
    "Vollzugriff ist durch requirements.toml deaktiviert.",
  ...
  "composer.placeholder.newTask.locally":
    "Frag Codex irgendetwas, @ zum Hinzufügen von Dateien, / für Befehle",
  "composer.planModeDropdown": "Planmodus",
  "composer.planModeDropdown.ariaLabel": "Planmodus",
  "composer.planModeIndicator": "Plan",
  "composer.planModeIndicator.tooltipShortcut": "Umschalt+Tab",
  "composer.planModeIndicator.tooltipText": "zum Umschalten",
  ...
  "composer.queuedMessage.sendNow": "Jetzt senden",
  "composer.queuedMessage.sendNowTooltip": "Jetzt senden",
  "composer.queuedMessage.turnOff": "Warteschlange deaktivieren",
  "composer.reasoningEffort.local.reasoning.tooltip":
    "Reasoning-Aufwand auswählen",
  ...
  "composer.remote.fromBranch": "von {branch}",
  "composer.remote.fromCurrentBranch": "Von {branch} (aktuell)",
  ...
  "composer.reviewMode.option.unsynced.simple":
    "Nicht synchronisierte Änderungen überprüfen",
  ...
  "composer.sandboxButton.windowsSandboxDialog.content":
    "Codex kann unter Windows eine experimentelle Sandbox verwenden, um den Zugriff auf Dateisystem und Netzwerk einzuschränken. {sandboxLink}",
  ...
  "composer.skillMentionList.loading": "Fähigkeiten werden geladen...",
  "composer.skillMentionList.noResults": "Keine Fähigkeiten gefunden",
  ...
  "composer.slashCommands.disabledTooltip":
    "Ein neues Gespräch starten, um Slash-Befehle zu verwenden",
  ...
  "composer.slashCommands.tooltip": "Slash-Befehle durchsuchen",
  ...
  "composer.statusSlashCommand.description":
    "Thread-ID,•Kontextnutzung•und•Ratenlimits•anzeigen",
  ...
  "composer.submit.emptyMessage": "Eine Nachricht eingeben, um zu beginnen",
  ...
  "composer.submit.unsavedComments":
    "Speichere oder verwirf {count, plural, one {deine Kommentaränderung} other {deine Kommentaränderungen}} vor dem Absenden.",
  ...
  "debug.childProcesses.age": "Alter {age}",
  "debug.childProcesses.empty": "Keine untergeordneten Git-Prozesse gefunden.",
  "debug.childProcesses.loading": "Untergeordnete Git-Prozesse werden geladen…",
  "debug.childProcesses.meta": "PID {pid} | Übergeordnet {parentPid}",
  "debug.childProcesses.missingCommand": "(Befehl nicht verfügbar)",
  "debug.childProcesses.title": "Untergeordnete Git-Prozesse ({count})",
  "debug.childProcesses.titleClosed": "Untergeordnete Git-Prozesse",
  "debug.entries.fallbackTitle": "Debug-Eintrag",
  "debug.onboarding.override.app": "App",
  "debug.onboarding.override.auto": "Autom.",
  "debug.onboarding.override.login": "Anmelden",
  "debug.onboarding.override.welcome": "Willkommen",
  "debug.onboarding.override.workspace": "Projekt",
  "debug.onboarding.state": "Auth: {auth} · Projekte: {workspaces}",
  "debug.onboarding.title": "Onboarding",
  "debug.roots.empty": "Keine Projekt-Roots",
  "debug.roots.title": "Projekt-Roots",
  "debug.sentry.appSessionId": "App-Sitzungs-ID",
  "debug.sentry.logs.export": "Exportieren",
  "debug.sentry.logs.export.scope.last7days": "Letzte 7 Tage",
  "debug.sentry.logs.export.scope.session": "Diese Sitzung",
  "debug.sentry.logs.export.scope.today": "Heutige Protokolle",
  "debug.sentry.logs.section.title": "Protokolle",
  "debug.sentry.section.title": "Diagnosen",
  "debug.sentry.testing.section.title": "Absturzberichte",
  "debug.triggerSentryTestError": "Testfehler senden",
  "debug.user.accountId": "Konto-ID",
  "debug.user.authMethod": "Authentifizierungsmethode",
  "debug.user.email": "E-Mail-Adresse",
  "debug.user.section.title": "Benutzer",
  "debug.user.userId": "Benutzer-ID",
  "debug.window.title": "Debugging",
  ...
  "electron.onboarding.login.chatgpt.continue": "Weiter mit ChatGPT",
  "electron.onboarding.login.devbox": "Mit Remote-SSH verbinden",
  "electron.onboarding.login.error": "Anmeldung fehlgeschlagen: {rawMessage}",
  "electron.onboarding.login.snake.start": "Snake spielen",
  "electron.onboarding.login.sshConfig.cancel": "Abbrechen",
  "electron.onboarding.login.sshConfig.continue": "Weiter",
  ...
  "electron.onboarding.login.subtitle":
    "Die beste Methode, mit Agenten zu arbeiten",
  ...
  "electron.onboarding.welcome.doubleLimits.description":
    "Zur Feier des Starts der Codex-App schenken wir dir bis zum 2. April doppelt so hohe Ratenlimits.",
  "electron.onboarding.welcome.freego.description":
    "Codex ist bis zum 2. März kostenlos in deinem Plan enthalten. Viel Spaß beim Coden!",
  ...
  "errorPage.list.downloadExtension":
    "Versuche, eine andere Version der Erweiterung herunterzuladen",
  ...
  "execApprovalRequest.reject": "Nein",
  ...
  "feedback.dialog.descriptionPlaceholder": "Beschreibe das Problem hier",
  "feedback.dialog.dismiss": "Verwerfen",
  "feedback.dialog.includeLogsLabel":
    "Aktuelle Codex-Sitzungsprotokolle einbeziehen",
  "feedback.dialog.submit": "Absenden",
  ...
  "feedback.dialog.uploadedMessage.noThread":
    "Feedback hochgeladen. Wenn das Problem weiterhin besteht, bitte {openIssueLink} oder auf {existingIssueLink} kommentieren.",
  "feedback.dialog.uploadedMessage.openIssue": "GitHub-Problem öffnen",
  "feedback.dialog.uploadedMessage.withThread":
    "Feedback hochgeladen. Wenn das Problem weiterhin besteht, bitte {openIssueLink} oder Thread-ID in einem {existingIssueLink} angeben:",
  ...
  "home.hero.letsBuild": "Viel Spaß beim Coden",
  "homePage.mainContent": "Hauptinhalte",
  "imageAttachment.defaultName": "Bild",
  "imageAttachment.preview.close": "Bildvorschau schließen",
  ...
  "inbox.archived.deleteError":
    "Archivierter Run konnte nicht gelöscht werden.",
  "inbox.archived.deleteRun": "Archivierten Run löschen",
  "inbox.archived.inlineLabel.auto":
    "Dieser Thread wurde automatisch archiviert. <learnMoreLink>Mehr erfahren</learnMoreLink>",
  "inbox.archived.inlineLabel.manual": "Dieser Thread wurde archiviert.",
  "inbox.archived.noMessageFound": "Keine Nachricht gefunden",
  ...
  "inbox.automations.deleteConfirm.description":
    "Dadurch wird die Automatisierung dauerhaft gelöscht und zukünftige Läufe gestoppt.",
  ...
  "inbox.automations.new": "Neu",
  "inbox.automations.newToolbar": "Neue Automatisierung",
  "inbox.automations.pauseTooltip": "Automatisierung anhalten",
  "inbox.automations.resumeTooltip": "Automatisierung wieder aufnehmen",
  "inbox.automations.startingNow": "Jetzt starten",
  "inbox.automations.startsIn": "Startet in {startTime}",
  "inbox.automations.status.active": "Aktiv",
  "inbox.automations.status.paused": "Angehalten",
  "inbox.automations.status.runs": "{count} Läufe",
  "inbox.automations.status.started": "Gestartet am {date}",
  "inbox.automations.updateError":
    "Automatisierung konnte nicht aktualisiert werden",
  "inbox.automations.workspaceFallback": "–",
  "inbox.filter.all": "Alle",
  "inbox.filter.ariaLabel": "Posteingangselemente filtern",
  "inbox.filter.unread": "Ungelesene",
  "inbox.list.archived": "Archiviert",
  "inbox.list.inProgress": "In Bearbeitung",
  "inbox.list.recent": "Aktuell",
  "inbox.list.upNext": "Als Nächstes",
  "inbox.mode.automations": "Automatisierungen",
  "inbox.mode.automations.beta": "Beta",
  "inbox.noDescription": "Keine Beschreibung vorhanden",
  "inbox.openThread": "Thread öffnen",
  "inbox.rightPanel.emptySubtitle":
    "Arbeit automatisieren, indem du geplante Aufgaben einrichtest",
  "inbox.rightPanel.emptyTasksTitle.activeCount":
    "{count, plural, one {# aktive Automatisierung} other {# aktive Automatisierungen}}",
  "inbox.rightPanel.emptyTasksTitle.noneUnread":
    "Keine ungelesenen Automatisierungen",
  "inbox.rightPanel.emptyTasksTitle.unreadCount":
    "{count, plural, one {# ungelesene Automatisierung} other {# ungelesene Automatisierungen}}",
  "inbox.rightPanel.emptyTitle": "Kein Element ausgewählt",
  "inbox.rightPanel.noThread": "Kein Thread für dieses Element",
  "inbox.untitled": "Unbenanntes Posteingangselement",
  ...
  "loadingPage.errorDescription.documentation":
    "Klicke auf „Neu laden“, um die Codex-Erweiterung neu zu starten, oder besuche unsere {documentationLink} für zusätzliche Hilfe.",
  ...
  "localConversation.contextCompacted": "Kontext automatisch komprimiert",
  "localConversation.contextCompacting": "Kontext wird automatisch komprimiert",
  "localConversation.merge.autoResolve.failed":
    "Anfrage zur automatischen Behebung fehlgeschlagen: {error}",
  "localConversation.merge.autoResolve.sent":
    "Anfrage zur automatischen Behebung gesendet",
  "localConversation.merge.autoResolveMerge.missingConversation":
    "Automatische Behebung ohne aktives Gespräch nicht möglich.",
  "localConversation.merge.autoResolveMerge.request":
    "Zusammenführungskonflikte automatisch beheben",
  ...
  "localConversation.sync.buttonLabel": "An lokal übergeben",
  "localConversation.sync.modal.loading.title": "Änderungen werden übergeben…",
  "localConversation.sync.modal.noChanges": "Keine Änderungen",
  "localConversation.syncSetup.branchAriaLabel": "Branch-Name",
  "localConversation.syncSetup.branchName": "Branch-Name",
  "localConversation.syncSetup.branchPlaceholder.existing":
    "Bestehenden Branch auswählen",
  "localConversation.syncSetup.branchPlaceholder.new": "codex/neue-funktion",
  "localConversation.syncSetup.branchesLoading": "Branches werden geladen…",
  "localConversation.syncSetup.checkoutAlreadyCheckedOut":
    "Bereits ausgecheckt",
  "localConversation.syncSetup.checkoutClean": "Aktuell in {branchName}",
  "localConversation.syncSetup.checkoutDirty":
    "Derzeit auf {branchName} mit nicht committeten Änderungen",
  "localConversation.syncSetup.checkoutError":
    "Branch konnte nicht ausgecheckt werden: {message}",
  "localConversation.syncSetup.checkoutLabel": "Jetzt lokal auschecken",
  "localConversation.syncSetup.checkoutOnLocal": "An lokal übergeben",
  "localConversation.syncSetup.checkoutPending": "Lokaler Status wird geprüft…",
  "localConversation.syncSetup.checkoutUnavailable":
    "Lokaler Workspace nicht verfügbar",
  "localConversation.syncSetup.checkoutUnknown":
    "Lokaler Branch nicht verfügbar",
  "localConversation.syncSetup.continue": "Weiter",
  "localConversation.syncSetup.createBranchError":
    "Übergabe-Branch konnte nicht festgelegt werden: {message}",
  "localConversation.syncSetup.error": "Etwas hat nicht geklappt: {message}",
  "localConversation.syncSetup.error.workingTreeMissing":
    "Worktree-Snapshot konnte nicht erstellt werden. Bitte versuche die Übergabe erneut.",
  "localConversation.syncSetup.mode.ariaLabel": "Branch-Modus auswählen",
  "localConversation.syncSetup.mode.existing": "Bestehender Branch",
  "localConversation.syncSetup.mode.new": "Neuer Branch",
  "localConversation.syncSetup.noBranches": "Keine Branches gefunden",
  "localConversation.syncSetup.overwriteError":
    "Der Branch wurde erstellt, aber nicht vollständig übergeben. Übergib ihn manuell, bevor du ihn lokal auscheckst.",
  "localConversation.syncSetup.setPrefix": "Präfix festlegen",
  "localConversation.syncSetup.success.checkedOut":
    "Branch wurde erstellt und lokal ausgecheckt",
  "localConversation.syncSetup.success.notCheckedOut": "Branch erstellt",
  "localConversation.syncSetup.title": "An einen lokalen Branch übergeben",
  "localConversation.syncWorktreeError.branchAriaLabel": "Branch-Name",
  "localConversation.syncWorktreeError.branchPlaceholder.new":
    "codex/neue-funktion",
  "localConversation.syncWorktreeError.branchSetup.subtitle":
    "Wähle einen Branch für die Übergabe und lade die Änderungen erneut.",
  ...
  "localConversation.syncWorktreeError.branchUpdate.error":
    "Branch konnte nicht aktualisiert werden: {message}",
  "localConversation.syncWorktreeError.branchUpdate.unknown":
    "Etwas hat nicht geklappt: {message}",
  "localConversation.syncWorktreeV2.apply.disabled.noCheckout":
    "Der Branch ist in keinem Worktree ausgecheckt.",
  "localConversation.syncWorktreeV2.applyUncommitted": "Übernehmen",
  "localConversation.syncWorktreeV2.applyUncommitted.disabled":
    "Du musst den Branch lokal auschecken, um nicht committete Änderungen anzuwenden.",
  "localConversation.syncWorktreeV2.branches.empty": "Keine Branches gefunden",
  ...
  "localConversation.syncWorktreeV2.changeBranch.ariaLabel":
    "Übergabe-Branch ändern",
  "localConversation.syncWorktreeV2.changeBranch.error":
    "Übergabe-Branch konnte nicht geändert werden: {message}",
  ...
  "localConversation.syncWorktreeV2.commandError.action.overwrite-local-to-worktree":
    "Worktree konnte nicht überschrieben werden",
  "localConversation.syncWorktreeV2.commandError.action.overwrite-worktree-to-local":
    "Lokale Version konnte nicht überschrieben werden",
  "localConversation.syncWorktreeV2.commandError.back": "Zurück",
  "localConversation.syncWorktreeV2.commandError.body":
    "Während der Übergabe ist ein Git-Befehl fehlgeschlagen. Überprüfe den Output und versuche es erneut.",
  "localConversation.syncWorktreeV2.commandError.retry": "Erneut versuchen",
  "localConversation.syncWorktreeV2.description":
    "Änderungen zwischen lokal und diesem Worktree übergeben. <a>Mehr erfahren</a>.",
  "localConversation.syncWorktreeV2.direction.ariaLabel":
    "Übergaberichtung auswählen",
  "localConversation.syncWorktreeV2.error.generic":
    "Bei der Übergabe ist ein Fehler aufgetreten. Bitte versuche es erneut.",
  "localConversation.syncWorktreeV2.localBranchLabel": "Lokal",
  "localConversation.syncWorktreeV2.noChanges": "Änderungen werden berechnet",
  "localConversation.syncWorktreeV2.noChanges.summary": "Keine Änderungen",
  ...
  "localConversation.syncWorktreeV2.partial.action.overwriteLocalFailed":
    "Lokale Änderungen konnten nicht überschrieben werden",
  "localConversation.syncWorktreeV2.partial.action.overwriteWorktreeFailed":
    "Worktree-Änderungen konnten nicht überschrieben werden",
  "localConversation.syncWorktreeV2.partial.appliedLabel": "Angewendet",
  "localConversation.syncWorktreeV2.partial.back": "Zurück",
  "localConversation.syncWorktreeV2.partial.body.resolveConflicts":
    "Konflikte beheben und erneut versuchen.",
  "localConversation.syncWorktreeV2.partial.conflictsLabel": "Konflikte",
  "localConversation.syncWorktreeV2.partial.fileCount":
    "{count, plural, one {# Datei} other {# Dateien}}",
  "localConversation.syncWorktreeV2.partial.retry": "Erneut versuchen",
  "localConversation.syncWorktreeV2.partial.skippedLabel": "Übersprungen",
  "localConversation.syncWorktreeV2.stateFailed.generic":
    "Beim Laden der Worktree-Änderungen für die Übergabe ist ein Fehler aufgetreten. Bitte versuche es erneut.",
  "localConversation.syncWorktreeV2.stateFailed.title":
    "Worktree-Änderungen konnten nicht geladen werden",
  "localConversation.syncWorktreeV2.statusError.diffUnknown":
    "Worktree-Änderungen konnten nicht geladen werden.",
  "localConversation.syncWorktreeV2.statusError.retry": "Erneut versuchen",
  "localConversation.syncWorktreeV2.statusError.title":
    "Lokale Branch-Änderungen konnten nicht geladen werden",
  "localConversation.syncWorktreeV2.statusError.unknown":
    "Der Branch-Status ist derzeit nicht verfügbar. Bitte versuche es erneut.",
  "localConversation.syncWorktreeV2.success.apply":
    "Änderungen erfolgreich angewendet",
  "localConversation.syncWorktreeV2.success.overwrite": "Übergabe erfolgreich",
  "localConversation.syncWorktreeV2.title": "Änderungen übergeben",
  ...
  "localConversation.userInputRequest.summary.asked": "Stellte",
  ...
  "localConversation.worktreeBranchSetup.createBranchError":
    "Branch konnte nicht festgelegt werden: {message}",
  "localConversation.worktreeBranchSetup.error":
    "Etwas hat nicht geklappt: {message}",
  "localConversation.worktreeBranchSetup.title": "Branch erstellen",
  "localConversationPage.addWorktreeToSidebar.tooltip":
    "Als Projekt speichern, um von diesem Worktree neue Threads zu starten",
  ...
  "localConversationPage.commitAndCreatePrModal.errorTitle":
    "Committen und PR erstellen fehlgeschlagen",
  "localConversationPage.commitAndCreatePrModal.successTitle":
    "Commit durchgeführt und PR erstellt",
  "localConversationPage.commitAndPushModal.errorTitle":
    "Committen und Pushen fehlgeschlagen",
  "localConversationPage.commitAndPushModal.successTitle":
    "Commit durchgeführt und Änderungen gepusht",
  "localConversationPage.commitCreatePr.open": "Pull Request öffnen",
  "localConversationPage.commitCreatePr.successTitle":
    "PR mit deinen neuesten Änderungen erstellt",
  "localConversationPage.createBranchButtonLabel": "Branch erstellen",
  "localConversationPage.createPrModal.baseBranch": "Basis",
  ...
  "localConversationPage.createPrModal.createDescription":
    "Öffnet einen Pull Request für deine neuesten Änderungen.",
  ...
  "localConversationPage.createPrModal.successTitle": "Pull Request erstellt",
  ...
  "localConversationPage.generatePullRequestMessageFailed":
    "Titel und Beschreibung für den Pull Request konnten nicht generiert werden.",
  "localConversationPage.gitActionResult.branch": "Branch",
  "localConversationPage.gitActionResult.cancel": "Abbrechen",
  "localConversationPage.gitActionResult.close": "Schließen",
  "localConversationPage.gitActionResult.tryAgain": "Erneut versuchen",
  "localConversationPage.gitActions": "Git-Aktionen",
  "localConversationPage.newChat": "Neuer Chat",
  "localConversationPage.openInTarget": "Öffnen in",
  "localConversationPage.openPrimaryTarget": "Öffnen",
  ...
  "localConversationPage.pushModal.cancel": "Abbrechen",
  "localConversationPage.pushModal.confirm": "Push",
  "localConversationPage.pushModal.description":
    "Pushe deine neuesten Commits ins Remote-Repository.",
  "localConversationPage.pushModal.errorTitle": "Push fehlgeschlagen",
  "localConversationPage.pushModal.forcePush": "Force-Push",
  "localConversationPage.pushModal.successTitle": "Push abgeschlossen",
  "localConversationPage.pushModal.title": "Änderungen pushen",
  "localConversationPage.pushModal.tryAgain": "Erneut versuchen",
  "localConversationPage.pushNoUpstream":
    "Upstream festlegen, bevor du diesen Branch pushst",
  "localConversationPage.pushNoUpstreamError":
    "Push fehlgeschlagen: kein Upstream konfiguriert",
  "localConversationPage.pushNothingToPush": "Keine neuen Commits zum Pushen",
  "localConversationPage.pushRemoteChangedError":
    "Push fehlgeschlagen: Remote hat neue Commits",
  ...
  "localConversationPage.pushSuccessToast": "Gepushte Änderungen",
  "localConversationPage.viewPullRequestButtonLabel": "PR anzeigen",
  ...
  "localConversationTurn.exploration.accordion.count.files":
    "<countText>{count, plural, one {# Datei} other {# Dateien}}</countText> verliert",
  "localConversationTurn.exploration.accordion.count.lists":
    "<countText>{count, plural, one {# Liste} other {# Listen}}</countText> verliert",
  "localConversationTurn.exploration.accordion.count.searches":
    "<countText>{count, plural, one {# Suche} other {# Suchen}}</countText> verliert",
  ...
  "localTaskRow.resumeError": "Aufgabe konnte nicht fortgesetzt werden",
  ...
  "patchApprovalRequest.approve": "Genehmigen",
  ...
  "patchApprovalRequest.reject": "Nein",
  "patchApprovalRequest.waitingForApproval":
    "Warte auf Genehmigung zum Bearbeiten von Dateien",
  "pendingRequest.approvalExec.collapse": "Reduzieren",
  "pendingRequest.approvalExec.expand": "Erweitern",
  "pendingRequestStory.toastAnswer": "Antwort: {answer}",
  "pendingRequestStory.toastApprovalTitle": "Genehmigungsantwort",
  "pendingRequestStory.toastNoAnswers": "Keine Antworten angegeben",
  "pendingRequestStory.toastQuestion": "Frage: {question}",
  "pendingRequestStory.toastUnknownDecision": "Unbekannt",
  "pendingRequestStory.toastUserInputTitle": "Abgesendete Antworten",
  "quickAction.request.codeReview.branches.new":
    "Bitte überprüfe die Änderungen an {from} im Vergleich zu {to}",
  "quickAction.request.codeReview.uncommitted.new":
    "Bitte überprüfe meine nicht übernommenen Änderungen",
  ...
  "recentConversations.title": "Letzte Gespräche",
  ...
  "review.commit.ariaLabel.includeUnstaged":
    "Nicht gestagete Änderungen einbeziehen",
  ...
  "review.commit.disabled.missingContext":
    "Füge etwas Kontext hinzu, um eine Commit-Nachricht zu generieren.",
  "review.commit.disabled.noChanges": "Keine Änderungen zum Committen",
  "review.commit.disabled.noSelection": "Änderungen zum Committen auswählen",
  ...
  "review.commit.loading.description":
    "Einen Moment bitte, das kann ein paar Augenblicke dauern...",
  "review.commit.loading.step.commit.done": "Änderungen",
  "review.commit.loading.step.commit.pending": "Änderungen werden committet...",
  "review.commit.loading.step.createPr.done": "Pull Request erstellt",
  "review.commit.loading.step.createPr.pending": "Pull Request wird erstellt…",
  "review.commit.loading.step.push.done": "Auf Branch {branch} gepusht",
  "review.commit.loading.step.push.pending":
    "Wird auf Branch {branch} gepusht...",
  "review.commit.loading.title.commit": "Änderungen werden committet...",
  "review.commit.loading.title.createPr": "PR wird erstellt...",
  "review.commit.loading.title.push": "Änderungen werden gepusht...",
  "review.commit.messageLabel": "Commit-Nachricht",
  "review.commit.messagePlaceholder":
    "Leer lassen, um automatisch eine Commit-Nachricht zu erstellen",
  ...
  "review.commit.nextSteps.prRequiresGh": "Benötigt GitHub CLI: {command}",
  "review.commit.rows.changes": "Änderungen",
  "review.commit.rows.commitCount":
    "{count, plural, one {# Commit} other {# Commits}}",
  "review.commit.rows.commitCount.withUncommitted":
    "{count, plural, one {# Commit} other {# Commits}} und {stats}",
  "review.commit.rows.fileCount":
    "{count, plural, one {# Datei} other {# Dateien}}",
  "review.commit.state.error.body":
    "Beim Committen ist etwas schiefgelaufen. Überprüfe deinen Git-Status und versuche es erneut.",
  "review.commit.state.error.title": "Commit fehlgeschlagen",
  "review.commit.state.success.title": "Änderungen committet",
  "review.commit.untracked.loadingStats":
    "Nicht verfolgte Diff-Statistiken werden geladen…",
  ...
  "settings.automations.dialog.subtitle":
    "Automatisiere wiederkehrende Aufgaben im Hintergrund. Codex fügt die Ergebnisse dem Posteingang hinzu oder archiviert die Aufgabe automatisch, wenn es nichts zu berichten gibt. <learnMoreLink>Mehr erfahren</learnMoreLink>",
  "settings.automations.dialog.title": "Automatisierung erstellen",
  "settings.automations.executionCopy.git":
    "Automatisierungen laufen im Hintergrund auf dedizierten Worktrees.",
  "settings.automations.executionCopy.nonGit":
    "Automatisierungen in Projekten ohne Versionskontrolle laufen direkt im Projektverzeichnis. Erwäge die Verwendung von Git, um die Ausführung auf Hintergrund-Worktrees zu ermöglichen.",
  "settings.automations.loading": "Wird geladen...",
  "settings.automations.nameLabel": "Name",
  "settings.automations.namePlaceholder": "Nach Sentry-Problemen suchen",
  "settings.automations.pause": "Anhalten",
  "settings.automations.promptLabel": "Prompt",
  "settings.automations.promptPlaceholder": "Nach Abstürzen in $Sentry suchen",
  "settings.automations.resume": "Fortsetzen",
  "settings.automations.rruleSummaryFallback": "Individueller Zeitplan",
  "settings.automations.runNow": "Test",
  ...
  "settings.automations.scheduleHeader": "Zeitplan",
  "settings.automations.scheduleHours": "Stunden",
  "settings.automations.scheduleLabel": "Ausführen alle",
  ...
  "settings.automations.scheduleSummary.singleDay": "{day} um {time}",
  ...
  "settings.automations.scheduleWeekdays": "Ein",
  "settings.automations.weekdayState.excluded": "Ausgeschlossen",
  "settings.automations.weekdayState.included": "Eingeschlossen",
  "settings.conversationDetail.steps": "Schritte",
  "settings.conversationDetail.steps.description":
    "Befehle und Output ausblenden",
  "settings.conversationDetail.stepsWithCommands": "Schritte mit Code-Befehlen",
  "settings.conversationDetail.stepsWithCommands.description":
    "Befehle anzeigen, Output reduzieren",
  "settings.conversationDetail.stepsWithOutput": "Schritte mit Code-Output",
  "settings.conversationDetail.stepsWithOutput.description":
    "Befehle anzeigen, Output ausklappen",
  ...
  "settings.dataControls.archivedChats.unarchiveSuccess":
    "Thread dearchivieren. <viewNowLink>Jetzt anzeigen</viewNowLink>",
  ...
  "settings.general.appearance": "Aussehen",
  "settings.general.appearance.codeFont": "Code-Schriftart",
  "settings.general.appearance.codeFont.description":
    "Passe Schriftart und -größe für Code in Chats und Diffs an.",
  "settings.general.appearance.codeFontFamily": "Code-Schriftart",
  ...
  "settings.general.appearance.opaqueWindows.description":
    "Fenster mit solidem Hintergrund statt System-Transparenz verwenden",
  "settings.general.appearance.opaqueWindows.label":
    "Undurchsichtigen Fensterhintergrund verwenden",
  "settings.general.appearance.sansFontFamily": "Schriftfamilie Sans-Serif",
  "settings.general.appearance.sansFontFamily.description":
    "Ändere die Schriftart für die Codex-UI.",
  ...
  "settings.general.enterBehavior.description":
    "Wenn aktiviert, müssen mehrzeilige Prompts mit {modifierSymbol} + Eingabtaste gesendet werden.",
  ...
  "settings.general.followUpQueueMode.description":
    "Folgeaufforderungen in Warteschlange einreihen, während Codex läuft, oder den aktuellen Ablauf unterbrechen",
  "settings.general.followUpQueueMode.interrupt": "Unterbrechen",
  ...
  "settings.general.power.preventSleepWhileRunning.description":
    "Halte deinen Computer aktiv, während Codex einen Thread ausführt.",
  ...
  "settings.git.prInstructions.description":
    "Wird an die von Codex erstellten Pull-Request-Beschreibungen angehängt",
  ...
  "settings.localEnvironments.actions.empty":
    "Füge eine Aktion hinzu, um Befehle aus der lokalen Symbolleiste auszuführen.",
  ...
  "settings.localEnvironments.environment.actions.description":
    "Diese Aktionen können beliebige Befehle ausführen und werden in der Kopfzeile angezeigt.",
  ...
  "settings.localEnvironments.environment.setup.hint":
    "Wird im Projekt-Root ausgeführt.",
  ...
  "settings.localEnvironments.environment.setup.platformOverrides.add":
    "{platform}-Einrichtungsskript hinzufügen",
  ...
  "settings.localEnvironments.environment.setup.platformOverrides.remove":
    "Entfernen",
  "settings.localEnvironments.environment.setup.script": "Skript",
  "settings.localEnvironments.environment.title": "Umgebungsdetails",
  "settings.localEnvironments.file.missing":
    "Speichere die Datei, um sie erstmalig zu erstellen.",
  ...
  "settings.localEnvironments.file.path": "Datei: {path}",
  "settings.localEnvironments.file.readError":
    "Lokale Umgebungsdaten konnten nicht geladen werden. ({error})",
  "settings.localEnvironments.file.title": "Lokale Umgebungsdatei",
  ...
  "settings.localEnvironments.save.disabled.name":
    "Zum Speichern Umgebungsnamen eingeben",
  ...
  "settings.mcp.empty": "Keine individuellen MCP-Server verbunden",
  "settings.mcp.myServers": "Individuelle Server",
  "settings.mcp.partnerServer.description.figma":
    "Erstelle besseren Code, indem du den vollständigen Figma-Kontext einbindest",
  "settings.mcp.partnerServer.description.github":
    "Integriere GitHub-APIs, um Arbeitsabläufe zu automatisieren und Daten zu extrahieren",
  "settings.mcp.partnerServer.description.linear":
    "Integriere Linears Problemverfolgung und Projektmanagement.",
  "settings.mcp.partnerServer.description.notion":
    "Lies die Dokumentation, aktualisiere Seiten und manage Aufgaben.",
  "settings.mcp.partnerServer.description.playwright":
    "Integriere Browser-Automation, um Design und UI zu implementieren und zu testen.",
  "settings.mcp.partnerServer.install": "Installieren",
  "settings.mcp.partnerServer.installAndAuthenticate":
    "Installieren und authentifizieren",
  "settings.mcp.partnerServer.logoAlt": "{label}-Logo",
  "settings.mcp.partnerServer.vendor": "von {vendor}",
  "settings.mcp.recommendedServers": "Empfohlene Server",
  ...
  "settings.multiselect.createOption": "„{value}“ erstellen",
  "settings.multiselect.removeOption": "Entfernen",
  ...
  "settings.nav.data-controls": "Archivierte Threads",
  ...
  "settings.nav.usage-analytics": "Nutzung und Analyse",
  ...
  "settings.personalization.agents.description":
    "Anweisungen bearbeiten, die Codex auf dich zuschneiden. {learnMore}",
  "settings.personalization.agents.learnMore": "Mehr erfahren",
  ...
  "settings.section.data-controls": "Archivierte Threads",
  ...
  "settings.section.mcp-settings.docs": "Dokumente",
  ...
  "settings.section.unavailable": "Noch nicht in Alpha verfügbar",
  "settings.section.usage-analytics": "Nutzung und Analyse",
  "settings.section.worktrees": "Worktrees",
  "settings.threadDetail.description":
    "Wähle aus, wie viel Befehlsoutput in Threads angezeigt wird.",
  "settings.threadDetail.label": "Thread-Details",
  ...
  "settings.worktrees.error.retry": "Erneut versuchen",
  ...
  "sidebarElectron.addWorkspaceRoot": "Neues Projekt hinzufügen",
  "sidebarElectron.archiveThread": "Thread archivieren",
  "sidebarElectron.archiveThreadError":
    "Archivieren des Threads fehlgeschlagen",
  "sidebarElectron.collapseFolder": "Ordner einklappen",
  "sidebarElectron.debugNavLink": "Debugging",
  "sidebarElectron.editWorkspaceRootOptionName": "Namen bearbeiten",
  "sidebarElectron.expandFolder": "Ordner ausklappen",
  "sidebarElectron.groupByMenu.recency": "Chronologische Liste",
  "sidebarElectron.groupByMenu.title": "Organisieren",
  ...
  "sidebarElectron.newThread": "Neuer Thread",
  "sidebarElectron.newThreadInGroup": "Neuen Thread in {folder} beginnen",
  "sidebarElectron.noRecentThreads": "Keine aktuellen Threads",
  "sidebarElectron.noTasks": "Keine Threads",
  "sidebarElectron.noTasks.start": "Neues Projekt hinzufügen",
  "sidebarElectron.noTasksWithFilter": "Keine Threads entsprechen den Filtern.",
  "sidebarElectron.pinnedThreads": "Angeheftete Threads",
  "sidebarElectron.recentNavLink": "Threads",
  "sidebarElectron.recentThreads": "Aktuelle Threads",
  "sidebarElectron.removeWorkspaceRootOption": "Entfernen",
  "sidebarElectron.renameThread": "Thread umbenennen",
  "sidebarElectron.renameThreadDialogAriaLabel": "Thread-Titel",
  ...
  "sidebarElectron.renameThreadDialogTitle": "Thread umbenennen",
  "sidebarElectron.renameThreadError": "Umbenennen des Threads fehlgeschlagen",
  "sidebarElectron.renameWorkspaceRootOptionLabel": "Anzeigename",
  "sidebarElectron.showLess": "Weniger anzeigen",
  "sidebarElectron.showMenu.all": "Alle Threads",
  "sidebarElectron.showMenu.relevant": "Relevant",
  "sidebarElectron.showMenu.relevantHint":
    "Nur aktuelle Threads für den aktuellen Branch, Worktrees oder andere relevante Threads anzeigen",
  "sidebarElectron.showMenu.title": "Anzeigen",
  "sidebarElectron.showMenu.trigger": "Threads in der Seitenleiste filtern",
  ...
  "skills.card.try": "Ausprobieren",
  "skills.card.trySkill": "Fähigkeit testen",
  "skills.card.uninstall": "Deinstallieren",
  "skills.hero.dotLabel": "Zu Folie {index}",
  "skills.hero.next": "Nächste vorgestellte Fähigkeit",
  "skills.hero.trySkill": "Fähigkeit testen",
  ...
  "skills.preview.copyPrompt": "Prompt kopieren",
  "skills.preview.examplePrompt": "Beispielaufforderung",
  ...
  "story.slidingToggle.existing": "Bestehenden",
  "story.slidingToggle.fromLocal": "Von lokal",
  "story.slidingToggle.new": "Neu",
  "story.slidingToggle.toLocal": "Nach lokal",
  ...
  "threadHeader.copyAppLink": "App-Link kopieren",
  "threadHeader.copySessionId": "Sitzungs-ID•kopieren",
  "threadHeader.copyWorkingDirectory": "Arbeitsverzeichnis kopieren",
  "threadHeader.moreActions": "Thread-Aktionen",
  "threadPage.newThread": "Neuer Thread",
  ...
  "threadPage.runAction.label": "Ausgeführt",
  "threadPage.runAction.missing.label": "Run-Aktion einrichten",
  ...
  "threadPage.runAction.tooltip.withEnvironment":
    "Aktionen für {environmentName}",
  "threadPage.toggleDiffPanel": "Diff-Panel umschalten",
  "threadPage.toggleTerminal": "Terminal anzeigen/ausblenden",
  "threadTitle.branchName": "({branchName})",
  "threadTitle.openFolderInFinder": "Ordner öffnen",
  ...
  "toolSummaryForCmd.runningTimer": "für {elapsed}",
  ...
  "wham.diff.addComment": "Kommentar hinzufügen",
  "wham.diff.binaryFile": "Binärdatei wird nicht angezeigt.",
  "wham.diff.noContent": "Keine Inhalte",
  "wham.fileTag.deleted": "Gelöscht",
  "wham.fileTag.new": "Neu",
  ...
  "worktreeRestoreBanner.body":
    "Der Worktree dieses Threads wurde entfernt, um Speicherplatz zu sparen.",
  "worktreeRestoreBanner.missing.body":
    "Das Arbeitsverzeichnis dieses Threads existiert nicht mehr.",
...
export { e as default };
//# sourceMappingURL=de-DE-DfkOhDeG.js.map
