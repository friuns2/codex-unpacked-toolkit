import { g as Dt } from "./chunk-55IACEB6-D8dgPtuT.js";
import { s as wt } from "./chunk-QN33PNHL-C4LLq_9I.js";
import {
  a2 as u,
  a6 as Vt,
  a5 as Lt,
...
import { c as Qt } from "./channel-DF6SLYYj.js";
var dt = (function () {
...
var Xt = dt,
    ...
    ((w = class {
        ...
        return (
          this.entities.has(i)
            ? !this.entities.get(i)?.alias &&
              l &&
              ((this.entities.get(i).alias = l),
              D.info(`Add alias '${l}' to entity '${i}'`))
            : (this.entities.set(i, {
      ...
      addAttributes(i, l) {
        ...
        for (o = l.length - 1; o >= 0; o--)
          (l[o].keys || (l[o].keys = []),
            ...
            D.debug("Added attribute ", l[o].name));
      }
      ...
      getData() {
        ...
        for (const h of this.relationships) {
          const y = {
            id: zt(h.entityA, h.entityB, { prefix: "id", counter: o++ }),
            type: "normal",
            curve: "basis",
            start: h.entityA,
            end: h.entityB,
  ...
  Nt = {};
Kt(Nt, { draw: () => Ht });
var Ht = u(async function (s, i, l, d) {
    (D.info("REF0:"), D.info("Drawing er diagram (unified)", i));
    const { securityLevel: o, er: h, layout: y } = tt(),
      _ = d.db.getData(),
      k = Dt(i, o);
    ((_.type = d.type),
    ...
    (Wt.insertTitle(
      ...
      wt(k, Z, "erDiagram", h?.useMaxWidth ?? !0));
  }, "draw"),
  Jt = u((s, i) => {
    const l = Qt,
      d = l(s, "r"),
...
//# sourceMappingURL=erDiagram-Q2GNP2WA-B5_A9PIS.js.map
