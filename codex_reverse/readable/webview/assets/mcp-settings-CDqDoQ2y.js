...
const Ze = (t) =>
    n.createElement(
      ...
      n.createElement("path", {
        d: "M0 40.84C0 18.285 18.285 0 40.84 0H137.88C160.436 0 178.721 18.285 178.721 40.84V137.88C178.721 160.436 160.436 178.721 137.88 178.721H40.84C18.285 178.721 0 160.436 0 137.88V40.84Z",
        fill: "black",
      }),
      n.createElement("path", {
        d: "M47.473 131.249C47.473 119.682 56.85 110.305 68.417 110.305H89.36V131.249C89.36 142.816 79.984 152.193 68.417 152.193C56.85 152.193 47.473 142.816 47.473 131.249Z",
        fill: "#24CB71",
      }),
      n.createElement("path", {
        d: "M89.36 26.5293V68.4163H110.304C121.871 68.4163 131.248 59.0403 131.248 47.4733C131.248 35.9063 121.871 26.5293 110.304 26.5293H89.36Z",
        fill: "#FF7237",
      }),
      n.createElement("path", {
        d: "M110.13 110.304C121.697 110.304 131.074 100.927 131.074 89.3598C131.074 77.7929 121.697 68.416 110.13 68.416C98.563 68.416 89.1862 77.7929 89.1862 89.3598C89.1862 100.927 98.563 110.304 110.13 110.304Z",
        fill: "#00B6FF",
      }),
      n.createElement("path", {
        d: "M47.473 47.4733C47.473 59.0403 56.85 68.4173 68.417 68.4173H89.36V26.5293H68.417C56.85 26.5293 47.473 35.9063 47.473 47.4733Z",
        fill: "#FF3737",
      }),
      n.createElement("path", {
        d: "M47.473 89.361C47.473 100.928 56.85 110.305 68.417 110.305H89.36V68.418H68.417C56.85 68.418 47.473 77.794 47.473 89.361Z",
        fill: "#874FFF",
      }),
    ),
  ze = (t) =>
    n.createElement(
      ...
      n.createElement("path", { fill: "url(#a)", d: "M0 0h512v512H0z" }),
      n.createElement(
        "g",
        { filter: "url(#b)", opacity: 0.8 },
        n.createElement("path", {
          fill: "#fff",
      ...
      n.createElement(
        ...
        n.createElement(
          ...
          n.createElement("stop", { stopColor: "#2D2E31" }),
          n.createElement("stop", { offset: 1, stopColor: "#0F1012" }),
        ),
        n.createElement(
          "linearGradient",
          {
          ...
          n.createElement("stop", { stopColor: "#fff" }),
          n.createElement("stop", { offset: 1, stopColor: "#C5C5C5" }),
        ),
        n.createElement(
          "linearGradient",
          {
        ...
        n.createElement(
          ...
          n.createElement("stop", { stopColor: "#fff" }),
          n.createElement("stop", { offset: 1, stopColor: "#CCC" }),
        ),
        n.createElement(
          "linearGradient",
          {
        ...
        n.createElement(
          ...
          n.createElement("feOffset", { dy: -5.12 }),
          n.createElement("feGaussianBlur", { stdDeviation: 12 }),
  ...
  me = [
    ...
    },
    {
      ...
      vendor: "Microsoft",
      config: {
        keyPath: "mcp_servers.playwright",
...
function _e(t) {
  const e = Z.c(5),
    { children: o, className: r } = t;
  let u;
  e[0] !== r
    ? ((u = ae("flex items-center gap-2", r)), (e[0] = r), (e[1] = u))
    : (u = e[1]);
  let c;
  return (
    e[2] !== o || e[3] !== u
      ? ((c = s.jsx("div", { className: u, children: o })),
        (e[2] = o),
        (e[3] = u),
        (e[4] = c))
      : (c = e[4]),
...
function $e(t) {
  const e = Z.c(13),
    { tabs: o, selectedKey: r, onSelect: u, className: c } = t;
  let l;
  e[0] !== c
    ? ((l = ae(
    ...
    : (l = e[1]);
  let f;
  if (e[2] !== u || e[3] !== r || e[4] !== o) {
    let x;
    (e[6] !== u || e[7] !== r || e[8] !== o.length
      ? ((x = (S, M) => {
          const w = S.key === r,
            y = M === 0,
            D = M === o.length - 1;
          return s.jsxs(
            n.Fragment,
            {
              children: [
                ...
                s.jsx("div", {
                  className:
                    "bg-token-border h-full w-px last:hidden self-stretch",
                }),
              ],
            },
            S.key,
  ...
  return (
    e[10] !== l || e[11] !== f
      ? ((C = s.jsx("div", { className: l, children: f })),
        (e[10] = l),
        (e[11] = f),
        (e[12] = C))
      : (C = e[12]),
...
function W(t) {
  const e = Z.c(52),
    o = t.inputType === N.String,
    r = t.inputType === N.Array,
    u = t.inputType === N.Record,
    c = ge();
  let l;
  e[0] !== c
    ? ((l = c.formatMessage({
  ...
  if (
    e[6] !== f ||
    e[7] !== t.inputType ||
    e[8] !== t.placeHolderValue ||
    e[9] !== x
  ) {
    if (((w = f), (y = x), t.inputType === N.Record)) {
      const [p] = t.placeHolderValue;
      ((w = p?.key ?? f), (y = p?.value ?? x));
    }
    ((e[6] = f),
      (e[7] = t.inputType),
      (e[8] = t.placeHolderValue),
  ...
  if (o) {
    ...
    e[16] !== t.title
      ...
      : (p = e[17]);
    const m =
      o && typeof t.placeHolderValue == "string" ? t.placeHolderValue : void 0;
    let B;
    e[18] !== t
      ? ((B = (G) => {
          t.onEdit(G.target.value);
        }),
        (e[18] = t),
        (e[19] = B))
      : (B = e[19]);
    let h;
    e[20] !== t.value || e[21] !== m || e[22] !== B
      ? ((h = s.jsx(se, {
          className: "text-base",
          value: t.value,
          placeholder: m,
    ...
    return (
      e[24] !== p || e[25] !== h
        ? ((E = s.jsxs("div", {
            className:
              "bg-token-input-background flex flex-col gap-2 rounded-lg px-3 py-2",
            children: [p, h],
          })),
          (e[24] = p),
          (e[25] = h),
              ...
              "div",
              {
                ...
                children: [
                  s.jsx(se, {
                    ...
                    value: p,
                    placeholder:
                      r && t.placeHolderValue.length > 0
                        ? (t.placeHolderValue[m] ?? t.placeHolderValue[0] ?? "")
                        : "",
                    onChange: (B) => {
                      const h = [...Q];
                      ((h[m] = B.target.value), t.onEdit(h));
                    },
                  }),
                  s.jsx(T, {
                    color: "ghost",
                    size: "icon",
                    disabled: Q.length <= 1 && p.trim().length === 0,
                    "aria-label": M,
                    onClick: () => {
                      const B = t.value.filter((h, E) => E !== m);
                      t.onEdit(B);
                    },
                    children: s.jsx(Ae, { className: "icon-2xs" }),
                  }),
                ],
              },
              `list-${m}`,
                ...
                children: [
                  s.jsx(se, {
                    ...
                    onChange: (B) => {
                      const h = [...j],
                        E = h[m];
                      ((h[m] = { ...E, key: B.target.value }), t.onEdit(h));
                    },
                  }),
                  s.jsx(se, {
                    className: "text-sm",
                    ...
                    onChange: (B) => {
                      const h = [...j],
                        E = h[m];
                      ((h[m] = { ...E, value: B.target.value }), t.onEdit(h));
                    },
                  }),
                  s.jsx(T, {
                    color: "ghost",
  ...
  let I;
  e[37] !== i
    ? ((I = s.jsx("div", { className: "flex flex-col gap-2", children: i })),
      (e[37] = i),
      (e[38] = I))
    : (I = e[38]);
  let P;
  ...
  e[44] === Symbol.for("react.memo_cache_sentinel")
    ? ((H = s.jsx(ve, { className: "icon-2xs" })), (e[44] = H))
    : (H = e[44]);
  const U = t.addLabel ? t.addLabel : null;
  let L;
  e[45] !== U || e[46] !== v
    ? ((L = s.jsxs(T, {
        color: "secondary",
  ...
  let O;
  return (
    e[48] !== L || e[49] !== d || e[50] !== I
      ? ((O = s.jsxs("div", {
          className:
            "bg-token-input-background flex flex-col gap-3 rounded-lg px-3 py-2",
          children: [d, I, L],
        })),
        (e[48] = L),
        (e[49] = d),
...
const se = Me.input`bg-token-input-background text-token-input-foreground placeholder:text-token-input-placeholder-foreground w-full rounded-md border border-token-input-border px-2.5 py-1.5 outline-none focus:border-token-focus-border`;
function et(t) {
  return t
    ? t.trim().length === 0
      ? t
...
function tt({
  ...
  const c = n.useMemo(() => st(t, e), [t, e]),
    ...
    w = !Qe(l, c),
    y =
      l.transportType === "streamable_http"
        ? l.http.url.trim().length === 0
        : l.stdio.command.trim().length === 0,
    D = async () => {
      if (!(M.length === 0 || y)) {
        x(!0);
        try {
  ...
  return s.jsx(Ce, {
    ...
    subtitle: Q
      ...
      : s.jsxs("a", {
          className:
            "text-token-text-secondary hover:text-token-text-primary inline-flex items-center gap-1 text-sm",
          href: De,
          target: "_blank",
          rel: "noreferrer",
          ...
          children: [
            ...
            s.jsx(ke, { className: "icon-xxs" }),
          ],
        }),
    action:
      u && l.label.trim().length > 0
        ? s.jsxs(T, {
            color: "danger",
            size: "toolbar",
            disabled: C,
    ...
    children: s.jsxs("div", {
      className: "relative",
      children: [
        C ? s.jsx(je, { overlay: !0 }) : null,
        s.jsx(X, {
          children: s.jsxs(X.Content, {
            children: [
              Q
                ? s.jsx("p", {
                ...
                : s.jsxs(ne, {
                    children: [
                      ...
                      s.jsx($e, {
                        ...
                        selectedKey: l.transportType,
                        onSelect: (d) => {
                          f((i) => ({ ...i, transportType: d }));
                        },
                      }),
                    ],
                  }),
                    ...
                    ? s.jsxs(s.Fragment, {
                        children: [
                          s.jsx(W, {
                            ...
                            value: l.stdio.command,
                            placeHolderValue: "openai-dev-mcp serve-sqlite",
                            inputType: N.String,
                            onEdit: (d) => {
                              f((i) => ({
                                ...i,
                                stdio: { ...i.stdio, command: d },
                              }));
                            },
                          }),
                          s.jsx(W, {
                    ...
                    : s.jsxs(s.Fragment, {
                        children: [
                          ...
                          s.jsx(W, {
                            ...
                            value: l.http.bearerTokenEnvVar,
                            placeHolderValue: "MCP_BEARER_TOKEN",
                            inputType: N.String,
                            onEdit: (d) => {
                              f((i) => ({
                                ...i,
                                http: { ...i.http, bearerTokenEnvVar: d },
                              }));
                            },
                          }),
                          s.jsx(W, {
...
function st(t, e) {
  const o = "command" in t ? "stdio" : "streamable_http";
  return {
    base: {
      enabled: t.enabled,
      startup_timeout_sec: t.startup_timeout_sec,
      startup_timeout_ms: t.startup_timeout_ms,
      tool_timeout_sec: t.tool_timeout_sec,
    ...
    transportType: o,
    stdio: {
      command: "command" in t ? t.command : "",
      args: "command" in t && t.args && t.args.length > 0 ? t.args : [],
      env: "command" in t && t.env ? ie(t.env) : [],
      envVars:
        "command" in t && t.env_vars && t.env_vars.length > 0 ? t.env_vars : [],
      cwd: "command" in t && t.cwd ? t.cwd : "",
    },
    http: {
      url: "url" in t ? t.url : "",
      bearerTokenEnvVar:
        "url" in t && t.bearer_token_env_var ? t.bearer_token_env_var : "",
      httpHeaders: "url" in t && t.http_headers ? ie(t.http_headers) : [],
      envHttpHeaders:
        "url" in t && t.env_http_headers ? ie(t.env_http_headers) : [],
    },
  };
}
function at(t) {
  const e = t.base;
  if (t.transportType === "streamable_http") {
    const l = oe(t.http.httpHeaders),
      f = oe(t.http.envHttpHeaders);
    return {
      ...e,
      url: t.http.url,
      bearer_token_env_var:
        t.http.bearerTokenEnvVar.trim().length > 0
          ? t.http.bearerTokenEnvVar.trim()
          : void 0,
      http_headers: Object.keys(l).length > 0 ? l : void 0,
      env_http_headers: Object.keys(f).length > 0 ? f : void 0,
    };
  }
  const o = oe(t.stdio.env),
    r = t.stdio.envVars.map((l) => l.trim()).filter((l) => l.length > 0),
    u = t.stdio.args.map((l) => l.trim()).filter((l) => l.length > 0);
  return {
    ...e,
    command: t.stdio.command,
    args: u.length > 0 ? u : void 0,
    env: Object.keys(o).length > 0 ? o : void 0,
    env_vars: r.length > 0 ? r : void 0,
    cwd: t.stdio.cwd.trim().length > 0 ? t.stdio.cwd.trim() : void 0,
  };
}
function ie(t) {
  ...
  return e.length === 0
    ? [{ key: "", value: "" }]
    : e.map(([o, r]) => ({ key: o, value: r }));
}
function oe(t) {
  const e = {};
  return (
    t.forEach(({ key: o, value: r }) => {
      const u = o.trim(),
        c = r.trim();
      u.length === 0 || c.length === 0 || (e[u] = c);
    }),
    e
  );
}
const pe = "mcp-settings",
  nt = { command: "", args: [], env_vars: [], enabled: !0 };
function ot() {
  const { data: t } = Le(),
    { data: e, isFetching: o } = Ne(),
    { data: r = [] } = He(),
    u = Ue(),
    c = Fe(),
    l = Te(),
    ...
    [j, d] = n.useState(null),
    [i, I] = n.useState(null),
    P = t?.configWriteTarget ?? null,
    v = t?.servers ?? {},
    H = t?.serverOrigins ?? {},
    U = Object.keys(v),
    L = n.useMemo(() => {
      const a = new Set(me.map((A) => A.id));
      return (
        r.forEach((A) => {
          a.add(A.id);
        }),
    ...
    O = n.useMemo(() => Object.values(x).some(Boolean), [x]),
    p = n.useMemo(() => {
      const a = new Set(r.map((A) => A.id));
      return me.filter((A) => !a.has(A.id));
    }, [r]),
    m = n.useMemo(() => U.filter((a) => !L.has(a)), [U, L]),
    B = m.length > 0,
    h = n.useMemo(() => U, [U]),
    E = n.useMemo(() => {
      const a = {};
        ...
        try {
          if (P) {
            ...
            (await l.mutateAsync({
              ...
              await C.invalidateQueries({ queryKey: te }),
              de(a.config.value) &&
                (await C.invalidateQueries({ queryKey: re })),
              D(!0));
          }
        } catch (A) {
          $.error(`Failed to install MCP server ${a.id} (${ee(A)})`);
        } finally {
          S((A) => ({ ...A, [a.id]: !1 }));
        }
      }
    ...
    Y = async (a, A) => {
      try {
        (await f.mutateAsync({ key: a, enabled: A }),
          await C.invalidateQueries({ queryKey: te }),
          D(!0));
      } catch {}
    },
    K = async (a, A) => {
      const b = fe(A, h, Q),
        F = Q == null || !h.includes(b),
        le =
          "command" in a
            ? { ...a, env: a.env ? { ...a.env } : void 0 }
            : {
                ...a,
                http_headers: a.http_headers ? { ...a.http_headers } : void 0,
                env_http_headers: a.env_http_headers
                  ? { ...a.env_http_headers }
                  : void 0,
              },
        J = `mcp_servers.${b}`;
      try {
        if (P) {
          const q = [{ keyPath: J, value: le, mergeStrategy: "replace" }];
          (await l.mutateAsync({
            edits: q,
            ...
            await C.invalidateQueries({ queryKey: te }),
            F && lt(a) && C.invalidateQueries({ queryKey: re }),
            D(!0),
            d(null),
            k(null));
        }
      } catch (q) {
        throw ($.error(`Failed to save MCP server ${b} (${ee(q)})`), q);
      }
    },
    R = async (a) => {
      const A = fe(a, h, Q),
      ...
      try {
        P &&
          (await l.mutateAsync({
            edits: [{ keyPath: b, value: null, mergeStrategy: "replace" }],
            filePath: P?.filePath ?? null,
            expectedVersion: P?.expectedVersion ?? null,
          }),
          await C.invalidateQueries({ queryKey: te }),
        ...
        throw ($.error(`Failed to uninstall MCP server ${A} (${ee(F)})`), F);
      }
    },
    V = async (a) => {
      if (!o) {
        const b = E[a];
        if (b !== void 0 && b !== "notLoggedIn") return;
      }
      const A = M[a];
      if (A) {
        _.dispatchMessage("open-in-browser", { url: A });
        return;
      }
      w((b) => ({ ...b, [a]: null }));
      try {
        const b = await c.loginMcpServer({ name: a });
        b.authorizationUrl &&
          (w((F) => ({ ...F, [a]: b.authorizationUrl })),
          _.dispatchMessage("open-in-browser", { url: b.authorizationUrl }));
      } catch (b) {
        ($.error(`Failed to start login for MCP server ${a} (${ee(b)})`),
          w((F) => {
            const { [a]: le, ...J } = F;
            return J;
          }));
    ...
    z = (a) => {
      const A = a?.trim();
      A && _.dispatchMessage("open-in-browser", { url: A });
    },
    xe = n.useEffectEvent((a) => {
      V(a);
    }),
    Ee = async (a) => {
      (await G(a), I(a.id));
    },
    we = n.useEffectEvent((a, A) => {
      (w((b) => {
        const F = b[a];
        if (A || F == null) {
          const { [a]: le, ...J } = b;
        ...
        A && (D(!0), C.invalidateQueries({ queryKey: re })));
    });
  if (
    (n.useEffect(() => {
      const a = ({ name: b, success: F }) => {
        we(b, F);
      };
      return c.addMcpLoginCallback(a);
    }, [c]),
    n.useEffect(() => {
      if (o || i == null) return;
      (E[i] === "notLoggedIn" && xe(i), I(null));
    }, [E, o, i]),
    j)
  )
    return s.jsx(tt, {
      ...
      onSave: (a, A) => K(a, A),
      onUninstall: Q ? (a) => R(a) : void 0,
    });
  const be = s.jsx(Ke, { slug: pe }),
    ye = s.jsx(Ye, { slug: pe }),
    Se = y
      ? s.jsxs(T, {
          color: "ghost",
          size: "toolbar",
          onClick: () => {
            _.dispatchMessage("codex-app-server-restart", {});
          },
          children: [
            s.jsx(We, { className: "icon-2xs" }),
            u === "electron"
              ? s.jsx(g, {
              ...
              : s.jsx(g, {
                  ...
                  description:
                    "Button label to restart the extension after MCP settings change",
                }),
          ],
        })
      : null,
    Pe = {
      figma: s.jsx(Ze, { className: "size-4.5", "aria-hidden": "true" }),
      linear: s.jsx(ze, { className: "size-4.5", "aria-hidden": "true" }),
      notion: s.jsx(qe, { className: "size-4.5", "aria-hidden": "true" }),
      playwright: s.jsx(Je, { className: "size-4.5", "aria-hidden": "true" }),
    },
    ue = () => {
      (k(null), d({ ...nt, name: void 0 }));
    };
  return s.jsxs(Ce, {
    title: be,
    subtitle: ye,
    ...
    children: [
        ...
        children: [
          s.jsx(X.Header, {
            title: s.jsx(g, {
              ...
              defaultMessage: "Custom servers",
              description: "Heading for the user's MCP servers list",
            }),
            actions: m.length > 0 && s.jsx(he, { onClick: ue }),
          }),
          s.jsx(X.Content, {
            children: s.jsx(ne, {
              children: B
                ? m.map((a) =>
                    s.jsx(
                      ce,
                      {
                        ...
                        installed: !0,
                        statusLoading: O ? !1 : o,
                        enabled: v[a]?.enabled !== !1,
                        authStatus: E[a],
                        onAuthenticateClicked: () => V(a),
                        onEnableClicked: v[a] ? (A) => Y(a, A) : void 0,
                        onSettingsClicked: v[a]
                          ? async () => {
                              (k(a), d(v[a]));
                            }
                          : void 0,
                        isReadOnly: H[a]?.name.type === "project",
                      },
                      a,
                    ),
                  )
                : s.jsx(Be, {
                    label: s.jsx(g, {
                      ...
                      defaultMessage: "No custom MCP servers connected",
                      description: "Empty state for MCP servers list",
                    }),
                    control: s.jsx(he, { onClick: ue }),
                  }),
            }),
          }),
        ],
      ...
      s.jsxs(X, {
        children: [
          s.jsx(X.Header, {
            title: s.jsx(g, {
              id: "settings.mcp.recommendedServers",
              defaultMessage: "Recommended servers",
              description: "Heading for recommended MCP servers list",
            }),
          }),
          s.jsx(X.Content, {
            children: s.jsxs(ne, {
              children: [
                p.map((a) =>
                  s.jsx(
                    ce,
                    {
                      leadingSlot: s.jsx("span", {
                        className:
                          "bg-token-bg-tertiary border-token-border flex size-8 items-center justify-center rounded-md border",
                        children: Pe[a.id] ?? null,
                      }),
                      name: a.label,
                      iconUrl: a.iconUrl,
                      enabled: v[a.id]?.enabled !== !1,
                      authStatus: E[a.id],
                      installLabel: de(a.config.value)
                        ? s.jsx(g, {
                            id: "settings.mcp.partnerServer.installAndAuthenticate",
                            defaultMessage: "Install and authenticate",
                            description:
                              "Button label to install and authenticate a recommended MCP server",
                          })
                        : void 0,
                      subtitle: s.jsx(g, {
                        id: "settings.mcp.partnerServer.vendor",
                        defaultMessage: "by {vendor}",
                        description:
                          "Label showing the vendor for a recommended MCP server",
                        values: { vendor: a.vendor },
                      }),
                      description: rt(a.id),
                      installed: !!v[a.id],
                      statusLoading: O ? x[a.id] === !0 : o && !!v[a.id],
                      installing: x[a.id] === !0,
                      onInstallClicked: de(a.config.value)
                        ? () => Ee(a)
                        : () => G(a),
                      onEnableClicked: v[a.id] ? (A) => Y(a.id, A) : void 0,
                      onAuthenticateClicked: v[a.id] ? () => V(a.id) : void 0,
                      onSettingsClicked: v[a.id]
                        ? async () => {
                            (k(a.id), d(v[a.id]));
                          }
                        : void 0,
                      isReadOnly: H[a.id]?.name.type === "project",
                    },
                    a.id,
                  ),
                ),
                r.map((a) =>
                  s.jsx(
                    ...
                    {
                      name: a.name,
                      iconUrl: a.logoUrl ?? a.logoUrlDark ?? void 0,
                      reserveIconSlot: !0,
                      installLabel: s.jsx(g, {
                        id: "settings.mcp.partnerServer.installAndAuthenticate",
                        defaultMessage: "Install and authenticate",
                        description:
                          "Button label to install and authenticate a recommended MCP server",
                      ...
                      installed: a.isAccessible,
                      onInstallClicked: async () => {
                        z(a.installUrl);
                      },
                      onManageClicked: a.isAccessible
                        ? async () => {
                            z(a.installUrl);
                          }
                        : void 0,
...
function fe(t, e, o) {
  const r =
      t
        ...
        .replace(/-+/gu, "-") ?? "",
    u = r.length > 0 ? r.toLowerCase() : "custom-server",
    c = e.filter((C) => (o == null ? !0 : C !== o));
  if (!c.includes(u)) return u;
  let l = 2,
    f = `${u}-${l}`;
  for (; c.includes(f); ) ((l += 1), (f = `${u}-${l}`));
  return f;
}
function de(t) {
  return t != null && typeof t == "object" && !Array.isArray(t) && "url" in t;
}
function lt(t) {
  return "url" in t;
}
function ce(t) {
  ...
  e[0] !== v || e[1] !== o
    ? ((H = v.formatMessage(
        {
          id: "settings.mcp.partnerServer.logoAlt",
          defaultMessage: "{label} logo",
          description: "Alt text for a recommended MCP server logo",
        },
        { label: o },
      )),
      (e[0] = v),
  ...
  e[3] !== c
    ? ((p = c
        ? s.jsx("span", { className: "flex size-8 shrink-0", children: c })
        : null),
      (e[3] = c),
      (e[4] = p))
    : (p = e[4]);
  ...
  e[5] !== U || e[6] !== r || e[7] !== u
    ? ((m =
        r || u
          ? s.jsx("span", {
              className:
                "bg-token-surface-tertiary flex size-8 shrink-0 items-center justify-center overflow-hidden rounded-md",
              children: r
                ? s.jsx("img", {
                    alt: U,
  ...
  e[11] !== l
    ? ((h = l
        ? s.jsx("span", { className: "text-token-text-secondary", children: l })
        : null),
      (e[11] = l),
      (e[12] = h))
    : (h = e[12]);
  ...
  e[16] !== f
    ? ((G = f
        ? s.jsx("span", { className: "text-token-text-secondary", children: f })
        : null),
      (e[16] = f),
      (e[17] = G))
    : (G = e[17]);
            ...
            children: [
              x && !M && !w
                ? s.jsx(T, {
                    ...
                    children:
                      D ??
                      s.jsx(g, {
                        id: "settings.mcp.partnerServer.install",
                        defaultMessage: "Install",
                        description:
                          "Button label to install a recommended MCP server",
                      }),
                  })
                : null,
              S && M && !w
                ? s.jsx(T, {
                    ...
                    children:
                      Q ??
                      s.jsx(g, {
                        id: "settings.mcp.partnerServer.manage",
                        defaultMessage: "Manage",
                        description:
                          "Button label to manage an installed recommended app",
                      }),
                  })
                : null,
              y ? s.jsx(Re, { className: "icon-xs" }) : null,
              L
                ? s.jsx(T, {
                    color: "outline",
                    disabled: !!y,
              ...
              I
                ? s.jsx(T, {
                    ...
                    children: s.jsx(Ve, { className: "icon-xs" }),
                  })
                : null,
              d
                ? s.jsx(Xe, {
...
function rt(t) {
  switch (t) {
    case "linear":
      return s.jsx(g, {
        id: "settings.mcp.partnerServer.description.linear",
        defaultMessage:
          "Integrate with Linear's issue tracking and project management",
        description: "Description for the Linear MCP server",
      });
    case "notion":
      return s.jsx(g, {
        id: "settings.mcp.partnerServer.description.notion",
        defaultMessage: "Read docs, update pages, manage tasks",
        description: "Description for the Notion MCP server",
      });
    case "figma":
      return s.jsx(g, {
        id: "settings.mcp.partnerServer.description.figma",
        defaultMessage:
          "Generate better code by bringing in full Figma context",
        description: "Description for the Figma MCP server",
      });
    case "github":
      return s.jsx(g, {
        id: "settings.mcp.partnerServer.description.github",
        defaultMessage:
          "Integrate with GitHub APIs to automate workflows and extract data",
        description: "Description for the GitHub MCP server",
      });
    case "playwright":
      return s.jsx(g, {
        id: "settings.mcp.partnerServer.description.playwright",
        defaultMessage:
          "Integrate browser automation to implement design and test UI.",
        description: "Description for the Playwright MCP server",
      });
  }
}
export { ot as McpSettings };
//# sourceMappingURL=mcp-settings-CDqDoQ2y.js.map
