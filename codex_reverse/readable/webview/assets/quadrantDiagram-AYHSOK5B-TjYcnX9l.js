...
import { l as ee } from "./linear-LHrec7-C.js";
            ...
            case 2:
              if (
                ...
                (vt = this.performAction.apply(
                  rt,
                  [s, Zt, yt, Y.yy, N[1], S, e].concat(me),
                )),
                typeof vt < "u")
              )
                return vt;
...
function St(t) {
  ...
  for (const f of t) {
    ...
    if (d === "radius") {
      if (ae(h)) throw new mt(d, h, "number");
      n.radius = parseInt(h);
    } else if (d === "color") {
      ...
      if (ne(h)) throw new mt(d, h, "number of pixels (eg. 10px)");
      n.strokeWidth = h;
...
` + t,
    ...
    (ve(T, b, m, _.quadrantChart?.useMaxWidth ?? !0),
      T.attr("viewBox", "0 0 " + m + " " + b),
      d.db.setHeight(b),
      d.db.setWidth(m));
    const g = d.db.getQuadrantData(),
      G = q.append("g").attr("class", "quadrants"),
...
//# sourceMappingURL=quadrantDiagram-AYHSOK5B-TjYcnX9l.js.map
