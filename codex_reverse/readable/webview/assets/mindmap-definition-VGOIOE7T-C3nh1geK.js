import { g as ae } from "./chunk-55IACEB6-D8dgPtuT.js";
import { s as oe } from "./chunk-QN33PNHL-C4LLq_9I.js";
import {
  a2 as c,
  a9 as O,
  ak as ce,
  ...
  ye =
    ((C = class {
      ...
      decorateNode(e) {
        ...
        (e.icon && (l.icon = U(e.icon, i)),
          e.class && (l.class = U(e.class, i)));
      }
      type2Str(e) {
        switch (e) {
      ...
      assignSections(e, i) {
        if (
          (e.level === 0 ? (e.section = void 0) : (e.section = i), e.children)
        )
      ...
      flattenNodes(e, i) {
        ...
        if ((i.push(p), e.children))
          for (const m of e.children) this.flattenNodes(m, i);
      }
      generateEdges(e, i) {
        if (e.children)
    ...
    for (let i = 0; i < r.THEME_COLOR_LIMIT; i++)
      ((r["lineColor" + i] = r["lineColor" + i] || r["cScaleInv" + i]),
        de(r["lineColor" + i])
          ...
          : (r["lineColor" + i] = pe(r["lineColor" + i], 20)));
    for (let i = 0; i < r.THEME_COLOR_LIMIT; i++) {
      const l = "" + (17 - 3 * i);
      e += `
...
//# sourceMappingURL=mindmap-definition-VGOIOE7T-C3nh1geK.js.map
