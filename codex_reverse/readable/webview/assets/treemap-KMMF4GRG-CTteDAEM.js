...
import {
  ...
  l as Qt,
  e as zc,
} from "./_basePickBy-D_ghe6L4.js";
import { c as re } from "./clone-CzlBXpAL.js";
var qc = Object.prototype,
  ...
  ke = wc(function (n, e) {
    ...
    for (var t in e) Yc.call(e, t) && Oc(n, t, e[t]);
  });
function _l(n, e, t) {
  var r = -1,
    i = n.length;
...
function ed(n, e, t, r) {
  var i = -1,
    ...
    u = e.length;
  if (!o) return l;
  e.length >= Zc && ((s = Uc), (a = !1), (e = new Fc(e)));
  e: for (; ++i < o; ) {
    var c = n[i],
      d = c;
    if (((c = c !== 0 ? c : 0), a && d === d)) {
...
var hi = bc(function (n, e) {
  return ga(n) ? ed(n, Cl(e, 1, ga, !0)) : [];
});
function Q(n, e, t) {
  var r = n == null ? 0 : n.length;
  return r ? ((e = e === void 0 ? 1 : Bs(e)), _l(n, e < 0 ? 0 : e, r)) : [];
}
function Yn(n, e, t) {
  var r = n == null ? 0 : n.length;
  return r
    ? ((e = e === void 0 ? 1 : Bs(e)), (e = r - e), _l(n, 0, e < 0 ? 0 : e))
    : [];
}
function td(n, e) {
...
var rd = Object.prototype,
  ...
  sd = Qc(function (n, e, t) {
    id.call(n, t) ? n[t].push(e) : Pc(n, t, [e]);
  }),
  ad = "[object String]";
function he(n) {
  return typeof n == "string" || (!te(n) && Sl(n) && Il(n) == ad);
}
var od = Math.max;
function de(n, e, t, r) {
  ...
  return (
    t < 0 && (t = od(i + t, 0)),
    he(n) ? t <= i && n.indexOf(e, t) > -1 : !!i && Nl(n, e, t) > -1
  );
}
function Ra(n, e, t) {
  var r = n == null ? 0 : n.length;
...
var va = ya && ya.isRegExp,
  Xe = va ? Mc(va) : ud,
  cd = "Expected a function";
function dd(n) {
  if (typeof n != "function") throw new TypeError(cd);
  return function () {
    var e = arguments;
    switch (e.length) {
      case 0:
...
class Z {
  ...
  join(e = ",") {
    ...
    let r = "",
      ...
      s = !1;
    do
      ((i = t.next()), i.done || (s && (r += e), (r += md(i.value))), (s = !0));
    while (!i.done);
    return r;
  }
  indexOf(e, t = 0) {
...
const gd = new Z(
  ...
  ve = Object.freeze({ done: !0, value: void 0 });
function ee(...n) {
  if (n.length === 1) {
    const e = n[0];
    ...
    if (typeof e.length == "number")
      return new Z(
        () => ({ index: 0 }),
        (t) => (t.index < e.length ? { done: !1, value: e[t.index++] } : ve),
      );
  }
  return n.length > 1
    ? new Z(
...
function Td(n, e) {
  ...
  const t =
    ...
    r =
      n.end.line < e.end.line ||
      (n.end.line === e.end.line && n.end.character <= e.end.character);
  return t && r
    ? He.Inside
    : t
      ? He.OverlapBack
...
class Vl extends Ol {
  ...
  getTypeMetaData(e) {
    switch (e) {
      ...
      case hn:
        return { name: hn, properties: [{ name: "true", defaultValue: !1 }] };
      case pn:
    ...
    (r) => {
      for (; r.keyIndex < r.keys.length; ) {
        ...
        if (!i.startsWith("$")) {
          const s = n[i];
          if (ae(s)) {
            if ((r.keyIndex++, ka(s, t))) return { done: !1, value: s };
          } else if (Array.isArray(s)) {
            for (; r.arrayIndex < s.length; ) {
              const a = r.arrayIndex++,
                o = s[a];
              if (ae(o) && ka(o, t)) return { done: !1, value: o };
            }
            r.arrayIndex = 0;
          }
        }
      ...
      for (; e.keyIndex < e.keys.length; ) {
        ...
        if (!t.startsWith("$")) {
          ...
          if (Ue(r))
            return (
              e.keyIndex++,
              { done: !1, value: { reference: r, container: n, property: t } }
            );
          if (Array.isArray(r)) {
            for (; e.arrayIndex < r.length; ) {
              ...
              if (Ue(s))
                return {
                  ...
                  value: { reference: s, container: n, property: t, index: i },
                };
            }
            e.arrayIndex = 0;
          }
...
const Hr = [];
for (let n = w("0"); n <= w("9"); n++) Hr.push(n);
const zr = [w("_")].concat(Hr);
...
function Xd(n) {
  return Array.prototype.map
    .call(n, (e) =>
      /\w/.test(e) ? `[${e.toLowerCase()}${e.toUpperCase()}]` : Ti(e),
    )
    .join("");
}
function Jd(n, e) {
...
function ql(n, e, t) {
  ...
  if (r.length !== 0)
    return (
      t !== void 0 ? (t = Math.max(0, Math.min(t, r.length - 1))) : (t = 0),
      r[t]
    );
}
function qs(n, e, t, r) {
  ...
  return Xn(n) && n.astNode === t
    ? n.content.flatMap((i) => qs(i, e, t, !1))
    : [];
}
function sf(n, e, t) {
  if (!n) return;
...
function af(n, e, t) {
  ...
  do
    if (((i = r.next()), !i.done)) {
      const a = i.value;
      a.astNode === t
        ? yt(a.grammarSource) && a.grammarSource.value === e && s.push(a)
        : r.prune();
    }
  while (!i.done);
  return s;
...
function of(n) {
  ...
  for (
    ;
    t === ((e = n.container) === null || e === void 0 ? void 0 : e.astNode);
  ) {
...
function Ql(n, e) {
  ...
  for (const t of tr(n))
    if (Tt(t)) {
      if (!t.rule.ref || (we(t.rule.ref) && !Ql(t.rule.ref, e))) return !1;
    } else {
      if (gt(t)) return !1;
      if (mi(t)) return !1;
    }
...
function Xs(n) {
  ...
  if (Fl(n) || Gl(n) || Nd(n)) return n.name;
  if (mi(n)) {
    const t = lf(n);
    if (t) return t;
  } else if (Dl(n)) return n.name;
  throw new Error("Cannot get name of Unknown Type");
}
function lf(n) {
  var e;
  if (n.inferredType) return n.inferredType.name;
  if (!((e = n.type) === null || e === void 0) && e.ref) return Xs(n.type.ref);
}
function uf(n) {
  var e, t, r;
  return kt(n)
    ? (t = (e = n.type) === null || e === void 0 ? void 0 : e.name) !== null &&
      t !== void 0
      ? t
      : "string"
    : (r = Ys(n)) !== null && r !== void 0
      ? r
      : n.name;
}
function Js(n) {
...
function mf(n) {
  const e = [],
    t = n.Grammar;
  for (const r of t.rules) kt(r) && nf(r) && qd(Js(r)) && e.push(r.name);
...
function qr(n, e = []) {
  return n instanceof ne || n instanceof W || n instanceof me
    ? !0
    : n instanceof ge
      ? Ll(n.definition, (r) => qr(r, e))
      : n instanceof ue && de(e, n)
        ? !1
        : n instanceof Be
          ? (n instanceof ue && e.push(n), be(n.definition, (r) => qr(r, e)))
          : !1;
}
function vf(n) {
...
function Sa(n, e, t) {
  return [
    new ne({
      definition: [new G({ terminalType: n.separator })].concat(n.definition),
    }),
  ].concat(e, t);
}
function nr(n) {
  if (n instanceof ue) return nr(n.referencedRule);
  if (n instanceof G) return kf(n);
  if (Rf(n)) return Af(n);
  if (vf(n)) return Ef(n);
  throw Error("non exhaustive match");
}
...
function cs(n, e, t) {
  switch (n.type) {
    case "Disjunction":
      for (let i = 0; i < n.value.length; i++) cs(n.value[i], e, t);
      break;
    case "Alternative":
      const r = n.value;
      for (let i = 0; i < r.length; i++) {
        ...
        switch (a.type) {
          case "Character":
            ...
            break;
          case "Set":
            if (a.complement === !0) throw Error(ru);
            C(a.value, (l) => {
              if (typeof l == "number") Tr(l, e, t);
                ...
                if (t === !0) for (let c = u.from; c <= u.to; c++) Tr(c, e, t);
                  ...
                  for (let c = u.from; c <= u.to && c < Bn; c++) Tr(c, e, t);
                  if (u.to >= Bn) {
...
class _f extends yi {
  ...
  visitSet(e) {
    e.complement
      ? Ia(e, this.targetCharCodes) === void 0 && (this.found = !0)
      : Ia(e, this.targetCharCodes) !== void 0 && (this.found = !0);
  }
}
function Zs(n, e) {
  ...
  } else return Jt(e, (t) => de(n, t.charCodeAt(0))) !== void 0;
}
const Rt = "PATTERN",
  Un = "defaultMode",
  Rr = "modes";
  ...
  t("misc mapping", () => {
    ((a = $(r, (E) => E.tokenTypeIdx)),
      ...
      (l = $(r, (E) => {
        ...
        if (R) return te(R) ? $(R, (F) => Ra(r, F)) : [Ra(r, R)];
      })),
      (u = $(r, (E) => E.PUSH_MODE)),
      (c = $(r, (E) => N(E, "POP_MODE"))));
  });
  ...
  return (
    e &&
      C(a, (l) => {
        const u = au(l, o);
        if (u !== !1) {
          const d = { message: eh(l, u), type: u.issue, tokenType: l };
          r.push(d);
        } else
          N(l, "LINE_BREAKS")
            ? l.LINE_BREAKS === !0 && (i = !0)
...
function au(n, e) {
  ...
  if (Xe(n.PATTERN)) {
    ...
    if (su(n)) return { issue: j.CUSTOM_LINE_BREAK };
    throw Error("non exhaustive match");
  }
}
function eh(n, e) {
...
function th() {
  if (D(Or)) {
    Or = new Array(65536);
    for (let n = 0; n < 65536; n++) Or[n] = n > 255 ? 255 + ~~(n / 255) : n;
  }
}
function rr(n, e) {
  ...
  return t === e.tokenTypeIdx
    ? !0
    : e.isParent === !0 && e.categoryMatchesMap[t] === !0;
}
function Xr(n, e) {
...
function rh(n) {
  C(n, (e) => {
    (cu(e) || ((lu[wa] = e), (e.tokenTypeIdx = wa++)),
      _a(e) && !te(e.CATEGORIES) && (e.CATEGORIES = [e.CATEGORIES]),
      _a(e) || (e.CATEGORIES = []),
      ah(e) || (e.categoryMatches = []),
      oh(e) || (e.categoryMatchesMap = {}));
  });
}
function ih(n) {
  C(n, (e) => {
...
(function (n) {
  ((n[(n.MISSING_PATTERN = 0)] = "MISSING_PATTERN"),
    ...
    (n[(n.MULTI_MODE_LEXER_WITHOUT_DEFAULT_MODE = 7)] =
...
a boolean 2nd argument is no longer supported`);
      ...
      this.TRACE_INIT("Lexer Constructor", () => {
        ...
        (this.TRACE_INIT("Lexer Config handling", () => {
          if (this.config.lineTerminatorsPattern === Vn.lineTerminatorsPattern)
            ...
            this.config.lineTerminatorCharacters === Vn.lineTerminatorCharacters
          )
	...
	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#MISSING_LINE_TERM_CHARS`);
          ...
          ((this.trackStartLines = /full|onlyStart/i.test(
            ...
            te(e)
              ? (i = { modes: { defaultMode: re(e) }, defaultMode: Un })
              : ((s = !1), (i = re(e))));
        }),
        ...
        if (
              ...
              if (
                ...
                this.config.skipValidations === !1 &&
                  this.TRACE_INIT("validatePatterns", () => {
                    this.lexerDefinitionErrors =
                      this.lexerDefinitionErrors.concat(Of(o, a));
                  }),
                ...
                (this.TRACE_INIT("analyzeTokenTypes", () => {
                  ...
                  (this.charCodeToPatternIdxToConfig[l] =
                    u.charCodeToPatternIdxToConfig),
          ...
          const l = $(this.lexerDefinitionErrors, (u) => u.message)
            .join(`-----------------------
`);
          throw new Error(
...
` + l,
        ...
        (C(this.lexerDefinitionWarning, (o) => {
          ...
          this.TRACE_INIT("Choosing sub-methods implementations", () => {
            if (
              (iu
                ? ((this.chopInput = Ta), (this.match = this.matchWithTest))
                : ((this.updateLastIndex = Y),
                  (this.match = this.matchWithExec)),
              s && (this.handleModes = Y),
              this.trackStartLines === !1 && (this.computeNewColumn = Ta),
              this.trackEndLines === !1 &&
                (this.updateTokenEndLineColumnLocation = Y),
  ...
  tokenize(e, t = this.defaultMode) {
    if (!D(this.lexerDefinitionErrors)) {
      const i = $(this.lexerDefinitionErrors, (s) => s.message)
        .join(`-----------------------
`);
      throw new Error(
...
` + i,
  ...
  tokenizeInternal(e, t) {
    let r, i, s, a, o, l, u, c, d, h, f, m, g, A, T;
    const E = e,
      R = E.length;
    let I = 0,
      F = 0;
    ...
    const Nc = (se) => {
      if (_.length === 1 && se.tokenType.PUSH_MODE === void 0) {
        const Ce =
          this.config.errorMessageProvider.buildUnableToPopLexerModeMessage(se);
        ye.push({
        ...
        if (
          (Ve !== !1
            ...
            : Le.isCustom === !0
              ? ((T = Re.exec(E, I, _e, k)),
                T !== null
                  ? ((l = T[0]), T.payload !== void 0 && (u = T.payload))
                  : (l = null))
              : (this.updateLastIndex(Re, I), (l = this.match(Re, e, I))),
          l !== null)
        ) {
            ...
            for (s = 0; s < Qe; s++) {
              ...
              if (
                ...
                Ke.isCustom === !0
                  ? ((T = dt.exec(E, I, _e, k)),
                    T !== null
                      ? ((a = T[0]), T.payload !== void 0 && (c = T.payload))
                      : (a = null))
                  : (this.updateLastIndex(dt, I), (a = this.match(dt, e, I))),
                a && a.length > l.length)
              ) {
                ((l = a), (u = c), (Le = Ke));
                break;
      ...
      if (l !== null) {
        if (
          ...
          h !== void 0 &&
            ...
            h === !1 ? (F = this.addToken(_e, F, m)) : k[h].push(m)),
          (e = this.chopInput(e, d)),
          (I = I + d),
          (Ie = this.computeNewColumn(Ie, d)),
          y === !0 && Le.canLineTerminator === !0)
        ) {
          let Re = 0,
            Ve,
            Qe;
          S.lastIndex = 0;
          do ((Ve = S.test(l)), Ve === !0 && ((Qe = S.lastIndex - 1), Re++));
          while (Ve === !0);
          Re !== 0 &&
            ((Fe = Fe + Re),
            (Ie = d - Qe),
    ...
    return (
      this.hasCustom || (_e.length = F),
      { tokens: _e, groups: k, errors: ye }
    );
  }
  handleModes(e, t, r, i) {
    if (e.pop === !0) {
  ...
  updateTokenEndLineColumnLocation(e, t, r, i, s, a, o) {
    ...
    t !== void 0 &&
      ...
      (u = l ? -1 : 0),
      (i === 1 && l === !0) ||
        ((e.endLine = s + u), (e.endColumn = a - 1 + -u)));
  }
...
function ch(n) {
  const e = n.pattern,
    t = {};
  if (((t.name = n.name), Ye(e) || (t.PATTERN = e), N(n, uh)))
    throw `The parent property is no longer supported.
See: https://github.com/chevrotain/chevrotain/issues/564#issuecomment-349062346 for details.`;
  return (
    N(n, La) && (t.CATEGORIES = n[La]),
    ir([t]),
    N(n, Oa) && (t.LABEL = n[Oa]),
    N(n, ba) && (t.GROUP = n[ba]),
    N(n, Ma) && (t.POP_MODE = n[Ma]),
    N(n, Pa) && (t.PUSH_MODE = n[Pa]),
    N(n, Da) && (t.LONGER_ALT = n[Da]),
    N(n, Fa) && (t.LINE_BREAKS = n[Fa]),
    N(n, Ga) && (t.START_CHARS_HINT = n[Ga]),
    t
  );
}
const tt = fu({ name: "EOF", pattern: fe.NA });
ir([tt]);
...
and Non-Terminal names start with a lower case letter.`;
    ...
    buildAlternationPrefixAmbiguityError(n) {
      const e = $(n.prefixPath, (i) => Lt(i)).join(", "),
 ...
 has ${n.alternation.definition.length + 1} alternatives.`;
    ...
    buildLeftRecursionError(n) {
      const e = n.topLevelRule.name,
        t = $(n.leftRecursionPath, (s) => s.name),
        r = `${e} --> ${t.concat([e]).join(" --> ")}`;
...
class hh extends on {
  ...
  visitNonTerminal(e) {
    ...
    if (t) e.referencedRule = t;
      ...
      const r = this.errMsgProvider.buildRuleNotFoundError(
        this.currTopLevel,
        e,
      );
      this.errors.push({
...
class ph extends Ri {
  ...
  startWalking() {
    ...
    return (
      (this.ruleStack = re(this.path.ruleStack).reverse()),
      (this.occurrenceStack = re(this.path.occurrenceStack).reverse()),
      this.ruleStack.pop(),
...
function hs(n, e, t = []) {
  ...
  for (; t.length < e && i < n.length; ) {
    ...
    if (o instanceof ue) return a(o.definition);
    if (o instanceof ne) r = a(o.definition);
      ...
      const l = [
        ...
        new W({
          definition: [new G({ terminalType: o.separator })].concat(
            o.definition,
          ),
        }),
      ];
...
function pu(n, e, t, r) {
  ...
  const l = e.length,
    ...
    d = [];
  for (
    d.push({ idx: -1, def: n, ruleStack: [], occurrenceStack: [] });
    !D(d);
  ) {
    const h = d.pop();
    if (h === a) {
    ...
    if (T === i) {
      ...
      const E = new W({ definition: T.definition, idx: T.idx }),
        R = T.definition.concat([E], Q(f)),
        I = { idx: m, def: R, ruleStack: g, occurrenceStack: A };
      d.push(I);
    } else if (T instanceof Se) {
      const E = new G({ terminalType: T.separator }),
        R = new W({ definition: [E].concat(T.definition), idx: T.idx }),
        I = T.definition.concat([R], Q(f)),
      ...
      const R = new G({ terminalType: T.separator }),
        I = new W({ definition: [R].concat(T.definition), idx: T.idx }),
        F = T.definition.concat([I], Q(f)),
        ie = { idx: m, def: F, ruleStack: g, occurrenceStack: A };
      d.push(ie);
    ...
    else if (T instanceof an) d.push(Th(T, m, g, A));
    else throw Error("non exhaustive match");
  }
  return c;
}
function Th(n, e, t, r) {
  ...
  return (
    s.push(1),
    { idx: e, def: n.definition, ruleStack: i, occurrenceStack: s }
  );
}
var B;
(function (n) {
  ((n[(n.OPTION = 0)] = "OPTION"),
    ...
    (n[(n.REPETITION_MANDATORY_WITH_SEPARATOR = 3)] =
  ...
  if (s && !r) {
    const a = $(n, (l) => Ne(l)),
      o = le(
        ...
        (l, u, c) => (
          C(u, (d) => {
            (N(l, d.tokenTypeIdx) || (l[d.tokenTypeIdx] = c),
...
class kh extends Ri {
  ...
  walkAtLeastOne(e, t, r) {
    this.checkIsTarget(e, B.REPETITION_MANDATORY, t, r) ||
      super.walkOption(e, t, r);
  }
  walkAtLeastOneSep(e, t, r) {
    this.checkIsTarget(e, B.REPETITION_MANDATORY_WITH_SEPARATOR, t, r) ||
      super.walkOption(e, t, r);
  }
  walkMany(e, t, r) {
  ...
  walkManySep(e, t, r) {
    this.checkIsTarget(e, B.REPETITION_WITH_SEPARATOR, t, r) ||
      super.walkOption(e, t, r);
  }
}
class mu extends on {
...
function ki(n, e, t, r) {
  ...
  e.accept(i);
  const s = i.result,
    o = new kh(e, n, t).startWalking(),
    l = new pe({ definition: s }),
    u = new pe({ definition: o });
  return gu([l, u], r);
}
function ps(n, e) {
...
function Sh(n) {
  ...
  return $(e, (t) =>
    Object.assign({ type: ce.CUSTOM_LOOKAHEAD_VALIDATION }, t),
  );
}
function Ih(n, e, t, r) {
  const i = Ee(n, (l) => Ch(l, t)),
    s = Uh(n, e, t),
    a = Ee(n, (l) => Mh(l, t)),
    o = Ee(n, (l) => _h(l, n, r, t));
...
function br(n) {
  ...
  else if (t instanceof ge) e = Ne($(t.definition, (s) => br(s.definition)));
...
function bh(n, e, t) {
  ...
  return (
    (i = pi(i, (a) => a.ignoreAmbiguities === !0)),
    Ee(i, (a) => {
      const o = a.idx,
        l = a.maxLookahead || e,
        u = Ei(o, n, l, a),
    ...
    Ee(i, (a) => {
      ...
      const l = a.idx,
        ...
        c = $e(
          i,
          (h) =>
            e.definition[h.idx].ignoreAmbiguities !== !0 &&
            h.idx < l &&
            xh(h.path, u),
        );
      return $(c, (h) => {
...
function Bh(n) {
  const e = Vs(n, { errMsgProvider: dh }),
    t = {};
  return (
    C(n.rules, (r) => {
      t[r.name] = r;
...
function Vh(n) {
  return (
    (n = Vs(n, { errMsgProvider: mt })),
    Ih(n.rules, n.tokenTypes, n.errMsgProvider, n.grammarName)
  );
}
const vu = "MismatchedTokenException",
  Au = "NoViableAltException",
  Eu = "EarlyExitException",
  ku = "NotAllInputParsedException",
  $u = [vu, Au, Eu, ku];
Object.freeze($u);
function Jr(n) {
  return de($u, n.name);
...
class zh {
  initRecoverable(e) {
    ((this.firstAfterRepMap = {}),
      (this.resyncFollows = {}),
      (this.recoveryEnabled = N(e, "recoveryEnabled")
        ? e.recoveryEnabled
        : Je.recoveryEnabled),
      this.recoveryEnabled && (this.attemptInRepetitionRecovery = qh));
  }
  getTokenToInsert(e) {
  ...
  flattenFollowSet() {
    const e = $(this.buildFullFollowKeyStack(), (t) =>
      this.getFollowSetFromFollowKey(t),
    );
    return Ne(e);
  }
  ...
  getCurrentGrammarPath(e, t) {
    const r = this.getHumanReadableRuleStack(),
      i = re(this.RULE_OCCURRENCE_STACK);
    return {
      ruleStack: r,
      occurrenceStack: i,
      lastTok: e,
...
function qh(n, e, t, r, i, s, a) {
  ...
  (this.RULE_STACK.length === 1 && d && u === void 0 && ((u = tt), (c = 1)),
    !(u === void 0 || c === void 0) &&
...
class ra {
  constructor(e) {
    var t;
    this.maxLookahead =
      (t = e?.maxLookahead) !== null && t !== void 0 ? t : Je.maxLookahead;
  }
  validate(e) {
  ...
  validateEmptyOrAlternatives(e) {
    return Ee(e, (t) => Oh(t, mt));
  }
  validateAmbiguousAlternationAlternatives(e, t) {
    return Ee(e, (r) => bh(r, t, mt));
  }
...
class Xh {
  initLooksAhead(e) {
    ((this.dynamicTokensEnabled = N(e, "dynamicTokensEnabled")
      ...
      (this.maxLookahead = N(e, "maxLookahead")
        ? e.maxLookahead
        : Je.maxLookahead),
      (this.lookaheadStrategy = N(e, "lookaheadStrategy")
        ? e.lookaheadStrategy
        : new ra({ maxLookahead: this.maxLookahead })),
...
class op {
  initTreeBuilder(e) {
    if (
      ...
      ((this.cstInvocationStateUpdate = Y),
        (this.cstFinallyStateUpdate = Y),
        (this.cstPostTerminal = Y),
        (this.cstPostNonTerminal = Y),
        (this.cstPostRule = Y));
      ...
      this.recoveryEnabled
        ...
        : ((this.setNodeLocationFromToken = Y),
          (this.setNodeLocationFromNode = Y),
  ...
  getBaseCstVisitorConstructor() {
    if (Ye(this.baseCstVisitorConstructor)) {
      const e = rp(this.className, Xt(this.gastProductionsCache));
...
class up {
  ...
  OVERRIDE_RULE(e, t, r = ei) {
    const i = Lh(e, this.definedRulesNames, this.className);
  ...
  getSerializedGastProductions() {
    return Tf(z(this.gastProductionsCache));
  }
}
class cp {
  initRecognizerEngine(e, t) {
    ...
    else if (N(e, "modes") && be(Ne(z(e.modes)), lh)) {
      const s = Ne(z(e.modes)),
        a = Ks(s);
      this.tokensMap = le(a, (o, l) => ((o[l.name] = l), o), {});
    } else if (Dc(e)) this.tokensMap = re(e);
    else
      throw new Error(
    ...
    const r = N(e, "modes") ? Ne(z(e.modes)) : z(e),
      i = be(r, (s) => D(s.categoryMatches));
...
Make sure that all grammar rule definitions are done before 'performSelfAnalysis' is called.`);
    const i = N(r, "resyncEnabled") ? r.resyncEnabled : ei.resyncEnabled,
      s = N(r, "recoveryValueFunc")
        ? r.recoveryValueFunc
        : ei.recoveryValueFunc,
      a = this.ruleShortNameIdx << (Yh + it);
  ...
  atLeastOneSepFirstInternalLogic(e, t, r) {
    ...
    if (this.getLaFuncFromCache(r).call(this) === !0) {
      ...
      throw this.raiseEarlyExitException(
        e,
        B.REPETITION_MANDATORY_WITH_SEPARATOR,
        t.ERR_MSG,
      );
  }
  manyInternal(e, t) {
    ...
    try {
      ...
      return (
        ...
        this.cstPostNonTerminal(
          i,
          r !== void 0 && r.LABEL !== void 0 ? r.LABEL : e.ruleName,
        ),
        i
      );
    } catch (s) {
  ...
  consumeInternal(e, t, r) {
    ...
    return (
      this.cstPostTerminal(
        r !== void 0 && r.LABEL !== void 0 ? r.LABEL : e.name,
        i,
      ),
      i
    );
...
class dp {
  ...
  raiseEarlyExitException(e, t, r) {
    ...
    throw this.SAVE_ERROR(new jh(u, this.LA(1), this.LA(0)));
  }
...
const Ha = !0,
  za = Math.pow(2, it) - 1,
  wu = fu({ name: "RECORDING_PHASE_TOKEN", pattern: fe.NA });
ir([wu]);
const _u = ea(
  wu,
...
class pp {
  ...
  subruleInternalRecord(e, t, r) {
    if ((Qr(t), !e || N(e, "ruleName") === !1)) {
      const o =
        new Error(`<SUBRULE${qa(t)}> argument is invalid expecting a Parser method reference but got: <${JSON.stringify(e)}>
 inside top level rule: <${this.recordingProdStack[0].name}>`);
    ...
    return (i.definition.push(a), this.outputCst ? hp : xi);
  }
  consumeInternalRecord(e, t, r) {
    if ((Qr(t), !cu(e))) {
      const a =
        new Error(`<CONSUME${qa(t)}> argument is invalid expecting a TokenType reference but got: <${JSON.stringify(e)}>
 inside top level rule: <${this.recordingProdStack[0].name}>`);
      throw ((a.KNOWN_RECORDER_ERROR = !0), a);
    }
    const i = Qt(this.recordingProdStack),
      s = new G({ idx: t, terminalType: e, label: r?.LABEL });
  ...
  initPerformanceTracer(e) {
    if (N(e, "traceInitPerf")) {
      const t = e.traceInitPerf,
        r = typeof t == "number";
      ((this.traceInitMaxIdent = r ? t : 1 / 0),
...
const Zr = ea(tt, "", NaN, NaN, NaN, NaN, NaN, NaN);
Object.freeze(Zr);
...
(function (n) {
  ((n[(n.INVALID_RULE_NAME = 0)] = "INVALID_RULE_NAME"),
    ...
    (n[(n.CONFLICT_TOKENS_RULES_NAMESPACE = 8)] =
    ...
    this.TRACE_INIT("performSelfAnalysis", () => {
      ...
      if (
        (this.TRACE_INIT("Grammar Resolving", () => {
          ((r = Bh({ rules: z(this.gastProductionsCache) })),
        ...
        D(this.definitionErrors) &&
          (this.recoveryEnabled &&
            this.TRACE_INIT("computeAllProdsFollows", () => {
              const i = xf(z(this.gastProductionsCache));
        ...
        throw (
          (e = $(this.definitionErrors, (i) => i.message)),
...
`)}`)
  ...
  constructor(e, t) {
	...
	For further details.`);
    this.skipValidations = N(t, "skipValidations")
      ? t.skipValidations
      : Je.skipValidations;
  }
}
sr.DEFER_DEFINITION_ERRORS_HANDLING = !1;
yp(sr, [zh, Xh, op, lp, cp, up, dp, fp, pp, gp]);
class Tp extends sr {
  constructor(e, t = Je) {
    const r = re(t);
...
function Ip(n, e, t) {
  ...
  st(n, r);
  const i = ln(n, e, r, t, $t(n, e, t)),
    s = oa(n, e, t.separator, t);
  return Fu(n, e, t, i, s);
}
function Cp(n, e, t) {
  const r = X(n, e, t, { type: Lu });
  st(n, r);
  const i = ln(n, e, r, t, $t(n, e, t));
  return Du(n, e, t, i);
}
...
function wp(n, e, t) {
  ...
  st(n, r);
  const i = $(t.definition, (a) => Mu(n, e, a));
  return ln(n, e, r, t, ...i);
}
function _p(n, e, t) {
  const r = X(n, e, t, { type: nt });
...
function Du(n, e, t, r, i) {
  ...
  return (
    ...
    H(a, o),
    i === void 0 ? (H(o, s), H(o, l)) : (H(o, l), H(o, i.left), H(i.right, s)),
    { left: s, right: l }
  );
}
function Fu(n, e, t, r, i) {
  ...
  return (
    ...
    H(o, l),
    H(a, u),
    i !== void 0 ? (H(u, l), H(u, i.left), H(i.right, s)) : H(u, o),
    (n.decisionMap[Zt(e, i ? "RepetitionWithSeparator" : "Repetition", t.idx)] =
      o),
    { left: o, right: l }
  );
}
function Lp(n, e, t, r) {
  const i = r.left,
    s = r.right;
  return (H(i, s), (n.decisionMap[Zt(e, "Option", t.idx)] = i), r);
}
function st(n, e) {
  return (
...
function bp(n, e) {
  ...
  for (let s = 0; s < t - 1; s++) {
    ...
    ((l && u.followState === a.right) || o.target === a.right)
      ? (l ? (u.followState = c) : (o.target = c), Dp(n, a.right))
      : H(a.right, c);
  }
  const r = e[0],
    i = e[t - 1];
...
function oa(n, e, t, r) {
  const i = X(n, e, r, { type: nt }),
    s = X(n, e, r, { type: nt });
  return (la(i, new sa(s, t)), { left: i, right: s });
}
function Pp(n, e, t) {
...
function la(n, e) {
  (n.transitions.length === 0 && (n.epsilonOnlyTransitions = e.isEpsilon()),
...
function Fp(n, e) {
  ...
  return (r) => {
    ...
    return (
      s !== void 0 ||
        ((s = { atnStartState: n, decision: e, states: {} }), (t[i] = s)),
      s
    );
  };
}
...
class Gp extends ra {
  constructor(e) {
    ...
    (super(),
      (this.logging =
        (t = e?.logging) !== null && t !== void 0 ? t : (r) => console.log(r)));
  }
  initialize(e) {
    ((this.atn = $p(e.rules)), (this.dfas = Up(this.atn)));
  }
  ...
  buildLookaheadForOptional(e) {
    const {
      ...
      l = Zt(r, i, t),
      c = this.atn.decisionMap[l].decision,
      d = $(Va({ maxLookahead: 1, occurrence: t, prodType: i, rule: r }), (h) =>
        $(h, (f) => f[0]),
      );
    if (Ja(d) && d[0][0] && !s) {
      const h = d[0],
...
function Vp(n, e, t, r, i, s) {
  const a = qp(e.configs, t, i);
  if (a.size === 0) return (Qa(n, e, t, ti), ti);
  let o = Bu(a);
  const l = Xp(a, i);
  if (l !== void 0)
...
function Hp(n, e, t) {
  const r = Ee(e.configs.elements, (s) => s.state.transitions),
    i = hd(
      r.filter((s) => s instanceof sa).map((s) => s.tokenType),
      (s) => s.tokenTypeIdx,
    );
...
function qp(n, e, t) {
  ...
  if (i.length > 0 && !Zp(s)) for (const a of i) s.add(a);
  return s;
}
function Yp(n, e) {
  if (n instanceof sa && hu(e, n.tokenType)) return n.target;
}
function Xp(n, e) {
  let t;
...
function Qp(n, e) {
  if (e instanceof Pu) return { state: e.target, alt: n.alt, stack: n.stack };
  if (e instanceof aa) {
...
function rm(n) {
  for (const e of Array.from(n.values()))
    if (Object.keys(e).length > 1) return !0;
  return !1;
}
function im(n) {
  for (const e of Array.from(n.values()))
...
(function (n) {
  ...
  function t(r) {
    ...
    return (
      p.objectLiteral(i) &&
      b.is(i.range) &&
      (p.string(i.uri) || p.undefined(i.uri))
    );
  }
  n.is = t;
})(ii || (ii = {}));
...
(function (n) {
  ...
  function t(r) {
    ...
    return (
      ...
      b.is(i.targetSelectionRange) &&
      (b.is(i.originSelectionRange) || p.undefined(i.originSelectionRange))
    );
  }
  n.is = t;
})(to || (to = {}));
...
(function (n) {
  ...
  function t(r) {
    ...
    return (
      ...
      (p.undefined(i.additionalTextEdits) ||
        p.typedArray(i.additionalTextEdits, tn.is))
    );
  }
  n.is = t;
})(ro || (ro = {}));
...
(function (n) {
  ...
  function t(r) {
    ...
    return (
      ...
      (p.undefined(s.relatedInformation) ||
        p.typedArray(s.relatedInformation, Es.is))
    );
  }
  n.is = t;
})(si || (si = {}));
      ...
      (i.options === void 0 ||
        ((i.options.overwrite === void 0 || p.boolean(i.options.overwrite)) &&
          (i.options.ignoreIfExists === void 0 ||
            p.boolean(i.options.ignoreIfExists)))) &&
      ...
      (i.options === void 0 ||
        ((i.options.recursive === void 0 || p.boolean(i.options.recursive)) &&
          (i.options.ignoreIfNotExists === void 0 ||
            p.boolean(i.options.ignoreIfNotExists)))) &&
      (i.annotationId === void 0 || nn.is(i.annotationId))
    );
  }
  n.is = t;
    ...
    return (
      ...
      (r.documentChanges === void 0 ||
        r.documentChanges.every((i) =>
          p.string(i.kind) ? xs.is(i) || Ss.is(i) || Is.is(i) : $s.is(i),
        ))
    );
  }
  n.is = e;
...
(function (n) {
  ...
  function t(r) {
    ...
    return (
      p.defined(i) &&
      p.string(i.uri) &&
      (i.version === null || p.integer(i.version))
    );
  }
  n.is = t;
})(Ns || (Ns = {}));
...
(function (n) {
  ...
  function t(r) {
    ...
    return (
      p.string(i) ||
      (p.objectLiteral(i) && p.string(i.language) && p.string(i.value))
    );
  }
  n.is = t;
})(ai || (ai = {}));
...
(function (n) {
  function e(t) {
    ...
    return (
      ...
      (Jn.is(r.contents) ||
        ai.is(r.contents) ||
        p.typedArray(r.contents, ai.is)) &&
      (t.range === void 0 || b.is(t.range))
    );
  }
  n.is = e;
})(Eo || (Eo = {}));
  ...
  function t(r) {
    ...
    return (
      ...
      (i.triggerKind === void 0 ||
        i.triggerKind === oi.Invoked ||
        i.triggerKind === oi.Automatic)
    );
  }
  n.is = t;
})(Oo || (Oo = {}));
...
(function (n) {
  ...
  function t(r) {
    ...
    return (
      p.defined(i) &&
      b.is(i.range) &&
      (p.undefined(i.command) || en.is(i.command))
    );
  }
  n.is = t;
})(Po || (Po = {}));
...
(function (n) {
  ...
  function t(r) {
    ...
    return (
      p.defined(i) &&
      b.is(i.range) &&
      (p.undefined(i.target) || p.string(i.target))
    );
  }
  n.is = t;
})(Do || (Do = {}));
...
(function (n) {
  ...
  function t(r) {
    ...
    return (
      i != null &&
      b.is(i.range) &&
      (p.string(i.expression) || i.expression === void 0)
    );
  }
  n.is = t;
})(Wo || (Wo = {}));
...
(function (n) {
  ...
  function l(f) {
    return (
      e.call(f) === "[object Number]" && -2147483648 <= f && f <= 2147483647
    );
  }
  n.integer = l;
  function u(f) {
...
class om extends Hu {
  ...
  extractHiddenTokens(e) {
    ...
    for (let i = 0; i < t.length; i++)
      if (t[i].startOffset > r) return t.splice(0, i);
  ...
  consume(e, t, r) {
    ...
    if (!this.isRecording() && this.isValidToken(i)) {
      ...
      if (o) {
        ...
        let c = i.image;
        (yt(r) || (c = this.converter.convert(c, a).toString()),
          (u.value += c));
      }
    }
  }
...
class dm extends Tp {
  constructor(e, t) {
    ...
    super(
      e,
      Object.assign(
        Object.assign(Object.assign({}, cm), {
          lookaheadStrategy: r
            ? new ra({ maxLookahead: t.maxLookahead })
            : new Gp({ logging: t.skipValidations ? () => {} : void 0 }),
        }),
        t,
      ),
    );
...
function qu(n, e, t) {
  return (fm({ parser: e, tokens: t, ruleNames: new Map() }, n), e);
}
function fm(n, e) {
  const t = Hl(e, !1),
    r = ee(e.rules)
...
function vt(n, e, t = !1) {
  let r;
  if (yt(e)) r = Rm(n, e);
  else if (mi(e)) r = hm(n, e);
  else if (gt(e)) r = vt(n, e.terminal);
  else if (js(e)) r = Yu(n, e);
  else if (Tt(e)) r = pm(n, e);
  else if (Ul(e)) r = gm(n, e);
  else if (Bl(e)) r = ym(n, e);
  else if (Hs(e)) r = Tm(n, e);
  else if (Ld(e)) {
    const i = n.consume++;
    r = () => n.parser.consume(i, tt, e);
  } else throw new Ml(e.$cstNode, `Unexpected element type: ${e.$type}`);
...
function pm(n, e) {
  ...
  if (we(t)) {
    const r = n.subrule++,
      i = t.fragment,
      s = e.arguments.length > 0 ? mm(t, e.arguments) : () => ({});
  ...
  else throw new Ml(e.$cstNode, `Undefined rule: ${e.rule.$refText}`);
}
function mm(n, e) {
...
function li(n) {
  if (Hs(n)) return n.guardCondition;
}
function Yu(n, e, t = e.terminal) {
  if (t)
    ...
    if (!e.type.ref)
      throw new Error(
        "Could not resolve reference to type: " + e.type.$refText,
      );
    const r = Yl(e.type.ref),
      i = r?.terminal;
    if (!i)
      throw new Error(
        "Could not find name assignment for type: " + Xs(e.type.ref),
      );
    return Yu(n, e, i);
  }
}
...
function Xu(n, e, t, r) {
  ...
  if (r === "*") {
    const s = n.many++;
    return (a) =>
      n.parser.many(s, { DEF: () => t(a), GATE: i ? () => i(a) : void 0 });
  } else if (r === "+") {
    const s = n.many++;
    if (i) {
      const a = n.or++;
    ...
    const s = n.optional++;
    return (a) =>
      n.parser.optional(s, { DEF: () => t(a), GATE: i ? () => i(a) : void 0 });
  } else er();
}
function Ju(n, e) {
  const t = vm(n, e),
...
class Qu {
  ...
  buildTokens(e, t) {
    ...
    return (
      i.forEach((a) => {
        const o = a.PATTERN;
        typeof o == "object" && o && "test" in o && ls(o)
          ? s.unshift(a)
          : s.push(a);
      }),
      s
  ...
  buildTerminalToken(e) {
    ...
    return (
      ...
      e.hidden && (i.GROUP = ls(t) ? fe.SKIPPED : "hidden"),
      i
    );
  }
  ...
  buildKeywordTokens(e, t, r) {
    return e
      .filter(we)
      .flatMap((i) => tr(i).filter(yt))
      .distinct((i) => i.value)
      .toArray()
      .sort((i, s) => s.value.length - i.value.length)
      .map((i) => this.buildKeywordToken(i, t, !!r?.caseInsensitive));
  }
  ...
  findLongerAlt(e, t) {
    return t.reduce((r, i) => {
      const s = i?.PATTERN;
      return (s?.source && Jd("^" + s.source + "$", e.value) && r.push(i), r);
    }, []);
  }
}
class Zu {
...
function tc() {
  ...
  return ((pt.Emitter = r), (r._noop = function () {}), pt);
}
var sl;
function xm() {
  if (sl) return ht;
  ((sl = 1),
    ...
    (ht.CancellationTokenSource = ht.CancellationToken = void 0));
  const n = ec(),
    e = $m(),
    t = tc();
  var r;
...
async function Ae(n) {
  ...
  if (
    (e - Mr >= Im && ((Mr = e), await Sm(), (Mr = performance.now())),
...
class da {
  constructor() {
    this.promise = new Promise((e, t) => {
      ((this.resolve = (r) => (e(r), this)),
        (this.reject = (r) => (t(r), this)));
    });
  }
}
class Qn {
  ...
  update(e, t) {
    for (const r of e)
      if (Qn.isIncremental(r)) {
        ...
        if (l - o === c.length)
          for (let h = 0, f = c.length; h < f; h++) u[h + o + 1] = c[h];
        else
          c.length < 1e4
            ? u.splice(o + 1, l - o, ...c)
            : (this._lineOffsets = u =
  ...
  getLineOffsets() {
    return (
      this._lineOffsets === void 0 &&
        (this._lineOffsets = al(this._content, !0)),
      this._lineOffsets
    );
  }
  positionAt(e) {
  ...
  ensureBeforeEOL(e, t) {
    for (; e > t && nc(this._content.charCodeAt(e - 1)); ) e--;
    return e;
  }
  get lineCount() {
    return this.getLineOffsets().length;
  ...
  var n = {
      470: (i) => {
        ...
        var o = {
          resolve: function () {
            for (
              var l, u = "", c = !1, d = arguments.length - 1;
              d >= -1 && !c;
              d--
            ) {
              var h;
          ...
          relative: function (l, u) {
            if (
              (s(l), s(u), l === u || (l = o.resolve(l)) === (u = o.resolve(u)))
            )
              return "";
            for (var c = 1; c < l.length && l.charCodeAt(c) === 47; ++c);
            for (
              var d = l.length, h = d - c, f = 1;
              f < u.length && u.charCodeAt(f) === 47;
              ++f
            );
            for (
              var m = u.length - f, g = h < m ? h : m, A = -1, T = 0;
              T <= g;
              ++T
            ) {
              if (T === g) {
                if (m > g) {
                  ...
                  h > g &&
                    (l.charCodeAt(c + T) === 47 ? (A = T) : T === 0 && (A = 0));
                break;
              }
            ...
            var R = "";
            for (T = c + A + 1; T <= d; ++T)
              (T !== d && l.charCodeAt(T) !== 47) ||
                (R.length === 0 ? (R += "..") : (R += "/.."));
            return R.length > 0
              ? R + u.slice(f + A)
              : ((f += A), u.charCodeAt(f) === 47 && ++f, u.slice(f));
          },
          ...
          extname: function (l) {
            s(l);
            for (
              var u = -1, c = 0, d = -1, h = !0, f = 0, m = l.length - 1;
              m >= 0;
              --m
            ) {
          ...
          parse: function (l) {
            ...
            h ? ((u.root = "/"), (c = 1)) : (c = 0);
            for (
              var f = -1, m = 0, g = -1, A = !0, T = l.length - 1, E = 0;
              T >= c;
              --T
            )
            ...
            return (
              ...
              (E === 1 && f === g - 1 && f === m + 1)
                ? g !== -1 &&
                  (u.base = u.name =
                    m === 0 && h ? l.slice(1, g) : l.slice(m, g))
                : (m === 0 && h
                    ? ((u.name = l.slice(1, f)), (u.base = l.slice(1, g)))
                    : ((u.name = l.slice(m, f)), (u.base = l.slice(m, g))),
                  (u.ext = l.slice(f, g))),
              m > 0 ? (u.dir = l.slice(0, m - 1)) : h && (u.dir = "/"),
              u
            );
          },
          sep: "/",
  ...
  ((() => {
    ...
    class h {
      ...
      constructor(y, S, x, O, L, _ = !1) {
        typeof y == "object"
          ...
          : ((this.scheme = (function (Te, q) {
              return Te || q ? Te : "file";
            })(y, _)),
            (this.authority = S || u),
            (this.path = (function (Te, q) {
              switch (Te) {
                case "https":
                case "http":
                case "file":
      ...
      with(y) {
        ...
        return (
          ...
          O === void 0 ? (O = this.path) : O === null && (O = u),
          L === void 0 ? (L = this.query) : L === null && (L = u),
          _ === void 0 ? (_ = this.fragment) : _ === null && (_ = u),
          S === this.scheme &&
          x === this.authority &&
          O === this.path &&
          L === this.query &&
      ...
      static file(y) {
        ...
        if ((i && (y = y.replace(/\\/g, c)), y[0] === c && y[1] === c)) {
          ...
          x === -1
            ? ((S = y.substring(2)), (y = c))
            : ((S = y.substring(2, x)), (y = y.substring(x) || c));
        }
    ...
    class m extends h {
      ...
      toJSON() {
        const y = { $mid: 1 };
        return (
          this._fsPath && ((y.fsPath = this._fsPath), (y._sep = f)),
          this._formatted && (y.external = this._formatted),
          this.path && (y.path = this.path),
          this.scheme && (y.scheme = this.scheme),
          this.authority && (y.authority = this.authority),
          this.query && (y.query = this.query),
          this.fragment && (y.fragment = this.fragment),
          y
        );
      }
    }
      ...
      for (let L = 0; L < k.length; L++) {
        ...
        if (
          ...
          (O !== -1 && ((x += encodeURIComponent(k.substring(O, L))), (O = -1)),
            x !== void 0 && (x += k.charAt(L)));
        else {
          x === void 0 && (x = k.substr(0, L));
          const Te = g[_];
          Te !== void 0
            ? (O !== -1 &&
                ((x += encodeURIComponent(k.substring(O, L))), (O = -1)),
              (x += Te))
            : O === -1 && (O = L);
        }
      }
      return (
        O !== -1 && (x += encodeURIComponent(k.substring(O))),
        x !== void 0 ? x : k
      );
    }
    function T(k) {
          ...
          k.authority && k.path.length > 1 && k.scheme === "file"
            ...
            : k.path.charCodeAt(0) === 47 &&
                ((k.path.charCodeAt(1) >= 65 && k.path.charCodeAt(1) <= 90) ||
                  (k.path.charCodeAt(1) >= 97 &&
                    k.path.charCodeAt(1) <= 122)) &&
    ...
    function R(k, y) {
      const S = y ? T : A;
      let x = "",
        { scheme: O, authority: L, path: _, query: Te, fragment: q } = k;
      if (
        (O && ((x += O), (x += ":")),
        (L || O === "file") && ((x += c), (x += c)),
        L)
        ...
        let K = L.indexOf("@");
        if (K !== -1) {
          const ct = L.substr(0, K);
          ((L = L.substr(K + 1)),
            (K = ct.lastIndexOf(":")),
            K === -1
              ? (x += S(ct, !1, !1))
              : ((x += S(ct.substr(0, K), !1, !1)),
                (x += ":"),
                (x += S(ct.substr(K + 1), !1, !0))),
            (x += "@"));
        }
        ((L = L.toLowerCase()),
          (K = L.lastIndexOf(":")),
          K === -1
            ? (x += S(L, !1, !0))
            : ((x += S(L.substr(0, K), !1, !0)), (x += L.substr(K))));
      }
      if (_) {
        if (_.length >= 3 && _.charCodeAt(0) === 47 && _.charCodeAt(2) === 58) {
          ...
          K >= 65 &&
            K <= 90 &&
            (_ = `/${String.fromCharCode(K + 32)}:${_.substr(3)}`);
        } else if (_.length >= 2 && _.charCodeAt(1) === 58) {
          const K = _.charCodeAt(0);
          K >= 65 &&
            K <= 90 &&
            (_ = `${String.fromCharCode(K + 32)}:${_.substr(2)}`);
        }
        x += S(_, !0, !1);
      }
      return (
    ...
    (function (k) {
      ((k.joinPath = function (y, ...S) {
        ...
        (k.resolvePath = function (y, ...S) {
          ...
          return (
            O && L[0] === Fe && !y.authority && (L = L.substring(1)),
            y.with({ path: L })
          );
        }),
        (k.dirname = function (y) {
          ...
          return (
            S.length === 1 && S.charCodeAt(0) === 46 && (S = ""),
            y.with({ path: S })
          );
        }),
...
var rt;
(function (n) {
  ((n.basename = dn.basename),
    (n.dirname = dn.dirname),
    (n.extname = dn.extname),
    (n.joinPath = dn.joinPath),
    (n.resolvePath = dn.resolvePath));
  function e(i, s) {
...
class wm {
  ...
  fromTextDocument(e, t, r) {
    return (
      (t = t ?? At.parse(e.uri)),
      V.CancellationToken.is(r)
        ? this.createAsync(t, e, r)
        : this.create(t, e, r)
    );
  }
  fromString(e, t, r) {
    return V.CancellationToken.is(r)
      ? this.createAsync(t, e, r)
      : this.create(t, e, r);
  }
  fromModel(e, t) {
  ...
  async update(e, t) {
    var r, i;
    const s =
        (r = e.parseResult.value.$cstNode) === null || r === void 0
          ? void 0
          : r.root.fullText,
      a =
        (i = this.textDocuments) === null || i === void 0
          ? void 0
          : i.get(e.uri.toString()),
  ...
  createTextDocumentGetter(e, t) {
    ...
    return () =>
      ...
      (i = Ms.create(
        e.toString(),
        r.getServices(e).LanguageMetaData.languageId,
        0,
        t ?? "",
      ));
  }
...
class Lm {
        ...
        get ref() {
          ...
          if (pd(this._nodeDescription)) {
            ...
            const l = os(e).$document,
              u = s.getLinkedNode({ reference: a, container: e, property: t });
  ...
  getLinkedNode(e) {
    ...
    try {
      ...
      return i
        ? { node: i, descr: r }
        : { descr: r, error: this.createLinkingError(e, r) };
    } catch (r) {
      console.error(
...
class Pm {
  ...
  findReferences(e, t) {
    ...
    return (
      t.documentUri &&
        (i = i.filter((s) => rt.equals(s.sourceUri, t.documentUri))),
      r.push(...i),
      ee(r)
    );
  }
  ...
  constructor(e, t, r) {
    ...
    ((this.elements = e),
      ...
      (this.caseInsensitive =
        (i = r?.caseInsensitive) !== null && i !== void 0 ? i : !1));
  }
  getAllElements() {
...
class Bm {
  ...
  getScope(e) {
    const t = [],
      ...
      i = Ze(e.container).precomputedScopes;
    if (i) {
      let a = e.container;
      do {
        const o = i.get(a);
        (o.length > 0 &&
          t.push(ee(o).filter((l) => this.reflection.isSubtype(l.type, r))),
          (a = a.$container));
      } while (a);
    }
  ...
  getGlobalScope(e, t) {
    return this.globalScopeCache.get(
      e,
      () => new Dm(this.indexManager.allElements(e)),
    );
  }
}
function Vm(n) {
...
class Km {
  ...
  replacer(
    e,
    t,
    { refText: r, sourceText: i, textRegions: s, comments: a, uriConverter: o },
  ) {
    var l, u, c, d;
      ...
      if (Ue(t)) {
        ...
        if (h) {
          ...
          return {
            $error:
              (u =
                (l = t.error) === null || l === void 0 ? void 0 : l.message) !==
                null && u !== void 0
                ? u
        ...
        if (
          ...
          i &&
            ...
            (h ?? (h = Object.assign({}, t)),
            (h.$sourceText =
              (d = t.$cstNode) === null || d === void 0 ? void 0 : d.text)),
          a)
        ) {
          h ?? (h = Object.assign({}, t));
      ...
      if (Array.isArray(u))
        for (let c = 0; c < u.length; c++) {
          ...
          ul(d)
            ...
            : ae(d) && this.linkNode(d, t, r, e, l, c);
        }
      else
        ul(u)
          ? (e[l] = this.reviveReference(e, l, t, u, r))
          : ae(u) && this.linkNode(u, t, r, e, l);
    const o = e;
  ...
  reviveReference(e, t, r, i, s) {
    ...
    if (i.$ref) {
      ...
      if (ae(l))
        return (
          a || (a = this.nameProvider.getName(l)),
          { $refText: a ?? "", ref: l }
        );
      o = l;
    }
  ...
  getRefNode(e, t, r) {
    try {
      ...
      if (i < 0) {
        const l = r ? r(t) : At.parse(t),
          u = this.langiumDocuments.getDocument(l);
        return u
          ? u.parseResult.value
          : "Could not find document for URI: " + t;
      }
      const s = r ? r(t.substring(0, i)) : At.parse(t.substring(0, i)),
...
class jm {
  ...
  getChecks(e, t) {
    ...
    return (
      t && (r = r.filter((i) => t.includes(i.category))),
      r.map((i) => i.check)
    );
  }
...
class Hm {
      ...
      (!t.categories || t.categories.includes("built-in")) &&
        ...
        (t.stopAfterLexingErrors &&
          s.some((a) => {
            var o;
            return (
              ((o = a.data) === null || o === void 0 ? void 0 : o.code) ===
              Oe.LexingError
            );
          })) ||
  ...
  async validateAstBefore(e, t, r, i = V.CancellationToken.None) {
    ...
    for (const o of a)
      (await Ae(i),
        await o(e, r, (s = t.categories) !== null && s !== void 0 ? s : [], i));
  }
  ...
  createDescription(e, t, r) {
    ...
    const o = () => {
      ...
      return (
        a ??
        (a = jr(
          (l = this.nameProvider.getNameNode(e)) !== null && l !== void 0
            ? l
            : e.$cstNode,
        ))
      );
  ...
  async initialized(e) {
    if (this.workspaceConfig) {
      if (e.register) {
        ...
        e.register({
          section: t.map((r) =>
            this.toSectionName(r.LanguageMetaData.languageId),
          ),
        });
      }
...
class eg {
      ...
      if (a.state === U.Validated) {
        if (typeof t.validation == "boolean" && t.validation)
          ...
          const l = this.buildState.get(o),
            u =
              (i = l?.result) === null || i === void 0
                ? void 0
                : i.validationChecks;
          if (u) {
            const d = (
              (s = t.validation.categories) !== null && s !== void 0
                ? s
                : di.all
  ...
  async update(e, t, r = V.CancellationToken.None) {
    ...
    for (const a of e) {
      if (!this.langiumDocuments.invalidateDocument(a)) {
        const l = this.langiumDocumentFactory.fromModel(
          { $type: "INVALID" },
          a,
        );
      ...
      this.langiumDocuments.all
        .filter((a) => {
          ...
          return (
            ...
            !(
              !(
                (o = this.buildState.get(a.uri.toString())) === null ||
                o === void 0
              ) && o.completed
            )
          );
  ...
  hasTextDocument(e) {
    var t;
    return !!(
      !((t = this.textDocuments) === null || t === void 0) && t.get(e.uri)
    );
  }
  shouldRelink(e, t) {
  ...
  async buildDocuments(e, t, r) {
    (this.prepareBuild(e, t),
      await this.runCancelable(e, U.Parsed, r, (s) =>
        this.langiumDocumentFactory.update(s, r),
      ),
      ...
      await this.runCancelable(e, U.ComputedScopes, r, async (s) => {
        const a = this.serviceRegistry.getServices(s.uri).references
          .ScopeComputation;
  ...
  async validate(e, t) {
    var r, i;
    const s = this.serviceRegistry.getServices(e.uri).validation
        .DocumentValidator,
    ...
    if (u) {
      ...
      const c = (i = o?.categories) !== null && i !== void 0 ? i : di.all;
  ...
  getFileDescriptions(e, t) {
    ...
    return t
      ? this.symbolByTypeIndex.get(e, t, () => {
          var s;
          return (
            (s = this.symbolIndex.get(e)) !== null && s !== void 0 ? s : []
          ).filter((o) => this.astReflection.isSubtype(o.type, t));
        })
...
class ng {
  ...
  initialize(e) {
    var t;
    this.folders =
      (t = e.workspaceFolders) !== null && t !== void 0 ? t : void 0;
  }
  initialized(e) {
    return this.mutex.write((t) => {
      var r;
      return this.initializeWorkspace(
        (r = this.folders) !== null && r !== void 0 ? r : [],
        t,
      );
    });
  }
    ...
    return (
      ...
      await Promise.all(
        e
          ...
          .map(async (s) => this.traverseFolder(...s, t, i)),
      ),
      this._ready.resolve(),
      r
    );
...
function og(n, e, t) {
  ...
  const s = oc(n),
    a = fa(r),
    o = cg({ lines: s, position: i, options: a });
...
function oc(n) {
  let e = "";
  return (typeof n == "string" ? (e = n) : (e = n.text), e.split(jd));
}
...
function cg(n) {
  ...
  for (let o = 0; o < n.lines.length; o++) {
    const l = o === 0,
      u = o === n.lines.length - 1;
    let c = n.lines[o],
      d = 0;
    if (l && n.options.start) {
      const f =
        (e = n.options.start) === null || e === void 0 ? void 0 : e.exec(c);
      f && (d = f.index + f[0].length);
    } else {
      const f =
        (t = n.options.line) === null || t === void 0 ? void 0 : t.exec(c);
      f && (d = f.index + f[0].length);
    }
    if (u) {
      const f =
        (r = n.options.end) === null || r === void 0 ? void 0 : r.exec(c);
      f && (c = c.substring(0, f.index));
    }
    if (((c = c.substring(0, pg(c))), Fs(c, d) >= c.length)) {
      if (i.length > 0) {
...
const fg = /\S/,
  hg = /\s*$/;
function Fs(n, e) {
  const t = n.substring(e).match(fg);
...
function mg(n) {
  ...
  if (n.tokens.length === 0) return new fl([], b.create(s, s));
  const a = [];
  ...
  const o =
      (t = (e = a[0]) === null || e === void 0 ? void 0 : e.range.start) !==
        null && t !== void 0
        ? t
        : s,
    l =
...
function gg(n, e) {
  ...
  if (t.type === "tag") return uc(n, !1);
  if (t.type === "text" || t.type === "inline-tag") return lc(n);
  (yg(t, e), n.index++);
}
function yg(n, e) {
  if (e) {
...
function lc(n) {
  ...
  for (; e && e.type !== "break" && e.type !== "tag"; )
    (i.push(Tg(n)), (r = e), (e = n.tokens[n.index]));
  ...
  if (i?.type === "text")
    if (e) {
      ...
      return new zi(
        ...
        new Gs([s], s.range),
        e,
        b.create(t.range.start, s.range.end),
      );
    } else {
      const s = lc(n);
...
function fa(n) {
  if (!n) return fa({ start: "/**", end: "*/", line: "*" });
  const { start: e, end: t, line: r } = n;
  return { start: Hi(e, !0), end: Hi(t, !1), line: Hi(r, !0) };
}
function Hi(n, e) {
...
function Rg(n, e, t) {
  ...
  if (n === "linkplain" || n === "linkcode" || n === "link") {
    ...
    return (
      (n === "linkcode" || (n === "link" && t.link === "code")) &&
        (a = `\`${a}\``),
      (i =
        (r = t.renderLink) === null || r === void 0
          ? void 0
          : r.call(t, e, a)) !== null && i !== void 0
        ? i
        : vg(e, a)
    );
  }
...
class Eg {
  ...
  getComment(e) {
    ...
    return Vm(e)
      ? e.$comment
      : (t = Ad(e.$cstNode, this.grammarConfig().multilineCommentRules)) ===
            null || t === void 0
        ? void 0
        : t.text;
  }
...
class xg {
  ...
  hydrateCstLeafNode(e) {
    ...
    return new Os(
      r,
      i,
      { start: { line: s, character: a }, end: { line: o, character: l } },
      t,
      u,
    );
  }
...
function at(n) {
  return {
    ...
    parser: {
      ...
      LexerErrorMessageProvider: () => new rg(),
    },
    workspace: {
      AstNodeLocator: () => new Jm(),
      AstNodeDescriptionProvider: (e) => new Ym(e),
      ReferenceDescriptionProvider: (e) => new Xm(e),
    },
    references: {
      Linker: (e) => new Lm(e),
      NameProvider: () => new bm(),
      ScopeProvider: (e) => new Bm(e),
      ScopeComputation: (e) => new Mm(e),
      References: (e) => new Pm(e),
    },
    serializer: {
      Hydrator: (e) => new xg(e),
      JsonSerializer: (e) => new Km(e),
    },
    validation: {
      DocumentValidator: (e) => new Hm(e),
      ValidationRegistry: (e) => new jm(e),
    },
    shared: () => n.shared,
  };
}
function ot(n) {
  return {
    ServiceRegistry: (e) => new Wm(e),
    workspace: {
      LangiumDocuments: (e) => new _m(e),
      LangiumDocumentFactory: (e) => new wm(e),
      DocumentBuilder: (e) => new eg(e),
      IndexManager: (e) => new tg(e),
      WorkspaceManager: (e) => new ng(e),
      FileSystemProvider: (e) => n.fileSystemProvider(e),
      WorkspaceLock: () => new $g(),
      ConfigurationProvider: (e) => new Zm(e),
    },
  };
}
var pl;
...
const lt = { fileSystemProvider: () => new Ig() },
  Cg = {
    Grammar: () => {},
    LanguageMetaData: () => ({
      caseInsensitive: !1,
...
function xt(n) {
  ...
  return (
    t.shared.workspace.LangiumDocumentFactory.fromModel(
      r,
      At.parse(
        `memory://${(e = r.name) !== null && e !== void 0 ? e : "grammar"}.langium`,
      ),
    ),
    r
  );
...
var _g = Object.defineProperty,
  v = (n, e) => _g(n, "name", { value: e, configurable: !0 }),
  yl = "Statement",
  Dr = "Architecture";
function Lg(n) {
...
var rs = "TreemapRow",
  ...
  St = { AstReflection: v(() => new hc(), "AstReflection") },
  ry = {
    Grammar: v(() => Kg(), "Grammar"),
    LanguageMetaData: v(() => Xg, "LanguageMetaData"),
    parser: {},
  },
  iy = {
    Grammar: v(() => Wg(), "Grammar"),
    LanguageMetaData: v(() => Jg, "LanguageMetaData"),
    parser: {},
  },
  sy = {
    Grammar: v(() => jg(), "Grammar"),
    LanguageMetaData: v(() => Qg, "LanguageMetaData"),
    parser: {},
  },
  ay = {
    Grammar: v(() => Hg(), "Grammar"),
    LanguageMetaData: v(() => Zg, "LanguageMetaData"),
    parser: {},
  },
  oy = {
    Grammar: v(() => zg(), "Grammar"),
    LanguageMetaData: v(() => ey, "LanguageMetaData"),
    parser: {},
  },
  ly = {
    Grammar: v(() => qg(), "Grammar"),
    LanguageMetaData: v(() => ty, "LanguageMetaData"),
    parser: {},
  },
  uy = {
    Grammar: v(() => Yg(), "Grammar"),
  ...
  dy = /accTitle[\t ]*:([^\n\r]*)/,
  fy = /title([\t ][^\n\r]*|)/,
  hy = { ACC_DESCR: cy, ACC_TITLE: dy, TITLE: fy },
  bt,
  Ii =
    ((bt = class extends Zu {
      runConverter(e, t, r) {
...
`,
  ...
  ut =
    ...
    Mt),
  Dt;
((Dt = class extends ut {}), v(Dt, "CommonTokenBuilder"));
var Ft,
  py =
    ((Ft = class extends ut {
      constructor() {
  ...
  pc = {
    parser: {
      TokenBuilder: v(() => new py(), "TokenBuilder"),
      ValueConverter: v(() => new Ci(), "ValueConverter"),
    },
  };
function mc(n = lt) {
  const e = oe(ot(n), St),
    t = oe(at({ shared: e }), oy, pc);
...
var Gt,
  ...
  gc = {
    parser: {
      TokenBuilder: v(() => new my(), "TokenBuilder"),
      ValueConverter: v(() => new Ci(), "ValueConverter"),
    },
  };
function yc(n = lt) {
  const e = oe(ot(n), St),
    t = oe(at({ shared: e }), ry, gc);
...
var Bt,
  ...
  vc = {
    parser: {
      TokenBuilder: v(() => new yy(), "TokenBuilder"),
      ValueConverter: v(() => new Ty(), "ValueConverter"),
    },
  };
function Ac(n = lt) {
  const e = oe(ot(n), St),
    t = oe(at({ shared: e }), sy, vc);
...
var Kt,
  ...
  Ec = {
    parser: {
      ...
      ValueConverter: v(() => new vy(), "ValueConverter"),
    },
  };
function kc(n = lt) {
  const e = oe(ot(n), St),
    t = oe(at({ shared: e }), ay, Ec);
...
var jt,
  ...
  $c = {
    parser: {
      TokenBuilder: v(() => new Ay(), "TokenBuilder"),
      ValueConverter: v(() => new Ci(), "ValueConverter"),
    },
  };
function xc(n = lt) {
  const e = oe(ot(n), St),
    t = oe(at({ shared: e }), ly, $c);
...
var qt,
  ...
  Ic = {
    parser: {
      TokenBuilder: v(() => new Ey(), "TokenBuilder"),
      ValueConverter: v(() => new $y(), "ValueConverter"),
    },
    validation: { TreemapValidator: v(() => new xy(), "TreemapValidator") },
  };
function Cc(n = lt) {
  const e = oe(ot(n), St),
    t = oe(at({ shared: e }), uy, Ic);
...
var je = {},
  Sy = {
    info: v(async () => {
      const { createInfoServices: n } = await ft(
          async () => {
            const { createInfoServices: t } = await Promise.resolve().then(
              () => Ny,
            );
    ...
    packet: v(async () => {
      const { createPacketServices: n } = await ft(
          async () => {
            const { createPacketServices: t } = await Promise.resolve().then(
              () => wy,
            );
    ...
    pie: v(async () => {
      const { createPieServices: n } = await ft(
          async () => {
            const { createPieServices: t } = await Promise.resolve().then(
              () => _y,
            );
    ...
    architecture: v(async () => {
      const { createArchitectureServices: n } = await ft(
          async () => {
            const { createArchitectureServices: t } =
              await Promise.resolve().then(() => Ly);
    ...
    gitGraph: v(async () => {
      const { createGitGraphServices: n } = await ft(
          async () => {
            const { createGitGraphServices: t } = await Promise.resolve().then(
              () => Oy,
            );
    ...
    radar: v(async () => {
      const { createRadarServices: n } = await ft(
          async () => {
            const { createRadarServices: t } = await Promise.resolve().then(
              () => by,
            );
    ...
    treemap: v(async () => {
      const { createTreemapServices: n } = await ft(
          async () => {
            const { createTreemapServices: t } = await Promise.resolve().then(
              () => Py,
            );
...
async function Iy(n, e) {
  ...
  if (i.lexerErrors.length > 0 || i.parserErrors.length > 0) throw new Cy(i);
  return i.value;
}
v(Iy, "parse");
var Yt,
...
const Ny = Object.freeze(
    Object.defineProperty(
      { __proto__: null, InfoModule: gc, createInfoServices: yc },
      Symbol.toStringTag,
      { value: "Module" },
    ),
  ),
  wy = Object.freeze(
    Object.defineProperty(
      { __proto__: null, PacketModule: Tc, createPacketServices: Rc },
      Symbol.toStringTag,
      { value: "Module" },
    ),
  ),
  _y = Object.freeze(
    Object.defineProperty(
      { __proto__: null, PieModule: vc, createPieServices: Ac },
      Symbol.toStringTag,
      { value: "Module" },
    ),
  ),
  Ly = Object.freeze(
    Object.defineProperty(
      {
        __proto__: null,
        ArchitectureModule: Ec,
        createArchitectureServices: kc,
      },
      Symbol.toStringTag,
      { value: "Module" },
    ),
  ...
  Oy = Object.freeze(
    Object.defineProperty(
      { __proto__: null, GitGraphModule: pc, createGitGraphServices: mc },
      Symbol.toStringTag,
      { value: "Module" },
    ),
  ),
  by = Object.freeze(
    Object.defineProperty(
      { __proto__: null, RadarModule: $c, createRadarServices: xc },
      Symbol.toStringTag,
      { value: "Module" },
    ),
  ),
  Py = Object.freeze(
    Object.defineProperty(
      { __proto__: null, TreemapModule: Ic, createTreemapServices: Cc },
      Symbol.toStringTag,
      { value: "Module" },
    ),
  );
export { Iy as p };
//# sourceMappingURL=treemap-KMMF4GRG-CTteDAEM.js.map
