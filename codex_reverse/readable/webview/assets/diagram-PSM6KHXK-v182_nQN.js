...
import { s as we } from "./chunk-QN33PNHL-C4LLq_9I.js";
import { p as Ce } from "./chunk-4BX2VUAB-DA7Q3XYm.js";
import { p as Te } from "./treemap-KMMF4GRG-CTteDAEM.js";
  ...
  return (
    ...
    (u.padding = function (r) {
      return arguments.length
        ? u.paddingInner(r).paddingOuter(r)
        : u.paddingInner();
    }),
    (u.paddingInner = function (r) {
      return arguments.length
        ? ((s = typeof r == "function" ? r : q(+r)), u)
        : s;
    }),
    ...
    (u.paddingTop = function (r) {
      return arguments.length
        ? ((d = typeof r == "function" ? r : q(+r)), u)
        : d;
    }),
    (u.paddingRight = function (r) {
      return arguments.length
        ? ((h = typeof r == "function" ? r : q(+r)), u)
        : h;
    }),
    (u.paddingBottom = function (r) {
      return arguments.length
        ? ((m = typeof r == "function" ? r : q(+r)), u)
        : m;
    }),
    (u.paddingLeft = function (r) {
      return arguments.length
        ? ((c = typeof r == "function" ? r : q(+r)), u)
        : c;
    }),
    u
  );
...
var Qe = w((t, a) => {
  ...
  at = w((t, a, l, n) => {
    ...
    const u = h ? 30 : 0,
      b = he(a),
      r = s.nodeWidth ? s.nodeWidth * P : 960,
      x = s.nodeHeight ? s.nodeHeight * P : 500,
      S = r,
      v = x + u;
    ...
    const V = b
      ...
      ee = Ke()
        .size([r, x])
        .paddingTop((e) => (e.children && e.children.length > 0 ? X + P : 0))
        .paddingInner(d)
        .paddingLeft((e) => (e.children && e.children.length > 0 ? P : 0))
        .paddingRight((e) => (e.children && e.children.length > 0 ? P : 0))
        .paddingBottom((e) => (e.children && e.children.length > 0 ? P : 0))
        .round(!0)(R),
    ...
    (j
      ...
      .attr(
        "style",
        (e) => B({ cssCompiledStyles: e.data.cssCompiledStyles }).nodeStyles,
      )
        ...
        j
          ...
          .attr("style", (i) => {
            const f =
                ...
                k(i.data.name) +
                ";",
              C = B({ cssCompiledStyles: i.data.cssCompiledStyles });
...
//# sourceMappingURL=diagram-PSM6KHXK-v182_nQN.js.map
