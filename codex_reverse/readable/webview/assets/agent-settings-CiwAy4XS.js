...
function B() {
  ...
  e[2] !== a
    ? ((o = () => {
        a("/settings/open-source-licenses");
      }),
      (e[2] = a),
      (e[3] = o))
    : (o = e[3]);
...
function z() {
  ...
  e[1] !== n
    ? ((r = {
        params: s,
        queryConfig: { enabled: n, staleTime: W.ONE_MINUTE },
      }),
      (e[1] = n),
      (e[2] = r))
    : (r = e[2]);
  const { data: w } = _("open-in-targets", r),
    m = v("open-file"),
    p = a?.platform === "win32" && a?.hasWsl && l,
    g = i?.codexHome ? `${i.codexHome}/config.toml` : null,
    x = w?.preferredTarget ?? void 0;
  let d;
  e[3] !== p
    ? ((d = p
        ? t.jsx(c, { ...y.openConfigTomlWsl })
        : t.jsx(c, { ...y.openConfigToml })),
      (e[3] = p),
      (e[4] = d))
    : (d = e[4]);
  const h = d;
  ...
  e[5] !== g || e[6] !== m || e[7] !== x
    ? ((f = () => {
        g && m.mutate({ path: g, cwd: null, target: x });
      }),
      (e[5] = g),
      (e[6] = m),
      (e[7] = x),
...
export { $ as AgentSettings };
//# sourceMappingURL=agent-settings-CiwAy4XS.js.map
