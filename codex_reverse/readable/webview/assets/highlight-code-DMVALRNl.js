import { bB as Ln, bV as Mn, cN as Pn } from "./index-BnRAGF7J.js";
var ut, Mt;
function vn() {
  if (Mt) return ut;
  Mt = 1;
  function e(n) {
    return (
      ...
      Object.getOwnPropertyNames(n).forEach((o) => {
        const p = n[o],
          M = typeof p;
        (M === "object" || M === "function") && !Object.isFrozen(p) && e(p);
      }),
      n
    );
  }
  ...
  function a(n, ...o) {
    ...
    for (const M in n) p[M] = n[M];
    return (
      o.forEach(function (M) {
        for (const q in M) p[q] = M[q];
      }),
      p
    );
  }
  ...
  class l {
    constructor(o, p) {
      ((this.buffer = ""), (this.classPrefix = p.classPrefix), o.walk(this));
    }
    addText(o) {
      this.buffer += i(o);
    }
    openNode(o) {
      if (!E(o)) return;
      const p = c(o.scope, { prefix: this.classPrefix });
      this.span(p);
    }
    closeNode(o) {
      E(o) && (this.buffer += r);
  ...
  class s {
    constructor() {
      ((this.rootNode = m()), (this.stack = [this.rootNode]));
    }
    get top() {
    ...
    static _walk(o, p) {
      return (
        typeof p == "string"
          ...
          : p.children &&
            (o.openNode(p),
            p.children.forEach((M) => this._walk(o, M)),
            o.closeNode(p)),
        o
      );
    }
    static _collapse(o) {
      typeof o != "string" &&
        o.children &&
        (o.children.every((p) => typeof p == "string")
  ...
  class d extends s {
    ...
    __addSublanguage(o, p) {
      const M = o.root;
      (p && (M.scope = `language:${p}`), this.add(M));
    }
    toHTML() {
  ...
  function _(...n) {
    return n.map((p) => b(p)).join("");
  }
  function R(n) {
    const o = n[n.length - 1];
    return typeof o == "object" && o.constructor === Object
      ? (n.splice(n.length - 1, 1), o)
      : {};
  }
  function C(...n) {
    return (
      "(" + (R(n).capture ? "" : "?:") + n.map((M) => b(M)).join("|") + ")"
    );
  }
  function L(n) {
    ...
    return n
      .map((M) => {
        ...
        for (; Y.length > 0; ) {
          ...
          ((A += Y.substring(0, N.index)),
            (Y = Y.substring(N.index + N[0].length)),
            N[0][0] === "\\" && N[1]
              ? (A += "\\" + String(Number(N[1]) + q))
              : ((A += N[0]), N[0] === "(" && p++));
        }
        return A;
      })
  ...
  const y = /\b\B/,
    ...
    de = (n = {}) => {
      const o = /^#![ ]*\//;
      return (
        n.binary && (n.begin = _(o, /.*\b/, n.binary, /\b.*/)),
        a(
          {
            scope: "meta",
            begin: o,
    ...
    G = function (n, o, p = {}) {
      const M = a({ scope: "comment", begin: n, end: o, contains: [] }, p);
      M.contains.push({
        scope: "doctag",
    ...
    se = G("/\\*", "\\*/"),
    ae = G("#", "$"),
    ne = { scope: "number", begin: W, relevance: 0 },
    be = { scope: "number", begin: F, relevance: 0 },
    Ye = { scope: "number", begin: X, relevance: 0 },
    ve = {
      scope: "regexp",
      begin: /\/(?=[^/\n]*\/)/,
      end: /\/[gimuy]*/,
    ...
    Le = { scope: "title", begin: $, relevance: 0 },
    Xe = { scope: "title", begin: k, relevance: 0 },
    xe = { begin: "\\.\\s*" + k, relevance: 0 };
  var he = Object.freeze({
    ...
    END_SAME_AS_BEGIN: function (n) {
      return Object.assign(n, {
        "on:begin": (o, p) => {
          p.data._beginMatch = o[1];
        },
        "on:end": (o, p) => {
          p.data._beginMatch !== o[1] && p.ignoreMatch();
        },
      });
    },
  ...
  function Ze(n, o) {
    n.input[n.index - 1] === "." && o.ignoreMatch();
  }
  function Je(n, o) {
  ...
  function je(n, o) {
    o &&
      n.beginKeywords &&
      ((n.begin =
        "\\b(" + n.beginKeywords.split(" ").join("|") + ")(?!\\.)(?=\\b|\\s)"),
      (n.__beforeBegin = Ze),
  ...
  function et(n, o) {
    Array.isArray(n.illegal) && (n.illegal = C(...n.illegal));
  }
  function tt(n, o) {
    if (n.match) {
      if (n.begin || n.end)
  ...
  const De = (n, o) => {
      ...
      (Object.keys(n).forEach((M) => {
        ...
        (n.begin = _(p.beforeMatch, g(p.begin))),
        (n.starts = {
          relevance: 0,
          contains: [Object.assign(p, { endsParent: !0 })],
        }),
        (n.relevance = 0),
        delete p.beforeMatch);
    },
    Ae = [
      "of",
      "and",
      ...
      typeof n == "string"
        ...
        : Array.isArray(n)
          ...
          : Object.keys(n).forEach(function (Y) {
              Object.assign(M, Et(n[Y], o, Y));
            }),
      M
    );
    function q(Y, A) {
      (o && (A = A.map((N) => N.toLowerCase())),
  ...
  function en(n, o) {
    return o ? Number(o) : tn(n) ? 0 : 1;
  }
  function tn(n) {
    return Ae.includes(n.toLowerCase());
  }
  const St = {},
    Ce = (n) => {
      console.error(n);
    ...
    bt = (n, ...o) => {
      console.log(`WARN: ${n}`, ...o);
    },
    Ie = (n, o) => {
      St[`${n}/${o}`] ||
        (console.log(`Deprecated as of ${n}. ${o}`), (St[`${n}/${o}`] = !0));
    },
    Fe = new Error();
  function Tt(n, o, { key: p }) {
    let M = 0;
    const q = n[p],
      Y = {},
      A = {};
    for (let N = 1; N <= o.length; N++)
      ((A[N + M] = q[N]), (Y[N + M] = !0), (M += L(o[N - 1])));
    ((n[p] = A), (n[p]._emit = Y), (n[p]._multi = !0));
  }
  function nn(n) {
    if (Array.isArray(n.begin)) {
      ...
      if (typeof n.beginScope != "object" || n.beginScope === null)
        throw (Ce("beginScope must be object"), Fe);
      (Tt(n, n.begin, { key: "beginScope" }),
        (n.begin = v(n.begin, { joinWith: "" })));
    }
  }
  function an(n) {
    if (Array.isArray(n.end)) {
      if (n.skip || n.excludeEnd || n.returnEnd)
        throw (
          Ce("skip, excludeEnd, returnEnd not compatible with endScope: {}"),
          Fe
        );
      if (typeof n.endScope != "object" || n.endScope === null)
        throw (Ce("endScope must be object"), Fe);
      (Tt(n, n.end, { key: "endScope" }), (n.end = v(n.end, { joinWith: "" })));
    }
  }
  function on(n) {
    n.scope &&
  ...
  function sn(n) {
    ...
    class p {
      ...
      compile() {
        ...
        ((this.matcherRe = o(v(N, { joinWith: "|" }), !0)),
          (this.lastIndex = 0));
      }
      exec(N) {
        ...
        if (!O) return null;
        const ee = O.findIndex((Me, at) => at > 0 && Me !== void 0),
          Z = this.matchIndexes[ee];
        return (O.splice(0, ee), Object.assign(O, Z));
      }
    }
    class M {
      constructor() {
      ...
      getMatcher(N) {
        ...
        const O = new p();
        return (
          this.rules.slice(N).forEach(([ee, Z]) => O.addRule(ee, Z)),
          O.compile(),
      ...
      exec(N) {
        ...
        if (
          ...
          !(ee && ee.index === this.lastIndex)
        ) {
          const Z = this.getMatcher(0);
          ((Z.lastIndex = this.lastIndex + 1), (ee = Z.exec(N)));
        }
        return (
          ee &&
            ((this.regexIndex += ee.position + 1),
    ...
    function q(A) {
      const N = new M();
      return (
        A.contains.forEach((O) =>
          N.addRule(O.begin, { rule: O, type: "begin" }),
        ),
        A.terminatorEnd && N.addRule(A.terminatorEnd, { type: "end" }),
        A.illegal && N.addRule(A.illegal, { type: "illegal" }),
        N
      );
    }
    function Y(A, N) {
      ...
      ([Je, tt, rn, De].forEach((Z) => Z(A, N)),
        n.compilerExtensions.forEach((Z) => Z(A, N)),
        (A.__beforeBegin = null),
        [je, et, V].forEach((Z) => Z(A, N)),
        (A.isCompiled = !0));
      let ee = null;
      return (
        typeof A.keywords == "object" &&
          ...
          (ee = A.keywords.$pattern),
          delete A.keywords.$pattern),
        (ee = ee || /\w+/),
        A.keywords && (A.keywords = Et(A.keywords, n.case_insensitive)),
        (O.keywordPatternRe = o(ee, !0)),
        N &&
          (A.begin || (A.begin = /\B|\b/),
          (O.beginRe = o(O.begin)),
          !A.end && !A.endsWithParent && (A.end = /\B|\b/),
          A.end && (O.endRe = o(O.end)),
          (O.terminatorEnd = b(O.end) || ""),
          A.endsWithParent &&
            N.terminatorEnd &&
            (O.terminatorEnd += (A.end ? "|" : "") + N.terminatorEnd)),
        A.illegal && (O.illegalRe = o(A.illegal)),
        A.contains || (A.contains = []),
        (A.contains = [].concat(
          ...A.contains.map(function (Z) {
            return ln(Z === "self" ? A : Z);
          }),
        )),
        A.contains.forEach(function (Z) {
          Y(Z, O);
        }),
        A.starts && Y(A.starts, N),
        (O.matcher = q(O)),
        O
      );
    }
    ...
    return ((n.classNameAliases = a(n.classNameAliases || {})), Y(n));
  }
  function _t(n) {
  ...
  function ln(n) {
    return (
      n.variants &&
        !n.cachedVariants &&
        (n.cachedVariants = n.variants.map(function (o) {
          return a(n, { variants: null }, o);
        })),
      n.cachedVariants
        ? n.cachedVariants
        : _t(n)
  ...
  class un extends Error {
    constructor(o, p) {
      (super(o), (this.name = "HTMLInjectionError"), (this.html = p));
    }
  }
  const it = i,
    Nt = a,
    ...
    Ct = function (n) {
      ...
      function O(u) {
        return N.noHighlightRe.test(u);
      }
      function ee(u) {
        let I = u.className + " ";
        I += u.parentNode ? u.parentNode.className : "";
        const w = N.languageDetectRe.exec(I);
        if (w) {
          const z = _e(w[1]);
          return (
            z ||
              (bt(Y.replace("{}", w[1])),
              bt("Falling back to no-highlight mode for this block.", u)),
            z ? w[1] : "no-highlight"
          );
        }
        return I.split(/\s+/).find((z) => O(z) || _e(z));
      }
      function Z(u, I, w) {
        let z = "",
          j = "";
        (typeof I == "object"
          ? ((z = u), (w = I.ignoreIllegals), (j = I.language))
          : (Ie(
              "10.7.0",
...
https://github.com/highlightjs/highlight.js/issues/2277`,
            ...
            (z = I)),
          w === void 0 && (w = !0));
        const me = { code: z, language: j };
        we("before:highlight", me);
        const Ne = me.result ? me.result : Me(me.language, me.code, w);
        return ((Ne.code = me.code), we("after:highlight", Ne), Ne);
      }
      function Me(u, I, w, z) {
        ...
        function Ne() {
          ...
          let h = x.keywordPatternRe.exec(K),
            B = "";
          for (; h; ) {
            B += K.substring(S, h.index);
            const U = pe.case_insensitive ? h[0].toLowerCase() : h[0],
              oe = me(x, U);
            if (oe) {
              const [Te, yn] = oe;
              if (
                ...
                const On = pe.classNameAliases[Te] || Te;
                ge(h[0], On);
              }
            } else B += h[0];
            ((S = x.keywordPatternRe.lastIndex),
              (h = x.keywordPatternRe.exec(K)));
          }
          ((B += K.substring(S)), ie.addText(B));
        }
        function ke() {
          if (K === "") return;
          let S = null;
          if (typeof x.subLanguage == "string") {
            ...
            ((S = Me(x.subLanguage, K, !0, Lt[x.subLanguage])),
              (Lt[x.subLanguage] = S._top));
          } else S = ot(K, x.subLanguage.length ? x.subLanguage : null);
          (x.relevance > 0 && (Ue += S.relevance),
            ie.__addSublanguage(S._emitter, S.language));
        }
        function ce() {
          (x.subLanguage != null ? ke() : Ne(), (K = ""));
        }
        function ge(S, h) {
          S !== "" && (ie.startScope(h), ie.addText(S), ie.endScope());
        }
        function It(S, h) {
          let B = 1;
          const U = h.length - 1;
          for (; B <= U; ) {
            ...
            const oe = pe.classNameAliases[S[B]] || S[B],
              Te = h[B];
            (oe ? ge(Te, oe) : ((K = Te), Ne(), (K = "")), B++);
          }
        }
        function ft(S, h) {
          return (
            S.scope &&
              ...
              ie.openNode(pe.classNameAliases[S.scope] || S.scope),
            S.beginScope &&
              (S.beginScope._wrap
                ? (ge(
                    K,
                    pe.classNameAliases[S.beginScope._wrap] ||
                      S.beginScope._wrap,
                  ),
                  (K = ""))
                : S.beginScope._multi && (It(S.beginScope, h), (K = ""))),
            (x = Object.create(S, { parent: { value: x } })),
            x
          );
        }
        function yt(S, h, B) {
          ...
          if (U) {
            if (S["on:end"]) {
              const oe = new t(S);
              (S["on:end"](h, oe), oe.isMatchIgnored && (U = !1));
            }
            if (U) {
          ...
          if (S.endsWithParent) return yt(S.parent, h, B);
        }
        function Rn(S) {
          return x.matcher.regexIndex === 0 ? ((K += S[0]), 1) : ((ct = !0), 0);
        }
        function hn(S) {
          const h = S[0],
            B = S.rule,
            U = new t(B),
            oe = [B.__beforeBegin, B["on:begin"]];
          for (const Te of oe)
            if (Te && (Te(S, U), U.isMatchIgnored)) return Rn(h);
          return (
            B.skip
              ? (K += h)
              : (B.excludeBegin && (K += h),
                ce(),
                !B.returnBegin && !B.excludeBegin && (K = h)),
            ft(B, S),
            B.returnBegin ? 0 : h.length
          );
        }
        function Dn(S) {
          const h = S[0],
            B = I.substring(S.index),
            U = yt(x, S, B);
          if (!U) return At;
          const oe = x;
          x.endScope && x.endScope._wrap
            ? (ce(), ge(h, x.endScope._wrap))
            : x.endScope && x.endScope._multi
              ? (ce(), It(x.endScope, S))
              : oe.skip
                ? (K += h)
                : (oe.returnEnd || oe.excludeEnd || (K += h),
                  ce(),
                  oe.excludeEnd && (K = h));
          do
            (x.scope && ie.closeNode(),
              !x.skip && !x.subLanguage && (Ue += x.relevance),
              (x = x.parent));
          while (x !== U.parent);
          return (U.starts && ft(U.starts, S), oe.returnEnd ? 0 : h.length);
        }
        function In() {
          const S = [];
          for (let h = x; h !== pe; h = h.parent) h.scope && S.unshift(h.scope);
          S.forEach((h) => ie.openNode(h));
        }
        let Ge = {};
        function Ot(S, h) {
          const B = h && h[0];
          if (((K += S), B == null)) return (ce(), 0);
          if (
            Ge.type === "begin" &&
            h.type === "end" &&
            Ge.index === h.index &&
            ...
            if (((K += I.slice(h.index, h.index + 1)), !q)) {
              const U = new Error(`0 width match regex (${u})`);
              throw ((U.languageName = u), (U.badRule = Ge.rule), U);
            }
            return 1;
          }
          if (((Ge = h), h.type === "begin")) return hn(h);
          if (h.type === "illegal" && !w) {
            const U = new Error(
              'Illegal lexeme "' +
                B +
...
`),
        ...
        let K = "",
          ...
          ct = !1;
        try {
          if (pe.__emitTokens) pe.__emitTokens(I, ie);
          else {
            for (x.matcher.considerAll(); ; ) {
              (lt++,
                ct ? (ct = !1) : x.matcher.considerAll(),
                (x.matcher.lastIndex = Re));
              const S = x.matcher.exec(I);
              if (!S) break;
              const h = I.substring(Re, S.index),
                B = Ot(h, S);
              Re = S.index + B;
            }
            Ot(I.substring(Re));
      ...
      function at(u) {
        ...
        return (I._emitter.addText(u), I);
      }
      function ot(u, I) {
        I = I || N.languages || Object.keys(o);
        const w = at(u),
          z = I.filter(_e)
            .filter(Dt)
            .map((ce) => Me(ce, u, !1));
        z.unshift(w);
        const j = z.sort((ce, ge) => {
            if (ce.relevance !== ge.relevance)
              return ge.relevance - ce.relevance;
            if (ce.language && ge.language) {
              if (_e(ce.language).supersetOf === ge.language) return 1;
              if (_e(ge.language).supersetOf === ce.language) return -1;
            }
            return 0;
          }),
          [me, Ne] = j,
      ...
      function mn(u, I, w) {
        const z = (I && p[I]) || w;
        (u.classList.add("hljs"), u.classList.add(`language-${z}`));
      }
      function rt(u) {
        let I = null;
        const w = ee(u);
        if (O(w)) return;
        if (
          (we("before:highlightElement", { el: u, language: w }),
        ...
        I = u;
        const z = I.textContent,
          j = w ? Z(z, { language: w, ignoreIllegals: !0 }) : ot(z);
        ((u.innerHTML = j.value),
          ...
          we("after:highlightElement", { el: u, result: j, text: z }));
      }
      function gn(u) {
        N = Nt(N, u);
      }
      ...
      function Be() {
        ...
        if (document.readyState === "loading") {
          (Rt || window.addEventListener("DOMContentLoaded", u, !1), (Rt = !0));
          return;
        }
        document.querySelectorAll(N.cssSelector).forEach(rt);
      }
      function Sn(u, I) {
        let w = null;
        try {
        ...
        (w.name || (w.name = u),
          (o[u] = w),
          (w.rawDefinition = I.bind(null, n)),
          w.aliases && ht(w.aliases, { languageName: u }));
      }
      function bn(u) {
        delete o[u];
        for (const I of Object.keys(p)) p[I] === u && delete p[I];
      }
      function Tn() {
        return Object.keys(o);
      }
      function _e(u) {
        return ((u = (u || "").toLowerCase()), o[u] || o[p[u]]);
      }
      function ht(u, { languageName: I }) {
        (typeof u == "string" && (u = [u]),
          u.forEach((w) => {
            p[w.toLowerCase()] = I;
          }));
      ...
      function _n(u) {
        (u["before:highlightBlock"] &&
          ...
          (u["before:highlightElement"] = (I) => {
            u["before:highlightBlock"](Object.assign({ block: I.el }, I));
          }),
          u["after:highlightBlock"] &&
            !u["after:highlightElement"] &&
            (u["after:highlightElement"] = (I) => {
              u["after:highlightBlock"](Object.assign({ block: I.el }, I));
            }));
      }
      function Nn(u) {
        (_n(u), M.push(u));
      ...
      for (const u in he) typeof he[u] == "object" && e(he[u]);
      return (Object.assign(n, he), n);
    },
    fe = Ct({});
  return (
    (fe.newInstance = () => Ct({})),
...
function Fn(e) {
  const t = e.regex,
    ...
    g = { className: "title", begin: t.optional(r) + e.IDENT_RE, relevance: 0 },
    ...
    y = [v, b, l, i, e.C_BLOCK_COMMENT_MODE, d, s],
    $ = {
      variants: [
        { begin: /=/, end: /;/ },
        { begin: /\(/, end: /\)/ },
    ...
    k = {
      ...
      contains: [
        ...
        { begin: T, returnBegin: !0, contains: [g], relevance: 0 },
        { begin: /::/, relevance: 0 },
        { begin: /:/, endsWithParent: !0, contains: [s, d] },
        { relevance: 0, match: /,/ },
        {
          className: "params",
          begin: /\(/,
          ...
          contains: [
            ...
            l,
            {
              ...
              keywords: f,
              relevance: 0,
              contains: ["self", i, e.C_BLOCK_COMMENT_MODE, s, d, l],
            },
          ],
        },
        l,
...
function wn(e) {
  ...
  const m = { match: /\\"/ },
    ...
    g = ["fish", "bash", "zsh", "sh", "csh", "ksh", "tcsh", "dash", "scsh"],
    T = e.SHEBANG({ binary: `(${g.join("|")})`, relevance: 10 }),
    D = {
      className: "function",
      begin: /\w[\w\d_]*\s*\(\s*\)\s*\{/,
      returnBegin: !0,
  ...
  return {
    ...
    keywords: {
      ...
      keyword: _,
      literal: R,
      built_in: [...L, ...P, "set", "shopt", ...f, ...v],
    },
    contains: [T, e.SHEBANG(), D, b, E, c, C, l, m, s, d, i],
  };
}
function kn(e) {
  const t = e.regex,
    ...
    C = [b, l, i, e.C_BLOCK_COMMENT_MODE, d, s],
    L = {
      variants: [
        { begin: /=/, end: /;/ },
        { begin: /\(/, end: /\)/ },
    ...
    P = {
      ...
      illegal: /[^\w\s\*&:<>.]/,
      contains: [
        { begin: a, keywords: R, relevance: 0 },
        {
          begin: T,
          returnBegin: !0,
  ...
  return {
    ...
    exports: { preprocessor: b, strings: s, keywords: R },
  };
}
function Gn(e) {
  const t = e.regex,
...
function Un(e) {
  const t = [
    ...
    c = { keyword: r.concat(E), built_in: t, literal: a },
    ...
    b = e.inherit(d, { illegal: /\n/ }),
    g = { className: "subst", begin: /\{/, end: /\}/, keywords: c },
    T = e.inherit(g, { illegal: /\n/ }),
    D = {
      className: "string",
      begin: /\$"/,
      end: '"',
      illegal: /\n/,
      contains: [{ begin: /\{\{/ }, { begin: /\}\}/ }, e.BACKSLASH_ESCAPE, T],
    },
    _ = {
      className: "string",
      begin: /\$@"/,
  ...
  const C = { variants: [s, _, D, d, e.APOS_STRING_MODE, e.QUOTE_STRING_MODE] },
    L = { begin: "<", end: ">", contains: [{ beginKeywords: "in out" }, l] },
    P =
      e.IDENT_RE +
      "(<" +
      e.IDENT_RE +
  ...
  return {
    ...
    contains: [
      ...
      },
      {
        ...
        illegal: /[^\s:]/,
        contains: [l, L, e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE],
      },
      {
        className: "meta",
        begin: "^\\s*\\[(?=[\\w])",
      ...
      { beginKeywords: "new return throw await else", relevance: 0 },
      {
        ...
        contains: [
          ...
          { match: /\(\)/ },
          {
            ...
            keywords: c,
            relevance: 0,
            contains: [C, m, e.C_BLOCK_COMMENT_MODE],
          },
          e.C_LINE_COMMENT_MODE,
          e.C_BLOCK_COMMENT_MODE,
        ],
...
function Yn(e) {
  ...
  return {
    ...
    contains: [
      ...
      i.CSS_VARIABLE,
      { className: "attribute", begin: "\\b(" + qn.join("|") + ")\\b" },
      {
        begin: /:/,
        end: /[;}{]/,
        contains: [
      ...
      { className: "selector-tag", begin: "\\b(" + Wn.join("|") + ")\\b" },
    ],
  };
}
function Xn(e) {
...
function jn(e) {
  ...
  const r = {
    ...
    E = { className: "literal", begin: /\bon|off|true|false|yes|no\b/ },
    c = {
      className: "string",
      contains: [e.BACKSLASH_ESCAPE],
      variants: [
    ...
    d = /'[^']*'/,
    b = t.either(m, s, d),
    g = t.concat(b, "(\\s*\\.\\s*", b, ")*", t.lookahead(/\s*=\s*[^#\s]/));
  return {
    name: "TOML, also INI",
    aliases: ["toml"],
    case_insensitive: !0,
    ...
    contains: [
      ...
      { className: "section", begin: /\[+/, end: /\]+/ },
      {
        begin: g,
        className: "attr",
        starts: { end: /$/, contains: [a, l, E, r, c, i] },
      },
    ],
  };
}
var ye = "[0-9](_*[0-9])*",
  ...
  Pt = {
    className: "number",
    variants: [
      { begin: `(\\b(${ye})((${Ve})|\\.)?|(${Ve}))[eE][+-]?(${ye})[fFdD]?\\b` },
      { begin: `\\b(${ye})((${Ve})[fFdD]?\\b|\\.([fFdD]\\b)?)` },
      { begin: `(${Ve})[fFdD]?\\b` },
      { begin: `\\b(${ye})[fFdD]\\b` },
      {
        begin: `\\b0[xX]((${He})\\.?|(${He})?\\.(${He}))[pP][+-]?(${ye})[fFdD]?\\b`,
      },
...
function wt(e, t, i) {
  return i === -1 ? "" : e.replace(t, (a) => wt(e, t, i - 1));
}
function ei(e) {
  const t = e.regex,
...
function oi(e) {
  const t = e.regex,
    i = (G, { after: te }) => {
      ...
      return G.input.indexOf(se, te) !== -1;
    },
    a = vt,
    r = { begin: "<>", end: "</>" },
    E = /<[A-Za-z0-9\\._:-]+\s*\/>/,
    c = {
      ...
      isTrulyOpeningTag: (G, te) => {
        const se = G[0].length + G.index,
          ae = G.input[se];
        if (ae === "<" || ae === ",") {
          te.ignoreMatch();
          return;
        }
        ae === ">" && (i(G, { after: se }) || te.ignoreMatch());
        let ne;
        const be = G.input.substring(se);
        if ((ne = be.match(/^\s*=/))) {
          te.ignoreMatch();
          return;
        }
        if ((ne = be.match(/^\s+extends\s+/)) && ne.index === 0) {
          te.ignoreMatch();
          return;
        }
      },
...
var Oe = "[0-9](_*[0-9])*",
  ...
  si = {
    className: "number",
    variants: [
      { begin: `(\\b(${Oe})((${$e})|\\.)?|(${$e}))[eE][+-]?(${Oe})[fFdD]?\\b` },
      { begin: `\\b(${Oe})((${$e})[fFdD]?\\b|\\.([fFdD]\\b)?)` },
      { begin: `(${$e})[fFdD]?\\b` },
      { begin: `\\b(${Oe})[fFdD]\\b` },
      {
...
function li(e) {
  const t = {
    ...
    E = { className: "variable", begin: "\\$" + e.UNDERSCORE_IDENT_RE },
    c = {
      className: "string",
      variants: [
        { begin: '"""', end: '"""(?=[^"])', contains: [E, r] },
        { begin: "'", end: "'", illegal: /\n/, contains: [e.BACKSLASH_ESCAPE] },
        {
          begin: '"',
          end: '"',
          illegal: /\n/,
          contains: [e.BACKSLASH_ESCAPE, E, r],
        },
      ],
    };
  r.contains.push(c);
  const l = {
    ...
    g = b;
  return (
    (g.variants[1].contains = [b]),
    (b.variants[1].contains = [g]),
    {
      name: "Kotlin",
      aliases: ["kt", "kts"],
      keywords: t,
              ...
              contains: [
                {
                  ...
                  endsWithParent: !0,
                  contains: [b, e.C_LINE_COMMENT_MODE, d],
                  relevance: 0,
                },
                e.C_LINE_COMMENT_MODE,
                d,
...
function ci(e) {
  const i = e.regex.either(
    ...
    c = {
      ...
      relevance: 0,
      contains: [
        { endsParent: !0, begin: i },
        { endsParent: !0, begin: a },
        { endsParent: !0, variants: E },
        { endsParent: !0, relevance: 0, variants: r },
      ],
    },
    l = { className: "params", relevance: 0, begin: /#+\d?/ },
    m = { variants: E },
    s = { className: "built_in", relevance: 0, begin: /[$&^_]/ },
    d = {
      className: "meta",
    ...
    b = e.COMMENT("%", "$", { relevance: 0 }),
    g = [c, l, m, s, d, b],
    T = { begin: /\{/, end: /\}/, relevance: 0, contains: ["self", ...g] },
    D = e.inherit(T, { relevance: 0, endsParent: !0, contains: [T, ...g] }),
    _ = {
      begin: /\[/,
      end: /\]/,
      endsParent: !0,
    ...
    R = { begin: /\s+/, relevance: 0 },
    C = [D],
    L = [_],
    P = function (F, X) {
      return {
        contains: [R],
        starts: { relevance: 0, contains: F, starts: X },
      };
    },
    f = function (F, X) {
      return {
        begin: "\\\\" + F + "(?![a-zA-Z@:_])",
        keywords: { $pattern: /\\[a-zA-Z]+/, keyword: "\\" + F },
        relevance: 0,
        contains: [R],
        starts: X,
      };
    ...
    $ = function (F) {
      return { className: "string", end: "(?=\\\\end\\{" + F + "\\})" };
    },
    k = (F = "string") => ({
      relevance: 0,
      begin: /\{/,
    ...
    W = [
      ...["verb", "lstinline"].map((F) => f(F, { contains: [y()] })),
      f("mint", P(C, { contains: [y()] })),
      f("mintinline", P(C, { contains: [k(), y()] })),
      f("url", { contains: [k("link"), k("link")] }),
      f("hyperref", { contains: [k("link")] }),
      f("href", P(L, { contains: [k("link")] })),
      ...[].concat(
        ...["", "\\*"].map((F) => [
          v("verbatim" + F, $("verbatim" + F)),
          v("filecontents" + F, P(C, $("filecontents" + F))),
          ...["", "B", "L"].map((X) =>
            v(X + "Verbatim" + F, P(L, $(X + "Verbatim" + F))),
          ),
        ]),
      ),
      v("minted", P(L, P(C, $("minted")))),
    ];
  return { name: "LaTeX", aliases: ["tex"], contains: [...W, ...g] };
}
const ui = (e) => ({
    IMPORTANT: { scope: "meta", begin: "!important" },
    BLOCK_COMMENT: e.C_BLOCK_COMMENT_MODE,
...
function bi(e) {
  const t = ui(e),
    ...
    l = [],
    m = function (P) {
      return { className: "string", begin: "~?" + P + ".*?" + P };
    },
    s = function (P, f, v) {
      return { className: P, begin: f, relevance: v };
    },
    d = { $pattern: /[a-z-]+/, keyword: a, attribute: pi.join(" ") },
    b = { begin: "\\(", end: "\\)", contains: l, keywords: d, relevance: 0 };
  l.push(
    e.C_LINE_COMMENT_MODE,
    e.C_BLOCK_COMMENT_MODE,
    m("'"),
  ...
  const g = l.concat({ begin: /\{/, end: /\}/, contains: c }),
    T = {
      beginKeywords: "when",
      endsWithParent: !0,
    ...
    C = {
      ...
      contains: [
        ...
        s("keyword", "all\\b"),
        s("variable", "@\\{" + r + "\\}"),
        { begin: "\\b(" + gi.join("|") + ")\\b", className: "selector-tag" },
        t.CSS_NUMBER_MODE,
        s("selector-tag", E, 0),
        s("selector-id", "#" + E),
        s("selector-class", "\\." + E, 0),
        s("selector-tag", "&", 0),
        t.ATTRIBUTE_SELECTOR_MODE,
        { className: "selector-pseudo", begin: ":(" + Vt.join("|") + ")" },
    ...
    L = { begin: r + `:(:)?(${i.join("|")})`, returnBegin: !0, contains: [C] };
  return (
    c.push(
      e.C_LINE_COMMENT_MODE,
      e.C_BLOCK_COMMENT_MODE,
...
function _i(e) {
  ...
  return {
    ...
    contains: [e.HASH_COMMENT_MODE, t, i, a, r, E, c],
  };
}
function Ni(e) {
  const t = e.regex,
    ...
    b = e.inherit(s, { contains: [] }),
    g = e.inherit(d, { contains: [] });
  (s.contains.push(g), d.contains.push(b));
  let T = [i, m];
  return (
    [s, d, b, g].forEach((C) => {
...
function Ci(e) {
  const t = e.regex,
    ...
    b = {
      className: "number",
      relevance: 0,
      begin: t.concat(E, t.optional(m), t.optional(s)),
    },
    g = /[a-zA-Z$][a-zA-Z0-9$]*/,
    T = new Set(Ai),
    D = {
      variants: [
        {
          ...
          begin: g,
          "on:begin": (v, y) => {
            T.has(v[0]) || y.ignoreMatch();
          },
        },
        { className: "symbol", relevance: 0, begin: g },
      ],
    },
    _ = { className: "named-character", begin: /\\\[[$a-zA-Z][$a-zA-Z0-9]+\]/ },
    R = {
      className: "operator",
      relevance: 0,
      begin: /[+\-*/,;.:@~=><&|_`'^?!%]+/,
    ...
    P = { className: "brace", relevance: 0, begin: /[[\](){}]/ },
    f = { className: "message-name", relevance: 0, begin: t.concat("::", g) };
  return {
    name: "Mathematica",
    aliases: ["mma", "wl"],
    classNameAliases: {
...
function Ri(e) {
  const t = "('|\\.')+",
    i = { relevance: 0, contains: [{ begin: t }] };
  return {
    name: "Matlab",
    keywords: {
      keyword:
    ...
    contains: [
      ...
      { className: "built_in", begin: /true|false/, relevance: 0, starts: i },
      { begin: "[a-zA-Z][a-zA-Z_0-9]*" + t, relevance: 0 },
      { className: "number", begin: e.C_NUMBER_RE, relevance: 0, starts: i },
      {
        className: "string",
        begin: "'",
        end: "'",
...
function Ii(e) {
  const t = e.regex,
    ...
    E = { className: "subst", begin: "[$@]\\{", end: "\\}", keywords: r },
    c = { begin: /->\{/, end: /\}/ },
    l = { scope: "attr", match: /\s+:\s*\w+(\s*\(.*?\))?/ },
    m = {
      scope: "variable",
      variants: [
        { begin: /\$\d/ },
    ...
    d = [e.BACKSLASH_ESCAPE, E, m],
    b = [/!/, /\//, /\|/, /\?/, /'/, /"/, /#/],
    g = (_, R, C = "\\1") => {
      const L = C === "\\1" ? C : t.concat(C, R);
      return t.concat(
        t.concat("(?:", _, ")"),
        R,
        /(?:\\.|[^\\\/])*?/,
      ...
      s,
      {
        ...
        contains: [
          e.HASH_COMMENT_MODE,
          {
            className: "regexp",
            variants: [
              { begin: g("s|tr|y", t.either(...b, { capture: !0 })) },
              { begin: g("s|tr|y", "\\(", "\\)") },
              { begin: g("s|tr|y", "\\[", "\\]") },
              { begin: g("s|tr|y", "\\{", "\\}") },
            ],
          ...
          },
          {
            ...
            variants: [
              ...
              { begin: T("(?:m|qr)?", /\//, /\//) },
              { begin: T("m|qr", t.either(...b, { capture: !0 }), /\1/) },
              { begin: T("m|qr", /\(/, /\)/) },
              { begin: T("m|qr", /\[/, /\]/) },
              { begin: T("m|qr", /\{/, /\}/) },
            ],
...
function fi(e) {
  ...
  return {
    ...
    supersetOf: "sql",
    case_insensitive: !0,
    keywords: { keyword: E + l + c, built_in: d + b + g },
    ...
    contains: [
      ...
      {
        begin: "\\b(" + s + ")\\s+PATH\\b",
        keywords: { keyword: "PATH", type: m.replace("PATH ", "") },
      },
      { className: "type", begin: "\\b(" + s + ")\\b" },
      {
        className: "string",
        begin: "'",
        end: "'",
...
function yi(e) {
  const t = e.regex,
    ...
    d = e.inherit(e.QUOTE_STRING_MODE, {
      illegal: null,
      contains: e.QUOTE_STRING_MODE.contains.concat(m),
    }),
    b = {
      begin: /<<<[ \t]*(?:(\w+)|"(\w+)")\n/,
      end: /[ \t]*(\w+)\b/,
      contains: e.QUOTE_STRING_MODE.contains.concat(m),
      "on:begin": (Q, J) => {
        J.data._beginMatch = Q[1] || Q[2];
      },
      "on:end": (Q, J) => {
        J.data._beginMatch !== Q[1] && J.ignoreMatch();
      },
    },
    ...
    D = { scope: "string", variants: [d, s, b, g] },
    _ = {
      scope: "number",
      variants: [
      ...
      literal: ((Q) => {
        ...
        return (
          Q.forEach((re) => {
            (J.push(re),
              re.toLowerCase() === re
                ? J.push(re.toUpperCase())
                : J.push(re.toLowerCase()));
          }),
          J
        );
      })(R),
    ...
    F = {
      ...
      keywords: f,
      contains: [W, c, k, e.C_BLOCK_COMMENT_MODE, D, _, y],
    },
    X = {
      relevance: 0,
      match: [
  ...
  F.contains.push(X);
  const ue = [W, k, e.C_BLOCK_COMMENT_MODE, D, _, y],
    de = {
      begin: t.concat(/#\[\s*\\?/, t.either(r, E)),
      beginScope: "meta",
      end: /]/,
      endScope: "meta",
      keywords: { literal: R, keyword: ["new", "array"] },
      contains: [
        {
          begin: /\[/,
          end: /]/,
        ...
        ...ue,
        { scope: "meta", variants: [{ match: r }, { match: E }] },
      ],
    };
  return {
    case_insensitive: !1,
      ...
      y,
      {
        ...
        contains: [
          ...
          { begin: "=>", endsParent: !0 },
          {
            ...
            excludeEnd: !0,
            keywords: f,
            contains: ["self", de, c, k, e.C_BLOCK_COMMENT_MODE, D, _],
          },
        ],
      },
      {
    ...
    b = {
      ...
      variants: [
        ...
        },
        {
          ...
          contains: [e.BACKSLASH_ESCAPE, m, d, s],
        },
        {
          begin: /([fF][rR]|[rR][fF]|[fF])"""/,
          end: /"""/,
        ...
        { begin: /([bB]|[bB][rR]|[rR][bB])"/, end: /"/ },
        {
          ...
          contains: [e.BACKSLASH_ESCAPE, d, s],
        },
        {
          begin: /([fF][rR]|[rR][fF]|[fF])"/,
          end: /"/,
    ...
    C = {
      ...
      variants: [
        { className: "", begin: /\(\s*\)/, skip: !0 },
        {
          ...
          excludeEnd: !0,
          keywords: l,
          contains: ["self", m, _, b, e.HASH_COMMENT_MODE],
        },
      ],
    };
  return (
    ...
    contains: [
      ...
      },
      {
        ...
        variants: [
          ...
          { scope: { 1: "punctuation", 2: "number" }, match: [E, a] },
      ...
      { scope: "punctuation", relevance: 0, match: E },
      { begin: "`", end: "`", contains: [{ begin: /\\./ }] },
    ],
  };
}
function xi(e) {
  const t = e.regex,
    ...
    d = { className: "subst", begin: /#\{/, end: /\}/, keywords: c },
    b = {
      className: "string",
  ...
  const F = [
    { begin: /^\s*=>/, starts: { end: "$", contains: y } },
    {
      ...
      begin:
        ...
        "(\\w+-)?\\d+\\.\\d+\\.\\d+(p\\d+)?[^\\d][^>]+>" +
        ")(?=[ ])",
      starts: { end: "$", keywords: c, contains: y },
    },
  ];
  return (
    s.unshift(m),
    {
      ...
      keywords: c,
      illegal: /\/\*/,
      contains: [e.SHEBANG({ binary: "ruby" })].concat(F).concat(s).concat(y),
    }
  );
}
function Fi(e) {
  const t = e.regex,
    ...
    c = "([ui](8|16|32|64|128|size)|f(32|64))?",
    l = [
      "abstract",
      "as",
      "async",
  ...
  return {
    ...
    contains: [
      ...
      {
        begin: e.IDENT_RE + "::",
        keywords: { keyword: "Self", built_in: s, type: d },
      },
  ...
  return {
    ...
    contains: [
      ...
      },
      {
        ...
        returnBegin: !0,
        keywords: { $pattern: /[a-z-]+/, keyword: E, attribute: Ui.join(" ") },
        contains: [
...
function Ki(e) {
  const t = e.regex,
    ...
    m = ["add", "asc", "collation", "desc", "final", "first", "last", "view"],
    s = [
      "abs",
      "acos",
      "all",
    ...
    T = d,
    D = [...s, ...m].filter((v) => !d.includes(v)),
    _ = { scope: "variable", match: /@[a-z0-9][a-z0-9_]*/ },
    R = {
      scope: "operator",
      match: /[-+*/=%^~]|&&?|\|\|?|!=?|<(?:=>?|<|>)?|>[>=]?/,
      relevance: 0,
  ...
  const P = { scope: "keyword", match: L(g), relevance: 0 };
  function f(v, { exceptions: y, when: $ } = {}) {
    const k = $;
    return (
      (y = y || []),
      v.map((W) =>
        W.match(/\|\d+$/) || y.includes(W) ? W : k(W) ? `${W}|0` : W,
      )
    );
  }
  return {
    ...
    keywords: {
      $pattern: /\b[\w\.]+/,
      keyword: f(D, { when: (v) => v.length < 3 }),
      literal: E,
      type: l,
      built_in: b,
    },
    contains: [
      { scope: "type", match: L(c) },
      P,
      C,
      _,
      a,
...
function le(...e) {
  return (
    "(" + (Qi(e).capture ? "" : "?:") + e.map((a) => $t(a)).join("|") + ")"
  );
}
const gt = (e) => H(/\b/, e, /\w$/.test(e) ? /\b/ : /\B/),
  qi = ["Protocol", "Type"].map(gt),
  xt = ["init", "self"].map(gt),
  Yi = ["Any", "Self"],
  dt = [
    "actor",
  ...
  Qe = le(Kt, /\d/, /[\u0300-\u036F\u1DC0-\u1DFF\u20D0-\u20FF\uFE20-\uFE2F]/),
  Ee = H(Kt, Qe, "*"),
  ze = H(/[A-Z]/, Qe, "*"),
  Ji = [
    "attached",
    "autoclosure",
    H(/convention\(/, le("swift", "block", "c"), /\)/),
    "discardableResult",
    "dynamicCallable",
    "dynamicMemberLookup",
    "escaping",
...
function ea(e) {
  const t = { match: /\s+/, relevance: 0 },
    ...
    r = { match: [/\./, le(...qi, ...xt)], className: { 2: "keyword" } },
    E = { match: H(/\./, le(...dt)), relevance: 0 },
    c = dt.filter((V) => typeof V == "string").concat(["_|0"]),
    l = dt
      .filter((V) => typeof V != "string")
      .concat(Yi)
      .map(gt),
    m = { variants: [{ className: "keyword", match: le(...l, ...xt) }] },
    s = { $pattern: le(/\b\w+/, /#\w+/), keyword: c.concat(Zi), literal: Ft },
    d = [r, E, m],
    b = { match: H(/\./, le(...Bt)), relevance: 0 },
    g = { className: "built_in", match: H(/\b/, le(...Bt), /(?=\()/) },
    T = [b, g],
    D = { match: /->/, relevance: 0 },
    _ = {
      className: "operator",
      relevance: 0,
      variants: [{ match: mt }, { match: `\\.(\\.|${zt})+` }],
    },
    R = [D, _],
    C = "([0-9]_*)+",
    L = "([0-9a-fA-F]_*)+",
    ...
    ue = (V) => {
      ...
      return {
        ...
        contains: [...F, { scope: "comment", begin: `#(?!.*${Ae})`, end: /$/ }],
      };
    },
    de = { scope: "regexp", variants: [ue("###"), ue("##"), ue("#"), X] },
    Q = { match: H(/`/, Ee, /`/) },
    J = { className: "variable", match: /\$\d+/ },
    ...
    G = {
      ...
      starts: {
        contains: [
          { begin: /\(/, end: /\)/, keywords: ji, contains: [...R, P, W] },
        ],
      },
    },
    te = { scope: "keyword", match: H(/@/, le(...Ji), Pe(le(/\(/, /\s+/))) },
    se = { scope: "meta", match: H(/@/, Ee) },
    ae = [G, te, se],
    ne = {
      match: Pe(/\b[A-Z]/),
      relevance: 0,
    ...
    be = {
      ...
      keywords: s,
      contains: [...a, ...d, ...ae, D, ne],
    };
  ne.contains.push(be);
  const Ye = { match: H(Ee, /\s*:/), keywords: "_|0", relevance: 0 },
    ve = {
      begin: /\(/,
      end: /\)/,
      relevance: 0,
    ...
    Xe = {
      begin: le(Pe(H(Ee, /\s*:/)), Pe(H(Ee, /\s+/, Ee, /\s*:/))),
      end: /:/,
      relevance: 0,
      contains: [
    ...
    xe = {
      ...
      keywords: s,
      contains: [Xe, ...a, ...d, ...R, P, W, ...ae, ne, ve],
      endsParent: !0,
      illegal: /["']/,
    },
    pt = {
      match: [/(func|macro)/, /\s+/, le(Q.match, Ee, mt)],
      className: { 1: "keyword", 3: "title.function" },
      contains: [Le, xe, t],
      illegal: [/\[/, /%/],
    },
    ...
    tt = {
      begin: [/(struct|protocol|class|extension|enum|actor)/, /\s+/, Ee, /\s*/],
      ...
      contains: [
        ...
        ...d,
        {
          ...
          keywords: s,
          contains: [{ scope: "title.class.inherited", match: ze }, ...d],
          relevance: 0,
        },
      ],
    };
  for (const V of W.variants) {
    const De = V.contains.find((nt) => nt.label === "interpol");
    De.keywords = s;
    const Ae = [...d, ...T, ...R, P, W, ...Se];
    De.contains = [
      ...Ae,
      { begin: /\(/, end: /\)/, contains: ["self", ...Ae] },
    ];
  }
  return {
    name: "Swift",
...
const qe = "[A-Za-z$_][0-9A-Za-z$_]*",
  ...
  qt = ["true", "false", "null", "undefined", "NaN", "Infinity"],
  Yt = [
    "Object",
    "Function",
    "Boolean",
...
function na(e) {
  const t = e.regex,
    ...
    s = {
      ...
      keyword: Qt.concat(m),
      literal: qt,
      built_in: jt.concat(r),
      "variable.language": Jt,
    },
    d = { className: "meta", begin: "@" + a },
    b = (_, R, C) => {
      const L = _.contains.findIndex((P) => P.label === R);
      if (L === -1) throw new Error("can not find mode to replace");
      _.contains.splice(L, 1, C);
    };
  (Object.assign(i.keywords, s), i.exports.PARAMS_CONTAINS.push(d));
  const g = i.contains.find((_) => _.scope === "attr"),
    T = Object.assign({}, g, { match: t.concat(a, t.lookahead(/\s*\?:/)) });
  (i.exports.PARAMS_CONTAINS.push([i.exports.CLASS_REFERENCE, g, T]),
    (i.contains = i.contains.concat([d, E, c, T])),
    b(i, "shebang", e.SHEBANG()),
    b(i, "use_strict", l));
  const D = i.contains.find((_) => _.label === "func.def");
  return (
    (D.relevance = 0),
    Object.assign(i, {
      name: "TypeScript",
...
function ia(e) {
  const t = e.regex,
    ...
    m = {
      className: "literal",
      variants: [
        { begin: t.concat(/# */, t.either(E, r), / *#/) },
        { begin: t.concat(/# */, l, / *#/) },
        { begin: t.concat(/# */, c, / *#/) },
        { begin: t.concat(/# */, t.either(E, r), / +/, t.either(c, l), / *#/) },
      ],
    },
    s = {
      className: "number",
...
function aa(e) {
  ...
  const i = e.COMMENT(/;;/, /$/),
    ...
    m = { match: /(i32|i64|f32|f64)(?!\.)/, className: "type" },
    s = {
      className: "keyword",
      match:
  ...
  return {
    ...
    contains: [
      ...
      { className: "tag", begin: /<>|<\/>/ },
      {
        ...
        contains: [{ className: "name", begin: i, relevance: 0, starts: s }],
      },
      {
        className: "tag",
...
function ra(e) {
  const t = "true false yes no null",
    ...
    D = { begin: /\{/, end: /\}/, contains: [T], illegal: "\\n", relevance: 0 },
    _ = {
      begin: "\\[",
      end: "\\]",
      contains: [T],
...
for (const [e, t] of Object.entries(sa)) Ke.registerLanguage(e, t);
Ke.registerAliases(["wolfram"], { languageName: "mathematica" });
function ca(e, t) {
  return (
    Mn.trace(
      `[highlight-code] start language=${t ?? "auto"} codeLength=${e.length}`,
    ),
    Pn(
      {
        op: "codex.highlight",
        name: "highlightCode",
        attributes: { "codex.highlight.code_length": e.length },
      },
      () => {
        if (t) {
          const { value: r } = Ke.highlight(e, { language: t });
          return { html: r, language: t };
        }
        const { value: i, language: a } = Ke.highlightAuto(e);
        return { html: i, language: a };
      },
    )
  );
}
export { ca as highlightCode };
//# sourceMappingURL=highlight-code-DMVALRNl.js.map
