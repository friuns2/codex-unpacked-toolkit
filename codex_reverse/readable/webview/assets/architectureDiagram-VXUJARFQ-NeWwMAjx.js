...
import { p as fr } from "./chunk-4BX2VUAB-DA7Q3XYm.js";
import { p as cr } from "./treemap-KMMF4GRG-CTteDAEM.js";
import { c as Fe } from "./cytoscape.esm-DtBltrT8.js";
import "./_baseUniq-LVUcU6OA.js";
import "./_basePickBy-D_ghe6L4.js";
import "./clone-CzlBXpAL.js";
var he = { exports: {} },
  le = { exports: {} },
  fe = { exports: {} },
  gr = fe.exports,
          ...
          return (function (A) {
              ...
              ((a.prototype.addRoot = function () {
                ...
                (a.prototype.remove = function (e) {
                  if (e instanceof u) {
                    ...
                    if (
                      !(
                        r == this.rootGraph ||
                        (r.parent != null && r.parent.graphManager == this)
                      )
                    )
                ...
                (a.prototype.getAllNodes = function () {
                  if (this.allNodes == null) {
                    for (
                      var e = [], r = this.getGraphs(), l = r.length, i = 0;
                      i < l;
                      i++
                    )
            ...
            function (A, P, N) {
              ...
              ((h.calcSeparationAmount = function (a, e, r, l) {
                ...
                (this.decideDirectionsForOverlappingNodes(a, e, i),
                  (r[0] =
                    Math.min(a.getRight(), e.getRight()) - Math.max(a.x, e.x)),
                  (r[1] =
                    Math.min(a.getBottom(), e.getBottom()) -
                    Math.max(a.y, e.y)),
                  a.getX() <= e.getX() && a.getRight() >= e.getRight()
                    ? (r[0] += Math.min(
                        e.getX() - a.getX(),
                        a.getRight() - e.getRight(),
                      ))
                    : e.getX() <= a.getX() &&
                ...
                var g = Math.abs(
                  (e.getCenterY() - a.getCenterY()) /
                    (e.getCenterX() - a.getCenterX()),
                );
                e.getCenterY() === a.getCenterY() &&
                  e.getCenterX() === a.getCenterX() &&
                  (g = 1);
                ...
                (h.prototype.transformX = function (a) {
                  ...
                  return (
                    r != 0 &&
                      (e =
                        this.ldeviceOrgX +
                        ((a - this.lworldOrgX) * this.ldeviceExtX) / r),
                    e
                  );
                }),
                (h.prototype.transformY = function (a) {
                  ...
                  return (
                    r != 0 &&
                      (e =
                        this.ldeviceOrgY +
                        ((a - this.lworldOrgY) * this.ldeviceExtY) / r),
                    e
                  );
                }),
                (h.prototype.inverseTransformX = function (a) {
                  ...
                  return (
                    r != 0 &&
                      (e =
                        this.lworldOrgX +
                        ((a - this.ldeviceOrgX) * this.lworldExtX) / r),
                    e
                  );
                }),
                (h.prototype.inverseTransformY = function (a) {
                  ...
                  return (
                    r != 0 &&
                      (e =
                        this.lworldOrgY +
                        ((a - this.ldeviceOrgY) * this.lworldExtY) / r),
                    e
                  );
                }),
            ...
            function (A, P, N) {
              ...
              ((i.prototype.initParameters = function () {
                ...
                (i.prototype.calcGravitationalForces = function () {
                  for (
                    var t, o = this.getAllNodesToApplyGravitation(), s = 0;
                    s < o.length;
                    s++
                  )
                ...
                (i.prototype.calcNoOfChildrenForAllNodes = function () {
                  for (
                    var t, o = this.graphManager.getAllNodes(), s = 0;
                    s < o.length;
                    s++
                  )
                ...
                (i.prototype.addNodeToGrid = function (t, o, s) {
                  var c = 0,
                    ...
                    d = 0;
                  ((c = parseInt(
                    Math.floor((t.getRect().x - o) / this.repulsionRange),
                  )),
                    (f = parseInt(
                      Math.floor(
                        (t.getRect().width + t.getRect().x - o) /
                          this.repulsionRange,
                      ),
                    )),
                    (T = parseInt(
                  ...
                  if (
                    ...
                    for (
                      ...
                      for (var L = t.startY - 1; L < t.finishY + 2; L++)
                        if (
                          !(v < 0 || L < 0 || v >= d.length || L >= d[0].length)
                        ) {
            ...
            function (A, P, N) {
              ...
              ((h.prototype.add = function (a) {
                ...
                (h.prototype.addAllTo = function (a) {
                  for (
                    var e = Object.keys(this.set), r = e.length, l = 0;
                    l < r;
                    l++
                  )
                    a.push(this.set[e[l]]);
            ...
            function (A, P, N) {
              ...
              ((u.svd = function (h) {
                ...
                for (
                  var B = n - 1, _ = Math.pow(2, -52), ht = Math.pow(2, -966);
                  n > 0;
                ) {
                  var Q = void 0,
                    It = void 0;
                  ...
                  if (Q === n - 2) It = 4;
                    ...
                    for (Nt = n - 1; Nt >= Q && Nt !== Q; Nt--) {
                      var vt =
                        (Nt !== n ? Math.abs(e[Nt]) : 0) +
                        (Nt !== Q + 1 ? Math.abs(e[Nt - 1]) : 0);
                    ...
                    case 1:
                      {
                        ...
                        for (var gt = n - 2; gt >= Q; gt--) {
                          ...
                          for (var Et = 0; Et < this.n; Et++)
                            ((mt =
                              At * this.V[Et][gt] + Ot * this.V[Et][n - 1]),
                              (this.V[Et][n - 1] =
                                -Ot * this.V[Et][gt] + At * this.V[Et][n - 1]),
                              (this.V[Et][gt] = mt));
                        }
                      }
                      break;
                ...
                765: (a, e, r) => {
                  ...
                  ((O.prototype.newGraphManager = function () {
                    ...
                    (O.prototype.initConstraintVariables = function () {
                      ...
                      var y = function w(H) {
                        for (
                          var B = H.getChild().getNodes(), _, ht = 0, Q = 0;
                          Q < B.length;
                          Q++
                        )
                          ((_ = B[Q]),
                            ...
                            if (this.fixedComponentsOnHorizontal[p])
                              for (var y = 0; y < D.length; y++)
                                this.dummyToNodeForVerticalAlignment.has(D[y])
                                  ...
                                  : (this.idToNodeMap.get(D[y]).displacementX =
                                      0);
                            else {
                            ...
                            if (this.fixedComponentsOnVertical[p])
                              for (var y = 0; y < D.length; y++)
                                this.dummyToNodeForHorizontalAlignment.has(D[y])
                                  ...
                                  : (this.idToNodeMap.get(D[y]).displacementY =
                                      0);
                            else {
                              for (var q = 0, V = 0, y = 0; y < D.length; y++)
                                if (
                    ...
                    (O.branchRadialLayout = function (n, m, p, E, y, R) {
                      ...
                      m != null && X--;
                      for (
                        var et = 0, z = V.length, w, H = n.getEdgesBetween(m);
                        H.length > 1;
                      ) {
                        var B = H[0];
                        H.splice(0, 1);
                  ...
                  ((g.prototype.calculateDisplacement = function () {
                    ...
                    (this.getChild() != null && this.fixedNodeWeight
                      ...
                      Math.abs(this.displacementX) >
                        o.coolingFactor * o.maxNodeDisplacement &&
                        (this.displacementX =
                          o.coolingFactor *
                          o.maxNodeDisplacement *
                        ...
                        K = function () {
                          ...
                          for (
                            var p = function () {
                              ...
                              n.neighborhood()
                                .nodes()
                                .forEach(function (D) {
                                  o.intersection(n.edgesWith(D)).length > 0 &&
                                    R.merge(D);
                                });
                          ...
                          if (
                            (it.forEach(function (y) {
                              o.intersection(y.connectedEdges()).forEach(
                                function (R) {
                                  it.has(R.source()) &&
                                    it.has(R.target()) &&
                                    it.merge(R);
                      ...
                      var n = function (D) {
                        ...
                        E = function W(D, q, V, X) {
                          for (var et = q.length, z = 0; z < et; z++) {
                            ...
                            else B = D.add(new g(this.graphManager));
                            if (
                              ((B.id = w.data("id")),
                        ...
                        R = function (D, q) {
                          (q.fixedNodeConstraint &&
                            (D.constraints.fixedNodeConstraint =
                              q.fixedNodeConstraint),
                            q.alignmentConstraint &&
                              (D.constraints.alignmentConstraint =
                                q.alignmentConstraint),
                        ...
                        T.forEach(function (F) {
                          ...
                          (F.isParent()
                            ...
                            F.neighborhood()
                              .nodes()
                              .forEach(function ($) {
                                f.intersection(F.edgesWith($)).length > 0 &&
                                  ($.isParent()
                                    ? C[U].push(b.get($.id()))
                                    : C[U].push($.id()));
                              }));
    ...
    ((ae = class {
      ...
      addService({ id: x, icon: A, in: P, title: N, iconText: u }) {
        ...
        if (P !== void 0) {
          if (x === P)
            throw new Error(
              `The service [${x}] cannot be placed within itself`,
            );
      ...
      addGroup({ id: x, icon: A, in: P, title: N }) {
        ...
        ((this.registeredIds[x] = "group"),
          (this.groups[x] = { id: x, icon: A, title: N, in: P }));
      }
      getGroups() {
...
export { $r as diagram };
//# sourceMappingURL=architectureDiagram-VXUJARFQ-NeWwMAjx.js.map
