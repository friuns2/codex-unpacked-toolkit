...
const ur = B`\[\^?`,
  hr = `c.? | C(?:-.?)?|${B`[pP]\{(?:\^?[-\x20_]*[A-Za-z][-\x20\w]*\})?`}|${B`x[89A-Fa-f]\p{AHex}(?:\\x[89A-Fa-f]\p{AHex})*`}|${B`u(?:\p{AHex}{4})? | x\{[^\}]*\}? | x\p{AHex}{0,2}`}|${B`o\{[^\}]*\}?`}|${B`\d{1,3}`}`,
  Yt = /[?*+][?+]?|\{(?:\d+(?:,\d*)?|,\d+)\}\??/,
  Fe = new RegExp(
    B`
  \\ (?:
...
function ws(t, e = {}) {
  ...
  for (Fe.lastIndex = 0; (l = Fe.exec(t)); ) {
    ...
    (h.tokens ? i.push(...h.tokens) : h.token && i.push(h.token),
      h.lastIndex !== void 0 && (Fe.lastIndex = h.lastIndex));
  }
  const a = [];
  let c = 0;
  (i
    ...
    .forEach((h) => {
      h.kind === "capturing" ? (h.number = ++c) : h.raw === "(" && a.push(h);
    }),
    c ||
      a.forEach((h, d) => {
  ...
  const u = c || a.length;
  return {
    tokens: i.map((h) => (h.type === "EscapedNumber" ? Fs(h, u) : h)).flat(),
    flags: r,
  };
}
function Cs(t, e, n, r) {
  ...
  if (s === "\\") {
    if ("AbBGyYzZ".includes(o)) return { token: pn(n, n) };
    if (/^\\g[<']/.test(n)) {
      if (!/^\\g(?:<[^>]+>|'[^']+')$/.test(n))
  ...
  if (s === "(") {
    ...
    if (n === "(?>") return { token: pe("atomic", n) };
    if (n === "(?=" || n === "(?!" || n === "(?<=" || n === "(?<!")
      return {
        token: pe(n[2] === "<" ? "lookbehind" : "lookahead", n, {
          negate: n.endsWith("!"),
        }),
      };
    if (
    ...
    if (n.startsWith("(?~")) {
      ...
      return { token: pe("absence_repeater", n) };
    }
    throw n === "(?("
  ...
  if (n === ")") {
    if ((t.popModX(), t.numOpenGroups--, t.numOpenGroups < 0))
...
`,
  ...
  if (n === ".") return { token: le("dot", n) };
  if (n === "^" || n === "$") {
    const i = t.singleline ? { "^": B`\A`, $: B`\Z` }[n] : n;
    return { token: pn(i, n) };
  }
  return n === "|"
    ? { token: ks(n) }
...
function _s(t, e, n) {
  ...
  let s = 1,
    o;
  for (pt.lastIndex = n; (o = pt.exec(t)); ) {
    const i = o[0];
    if (i[0] === "[" && i[1] !== ":") (s++, r.push(gn(i[1] === "^", i)));
    else if (i === "]") {
      if (r.at(-1).type === "CharacterClassOpen") r.push(J(93, i));
      else if ((s--, r.push(vs(i)), !s)) break;
    } else {
      const l = Ss(i);
...
function Ss(t) {
  if (t[0] === "\\") return dr(t, { inCharClass: !0 });
  if (t[0] === "[") {
    const e = /\[:(?<negate>\^?)(?<name>[a-z]+):\]/.exec(t);
    if (!e || !Qt.has(e.groups.name))
      throw new Error(`Invalid POSIX class "${t}"`);
    return le("posix", t, { value: e.groups.name, negate: !!e.groups.negate });
  }
  return t === "-" ? xs(t) : t === "&&" ? Es(t) : J(_e(t), t);
}
function dr(t, { inCharClass: e }) {
  const n = t[1];
  if (n === "c" || n === "C") return Ps(t);
  if ("dDhHsSwW".includes(n)) return Os(t);
  if (t.startsWith(B`\o{`))
    throw new Error(
      `Incomplete, invalid, or unsupported octal code point "${t}"`,
    );
  if (/^\\[pP]\{/.test(t)) {
    if (t.length === 3)
  ...
  if (new RegExp("^\\\\x[89A-Fa-f]\\p{AHex}", "u").test(t))
    try {
      const r = t
          ...
          .slice(1)
          .map((i) => parseInt(i, 16)),
        s = new TextDecoder("utf-8", { ignoreBOM: !0, fatal: !0 }).decode(
          new Uint8Array(r),
        ),
        o = new TextEncoder();
      return [...s].map((i) => {
        const l = [...o.encode(i)].map((a) => `\\x${a.toString(16)}`).join("");
        return J(_e(i), l);
      });
    } catch {
      throw new Error(
        `Multibyte code "${t}" incomplete or invalid in Oniguruma`,
      );
    }
  if (n === "u" || n === "x") return J(Bs(t), t);
  if (mn.has(n)) return J(mn.get(n), t);
  if (/\d/.test(n)) return Is(e, t);
...
function pr(t, e, n = {}) {
  return t === "keep"
    ...
    : { type: "Directive", kind: t, flags: Se(n.flags), raw: e };
}
function Is(t, e) {
...
function Ps(t) {
  ...
  return J(_e(e.toUpperCase()) - 64, t);
}
function Ts(t, e) {
  ...
  const s = (e.getCurrentModX() || n.includes("x")) && !r.includes("x"),
    ...
    i = bn(r),
    l = {};
  if ((o && (l.enable = o), i && (l.disable = i), t.endsWith(")")))
    return (e.replaceCurrentModX(s), pr("flags", t, { flags: l }));
  if (t.endsWith(":"))
    return (
      e.pushModX(s),
      e.numOpenGroups++,
      pe("group", t, { ...((o || i) && { flags: l }) })
    );
...
function Ms(t) {
  ...
  const o = s
      ...
      : [],
    [i, l, a] = o,
    c = $s.has(n) ? n.toLowerCase() : "custom";
  switch (c) {
    case "fail":
    case "mismatch":
    case "skip":
    ...
    case "cmp":
      ...
      if (typeof a == "string" && !/^[A-Za-z_]\w*$/.test(a))
        throw new Error(
          `Named callout argument three must be a tag or number "${a}"`,
        );
      break;
    case "custom":
  ...
  return Rs(c, r ?? null, s?.split(",") ?? null, t);
}
function yn(t) {
  let e = null,
    n,
    r;
  if (t[0] === "{") {
    const { minStr: s, maxStr: o } =
        /^\{(?<minStr>\d*)(?:,(?<maxStr>\d*))?/.exec(t).groups,
      i = 1e5;
    if (+s > i || (o && +o > i))
...
function Os(t) {
  ...
  return le({ d: "digit", h: "hex", s: "space", w: "word" }[e], t, {
    negate: t[1] !== e,
  });
}
function Ds(t) {
  const {
    ...
    neg: n,
    value: r,
  } = /^\\(?<p>[pP])\{(?<neg>\^?)(?<value>[^}]+)/.exec(t).groups;
  return le("property", t, {
    value: r,
    negate: (e === "P" && !n) || (e === "p" && !!n),
  });
}
  ...
  for (let l = 0; l < i.length; l++) {
    ...
    if (l === 0 && a !== "8" && a !== "9") {
      if (((c = parseInt(a, 8)), c > 127))
        throw new Error(B`Octal encoded byte above 177 unsupported "${n}"`);
    } else c = _e(a);
    o.push(J(c, (l === 0 ? "\\" : "") + a));
  }
  return o;
...
function js(t) {
  ...
  for (; (r = n.exec(t)); ) {
    ...
    if (s[0] === "{") {
      ...
      if (o) {
        const { min: i, max: l } = o.groups;
        if (+i > +l && s.endsWith("?")) {
          (n.lastIndex--, e.push(yn(s.slice(0, -1))));
          continue;
        }
      }
    }
...
function mr(t, e = {}) {
  const n = {
    ...
    s = (d, f) => {
      ...
      switch (((o.parent = d), o.nextIndex++, p.type)) {
        case "Alternator":
          return ue();
        case "Assertion":
          return zs(p);
  ...
  for (; o.nextIndex < r.tokens.length; ) {
    const d = s(l, {});
    d.type === "Alternative" ? (i.body.push(d), (l = d)) : l.body.push(d);
  }
  const {
    capturingGroups: a,
    hasNumberedRef: c,
  ...
  for (const { ref: d } of h)
    if (typeof d == "number") {
      if (d > a.length)
        throw new Error("Subroutine uses a group number that's not defined");
      d && (a[d - 1].isSubroutined = !0);
    } else if (u.has(d)) {
      if (u.get(d).length > 1)
        throw new Error(B`Subroutine uses a duplicate group name "\g<${d}>"`);
      u.get(d)[0].isSubroutined = !0;
    } else
      throw new Error(
        B`Subroutine uses a group name that's not defined "\g<${d}>"`,
      );
  return i;
}
function zs({ kind: t }) {
    ...
    s = (o, i = !1) => {
      ...
      if (o > l)
        if (e.skipBackrefValidation) a = !0;
          ...
          throw new Error(
            `Not enough capturing groups defined to the left "${t}"`,
          );
      return ((e.hasNumberedRef = !0), $t(i ? l + 1 - o : o, { orphan: a }));
    };
  if (n) {
...
function Hs(t, e, n) {
  ...
  if (
    ...
    const a = s(o, { ...n, isCheckingRangeEnd: !0 });
    if (i.type === "Character" && a.type === "Character")
      return (o.body.pop(), Js(i, a));
    throw new Error("Invalid character class range");
  }
  return at(_e("-"));
}
function Vs({ negate: t }, e, n) {
  const { tokens: r, walk: s } = e,
    o = r[e.nextIndex],
    i = [Ve()];
  let l = _n(o);
  for (; l.type !== "CharacterClassClose"; ) {
    if (l.type === "CharacterClassIntersector") (i.push(Ve()), e.nextIndex++);
    else {
      const c = i.at(-1);
      c.body.push(s(c, n));
    }
    l = _n(r[e.nextIndex], o);
  }
  const a = Ve({ negate: t });
  return (
    i.length === 1
...
function Xs({ kind: t, negate: e, value: n }, r) {
  const {
  ...
  if (t === "property") {
    const l = lt(n);
    if (Qt.has(l) && !i?.has(l)) ((t = "posix"), (n = l));
    else
      return ge(n, {
        negate: e,
        normalizeUnknownPropertyNames: s,
  ...
  return t === "posix" ? ro(n, { negate: e }) : Pt(t, { negate: e });
}
function Ks(t, e, n) {
  const {
      tokens: r,
  ...
  for (; d.type !== "GroupClose"; ) {
    if (d.type === "Alternator") (a.body.push(ue()), e.nextIndex++);
      ...
      if ((f.body.push(p), (u || n.isInLookbehind) && !i)) {
        const b = "Lookbehind includes a pattern not allowed by Oniguruma";
        if (h || n.isInNegLookbehind) {
          if (wn(p) || p.type === "CapturingGroup") throw new Error(b);
        } else if (wn(p) || (Cn(p) && p.negate)) throw new Error(b);
      }
    }
    d = Sn(r[e.nextIndex]);
  }
...
function Zs({ kind: t, min: e, max: n }, r) {
  const s = r.parent,
    o = s.body.at(-1);
  if (!o || !Us(o)) throw new Error("Quantifier requires a repeatable token");
  const i = br(t, e, n, o);
  return (s.body.pop(), i);
}
function Qs({ raw: t }, e) {
...
function Ys(t, e) {
  return { type: "AbsenceFunction", kind: t, body: Oe(e?.body) };
}
function ue(t) {
  return { type: "Alternative", body: Cr(t?.body) };
}
function Nt(t, e) {
...
function eo(t, e = {}) {
  ...
  if (t === "flags") return { type: "Directive", kind: t, flags: Se(e.flags) };
...
function so(t, e) {
  return { type: "Regex", body: Oe(e?.body), flags: t };
}
function wr(t) {
...
function ge(t, e) {
  ...
  let r = n.unicodePropertyMap?.get(lt(t));
  if (!r) {
    if (n.normalizeUnknownPropertyNames) r = ao(t);
...
function oo({ flags: t, kind: e, name: n, negate: r, number: s }) {
  switch (e) {
    ...
    case "lookahead":
    case "lookbehind":
      return ae({ behind: e === "lookbehind", negate: r });
    default:
...
function Ae(t, e, n = null) {
  ...
  function s(o, i = null, l = null, a = null) {
    let c = 0,
      u = !1;
    const h = {
        node: o,
        ...
        root: t,
        remove() {
          (je(a).splice(Math.max(0, de(l) + c), 1), c--, (u = !0));
        },
        removeAllNextSiblings() {
          return je(a).splice(de(l) + 1);
        },
        removeAllPrevSiblings() {
          const g = de(l) + c;
          return ((c -= g), je(a).splice(0, Math.max(0, g)));
        },
        replaceWith(g, y = {}) {
          const m = !!y.traverse;
          (a
      ...
      f = e["*"],
      p = e[d],
      b = typeof f == "function" ? f : f?.enter,
      C = typeof p == "function" ? p : p?.enter;
    if ((b?.(h, n), C?.(h, n), !u))
      switch (d) {
    ...
    return (p?.exit?.(h, n), f?.exit?.(h, n), c);
  }
  return (s(t), t);
}
function je(t) {
...
const lo = String.raw`\(\?(?:[:=!>A-Za-z\-]|<[=!]|\(DEFINE\))`;
function co(t, e) {
...
function Jt(t, e, n, r) {
  ...
  for (const a of t.matchAll(s)) {
    ...
    if (!u && (!r || (r === X.DEFAULT) == !i)) {
      n instanceof Function
        ? (l += n(a, {
            context: i ? X.CHAR_CLASS : X.DEFAULT,
...
const kn = new RegExp(
  String.raw`(?<noncapturingStart>${lo})|(?<capturingStart>\((?:\?<[^>]+>)?)|\\?.`,
  "gsu",
);
function po(t, e) {
  ...
  do {
    ...
    let d = 0,
      ...
      b;
    for (
      kn.lastIndex = Number.isNaN(u) ? 0 : u + o.length;
      (b = kn.exec(t));
    ) {
      const {
        0: C,
      ...
      else if (C === s && !p) ((u = g), (p = !0));
      else if (p && m) f++;
      else if (y) p ? f++ : (a++, i.push(a + c));
      else if (C === ")" && p) {
        if (!f) {
          c++;
          const _ = a + c;
  ...
  return (
    ...
    (t = Jt(
      ...
      ({ 0: d, groups: { backrefNum: f, wrappedBackrefNum: p } }) => {
        if (f) {
          const b = +f;
          if (b > i.length - 1)
...
function go(t) {
  if (!new RegExp(`${Sr}\\+`).test(t)) return { pattern: t };
  const e = [];
  let n = null,
    r = null,
    s = "",
    o = 0,
    i;
  for (gt.lastIndex = 0; (i = gt.exec(t)); ) {
    const {
      0: l,
      index: a,
    ...
    if (l === "[") (o || (r = a), o++);
    else if (l === "]") o ? o-- : (r = null);
    else if (!o)
      if (u === "+" && s && !s.startsWith("(")) {
        if (h) throw new Error(`Invalid quantifier "${l}"`);
        let d = -1;
        if (/^\{\d+\}$/.test(c)) t = uo(t, a + c.length, u, "");
        else {
          if (s === ")" || s === "]") {
            const f = s === ")" ? n : r;
            if (f === null) throw new Error(`Invalid unmatched "${s}"`);
            t = `${t.slice(0, f)}(?>${t.slice(f, a)}${c})${t.slice(a + l.length)}`;
          } else
            t = `${t.slice(0, a - s.length)}(?>${s}${c})${t.slice(a + l.length)}`;
          d += 4;
        }
        gt.lastIndex += d;
      } else
        l[0] === "(" ? e.push(a) : l === ")" && (n = e.length ? e.pop() : null);
    s = l;
  }
  return { pattern: t };
}
const V = String.raw,
  mo = V`\\g<(?<gRNameOrNum>[^>&]+)&R=(?<gRDepth>[^>]+)>`,
  Tt = V`\(\?R=(?<rDepth>[^\)]+)\)|${mo}`,
  ct = V`\(\?<(?![=!])(?<captureName>[^>]+)>`,
  kr = V`${ct}|(?<unnamed>\()(?!\?)`,
  oe = new RegExp(V`${ct}|${Tt}|\(\?|\\?.`, "gsu"),
  mt = "Cannot use multiple overlapping recursions";
function yo(t, e) {
  ...
  if (!new RegExp(Tt, "su").test(t))
    return { pattern: t, captureTransfers: s, hiddenCaptures: n };
  if (r === "plugin" && Ue(t, V`\(\?\(DEFINE\)`, X.DEFAULT))
    throw new Error("DEFINE groups cannot be used with recursion");
  const o = [],
    i = Ue(t, V`\\[1-9]`, X.DEFAULT),
    l = new Map(),
    a = [];
  let c = !1,
    u = 0,
    h = 0,
    d;
  for (oe.lastIndex = 0; (d = oe.exec(t)); ) {
    const {
      0: f,
      groups: { captureName: p, rDepth: b, gRNameOrNum: C, gRDepth: g },
    } = d;
    if (f === "[") u++;
    else if (u) f === "]" && u--;
    else if (b) {
      if ((vn(b), c)) throw new Error(mt);
      if (i)
        throw new Error(
          `${r === "external" ? "Backrefs" : "Numbered backrefs"} cannot be used with global recursion`,
        );
      const y = t.slice(0, d.index),
        m = t.slice(oe.lastIndex);
      if (Ue(m, Tt, X.DEFAULT)) throw new Error(mt);
      const _ = +b - 1;
      ((t = xn(y, m, _, !1, n, o, h)), (s = In(s, y, _, o.length, 0, h)));
      break;
    } else if (C) {
      vn(g);
      let y = !1;
      for (const M of a)
        if (M.name === C || M.num === +C) {
          if (((y = !0), M.hasRecursedWithin)) throw new Error(mt);
          break;
        }
      if (!y)
        throw new Error(
          V`Recursive \g cannot be used outside the referenced group "${r === "external" ? C : V`\g<${C}&R=${g}>`}"`,
        );
      const m = l.get(C),
        _ = fo(t, m);
      ...
      const k = t.slice(m, d.index),
        I = _.slice(k.length + f.length),
        S = o.length,
        A = +g - 1,
        E = xn(k, I, A, !0, n, o, h);
      s = In(s, k, A, o.length - S, S, h);
      const R = t.slice(0, m),
        L = t.slice(m + _.length);
      ((t = `${R}${E}${L}`),
        (oe.lastIndex += E.length - f.length - k.length - I.length),
        a.forEach((M) => (M.hasRecursedWithin = !0)),
        (c = !0));
    } else if (p)
      (h++,
      ...
      const y = f === "(";
      (y && (h++, l.set(String(h), oe.lastIndex)), a.push(y ? { num: h } : {}));
    } else f === ")" && a.pop();
  }
...
function xn(t, e, n, r, s, o, i) {
  ...
  const a = [n, r ? l : null, s, o, i];
  return `${t}${En(`(?:${t}`, "forward", ...a)}(?:)${En(`${e})`, "backward", ...a)}${e}`;
}
function En(t, e, n, r, s, o, i) {
  ...
  for (let u = 0; u < n; u++) {
    ...
    c += Jt(
      t,
      V`${kr}|\\k<(?<backref>[^>]+)>`,
      ({ 0: d, groups: { captureName: f, unnamed: p, backref: b } }) => {
        if (b && r && !r.has(b)) return d;
        const C = `_$${h}`;
        if (p || f) {
          const g = i + o.length + 1;
          return (o.push(g), bo(s, g), p ? d : `(?<${f}${C}>`);
        }
        return V`\k<${b}${C}>`;
      },
      X.DEFAULT,
  ...
  if (t.size && r) {
    ...
    return (
      t.forEach((c, u) => {
        ...
        for (const b of c)
          if (b <= l) p.push(b);
          else if (b > l + i + h) p.push(b + r);
          else if (b <= l + i) for (let C = 0; C <= n; C++) p.push(b + i * C);
          else for (let C = 0; C <= n; C++) p.push(b + d + h * C);
        a.set(f, p);
      }),
      a
    );
...
ee.bugFlagVLiteralHyphenIsRange = ee.unicodeSets
  ...
  : !1;
ee.bugNestedClassIgnoresNegation =
  ee.unicodeSets && new RegExp("[[^a]]", "v").test("a");
function Ze(t, { enable: e, disable: n }) {
  return {
...
var An = { ES2025: 2025, ES2024: 2024, ES2018: 2018 },
  Co = { auto: "auto", ES2025: "ES2025", ES2024: "ES2024", ES2018: "ES2018" };
function vr(t = {}) {
...
var _o = "[	-\r ]",
  So = new Set([O(304), O(305)]),
  Q = v`[\p{L}\p{M}\p{N}\p{Pc}]`;
function xr(t) {
  if (So.has(t)) return [t];
  const e = new Set(),
    n = t.toLowerCase(),
    r = n.toUpperCase(),
    s = xo.get(n),
...
function Ao(t, e) {
  ...
  const r = {
    ...
    minTargetEs2024: Mt(n.bestEffortTarget, "ES2024"),
    passedLookbehind: !1,
    strategy: null,
...
var Ro = {
    AbsenceFunction({ node: t, parent: e, replaceWith: n }) {
      ...
      if (s === "repeater") {
        const o = K();
        o.body[0].body.push(ae({ negate: !0, body: r }), ge("Any"));
        const i = K();
        (i.body[0].body.push(br("greedy", 0, 1 / 0, o)),
          n(P(i, e), { traverse: !0 }));
    ...
    Assertion(
      ...
      if (a === "text_segment_boundary")
        throw new Error(
          `Unsupported text segment boundary "\\${c ? "Y" : "y"}"`,
        );
      if (a === "line_end")
        i(
          P(
            ae({
              body: [ue({ body: [Nt("string_end")] }), ue({ body: [at(10)] })],
            }),
            e,
          ),
        );
        ...
        if (d.has(t)) ((s.flags.sticky = !0), o());
        else {
          const p = r[n - 1];
          if (p && Do(p)) i(P(ae({ negate: !0 }), e));
          else {
            if (h)
              throw new Error(v`Uses "\G" in a way that requires a subclass`);
            (i(re(Nt("string_start"), e)), (l.strategy = "clip_search"));
          }
        }
      else if (!(a === "string_end" || a === "string_start"))
        if (a === "string_end_newline") i(P(Y(v`(?=\n?\z)`), e));
    ...
    Backreference({ node: t }, { jsGroupNameMap: e }) {
      let { ref: n } = t;
      typeof n == "string" && !wt(n) && ((n = bt(n, e)), (t.ref = n));
    },
    CapturingGroup({ node: t }, { jsGroupNameMap: e, subroutineRefMap: n }) {
      let { name: r } = t;
      (r && !wt(r) && ((r = bt(r, e)), (t.name = r)),
        n.set(t.number, t),
        r && n.set(r, t));
    },
    ...
    CharacterSet(
      ...
      if (o && (a === "digit" || u === "digit")) {
        n(re(Pt("digit", { negate: c }), e));
        return;
      }
      ...
      if (l && (a === "word" || u === "word")) {
        n(re(Pt("word", { negate: c }), e));
        return;
      }
      if (a === "any") n(re(ge("Any"), e));
      else if (a === "digit") n(re(ge("Nd", { negate: c }), e));
      else if (a !== "dot")
        if (a === "text_segment") {
          if (r === "strict")
          ...
          n(
            P(
              Y(v`(?>\r\n|${s ? v`\p{RGI_Emoji}` : d}|\P{M}\p{M}*)`, {
                skipPropertyNameValidation: !0,
              }),
              e,
            ),
          );
        } else if (a === "hex") n(re(ge("AHex", { negate: c }), e));
        else if (a === "newline")
          n(
            P(
              Y(
...
\v\f\u2028\u2029])`,
          ...
          if (!s && (u === "graph" || u === "print")) {
            ...
            (c &&
              ...
              n(P(Y(`[${h}]`), e)));
          } else n(P(Ct(Y(Eo.get(u)), c), e));
        else if (a === "property") en.has(lt(u)) || (t.key = "sc");
        else if (a === "space") n(re(ge("space", { negate: c }), e));
        else if (a === "word") n(P(Ct(Y(Q), c), e));
    ...
    Directive({
      ...
      if (l === "flags")
        if (!a.enable && !a.disable) r();
          ...
          const c = K({ flags: a });
          ((c.body[0].body = i()), s(P(c, e), { traverse: !0 }));
        }
      else if (l === "keep") {
        const c = n.body[0],
          h =
    ...
    Regex: {
      enter({ node: t }, { supportedGNodes: e }) {
        ...
        for (const o of t.body)
          if (o.body.length === 1 && o.body[0].kind === "search_start")
            ...
            const i = Nr(o.body);
            i
              ? ((r = !0), Array.isArray(i) ? n.push(...i) : n.push(i))
              : (s = !0);
          }
      ...
      exit(t, { accuracy: e, passedLookbehind: n, strategy: r }) {
        if (e === "strict" && n && r)
          throw new Error(
            v`Uses "\G" in a way that requires non-strict accuracy`,
          );
      },
    },
  ...
  Lo = {
    ...
    CapturingGroup: {
      enter(
        ...
        const c = s.get(t);
        if (c && l.has(t.number)) {
          const h = re(Rn(t.number), e);
          (a.set(h, l.get(t.number)), n(h));
          return;
        }
        (l.set(t.number, t), i.set(t.number, []), t.name && Le(i, t.name, []));
        const u = i.get(t.name ?? t.number);
        for (let h = 0; h < u.length; h++) {
          const d = u[h];
          if (c === d.node || (c && c === d.origin) || t === d.origin) {
            u.splice(h, 1);
            break;
          }
        }
    ...
    Group: {
      enter({ node: t }, e) {
        ((e.prevFlags = e.currentFlags),
          t.flags && (e.currentFlags = Ze(e.currentFlags, t.flags)));
      },
      exit(t, e) {
    ...
    Subroutine({ node: t, parent: e, replaceWith: n }, r) {
      ...
      if (s) {
        ...
        for (
          ;
          (u = u.parent) &&
          !(u.type === "CapturingGroup" && (u.name === o || u.number === o));
        );
      ...
      const i = r.subroutineRefMap.get(o),
        l = o === 0,
        a = l ? Rn(0) : Ar(i, r.groupOriginByCopy, null);
      let c = a;
      if (!l) {
        const u = Rr(To(i, (d) => d.type === "Group" && !!d.flags)),
          h = u ? Ze(r.globalFlags, u) : r.globalFlags;
        $o(h, r.currentFlags) ||
          ((c = K({ flags: Mo(h) })), c.body[0].body.push(a));
      }
      n(P(c, e), { traverse: !l });
    },
  },
  No = {
    Backreference({ node: t, parent: e, replaceWith: n }, r) {
      ...
      const o = r.reffedNodesByReferencer.get(t).filter((i) => Po(i, t));
      if (!o.length) n(P(ae({ negate: !0 }), e));
      else if (o.length > 1) {
        const i = K({
          atomic: !0,
          body: o.reverse().map((l) => ue({ body: [$t(l.number)] })),
        });
        n(P(i, e));
    ...
    Subroutine({ node: t }, e) {
      !t.isRecursive ||
        t.ref === 0 ||
        (t.ref = e.reffedNodesByReferencer.get(t).number);
    },
  };
function Ir(t) {
  Ae(t, {
...
function Mo({ dotAll: t, ignoreCase: e }) {
  const n = {};
  return (
    (t || e) &&
      ((n.enable = {}),
      t && (n.enable.dotAll = !0),
      e && (n.enable.ignoreCase = !0)),
    (!t || !e) &&
      ((n.disable = {}),
      !t && (n.disable.dotAll = !0),
      !e && (n.disable.ignoreCase = !0)),
    n
  );
}
function Lr(t) {
...
function Nr(t) {
  const e = t.find(
    (n) => n.kind === "search_start" || Go(n, { negate: !1 }) || !Oo(n),
  );
  if (!e) return null;
...
function $r(t, e) {
  const n = Lr(t) ?? [];
  for (const r of n) if (r === e || $r(r, e)) return !0;
  return !1;
}
function Oo({ type: t }) {
...
function Do(t) {
  ...
  return (
    e.includes(t.type) ||
    (t.type === "Quantifier" && t.min && e.includes(t.body.type))
  );
}
function Go(t, e) {
  ...
  return (
    ...
    t.body.length === 1 &&
    gr(t.body[0], { type: "Assertion", kind: "search_start" })
  );
}
function wt(t) {
...
function Y(t, e) {
  const r = mr(t, { ...e, unicodePropertyMap: en }).body;
  return r.length > 1 || r[0].body.length > 1 ? K({ body: r }) : r[0].body[0];
}
function Ct(t, e) {
  return ((t.negate = e), t);
}
...
function P(t, e) {
  return (Ir(t), (t.parent = e), t);
}
function Bo(t, e) {
  const n = vr(e),
    r = Mt(n.target, "ES2024"),
    s = Mt(n.target, "ES2025"),
  ...
  const a = {
    ...
    ignoreCase: !!((t.flags.ignoreCase || i) && !l),
  };
  let c = t;
  const u = {
    accuracy: n.accuracy,
  ...
  function h(f) {
    return (
      (u.lastNode = c),
      (c = f),
      wo(jo[f.type], `Unexpected node type "${f.type}"`)(f, u, h)
    );
  }
  const d = {
  ...
  return (
    ...
    u.captureMap.forEach((f, p) => {
      (f.hidden && d._hiddenCaptures.push(p),
        f.transferTo && Le(d._captureTransfers, f.transferTo, []).push(p));
    }),
    d
  );
}
var Fo = {
    "*": {
      enter({ node: t }, e) {
        if (Nn(t)) {
          ...
          e.pushModI(t.flags ? Ze({ ignoreCase: n }, t.flags).ignoreCase : n);
        }
      },
      exit({ node: t }, e) {
        Nn(t) && e.popModI();
    ...
    Character({ node: t }, e) {
      tn(O(t.value)) && e.setHasCasedChar();
    },
    CharacterClassRange({ node: t, skip: e }, n) {
      (e(), Pr(t, { firstOnly: !0 }).length && n.setHasCasedChar());
    },
    CharacterSet({ node: t }, e) {
      t.kind === "property" && Er.has(t.value) && e.setHasCasedChar();
    },
  },
  jo = {
    ...
    Assertion({ kind: t, negate: e }) {
      ...
      if (t === "word_boundary") return e ? v`\B` : v`\b`;
    ...
    CapturingGroup(t, e, n) {
      const { body: r, name: s, number: o } = t,
        ...
        l = e.originMap.get(t);
      return (
        l && ((i.hidden = !0), o > l.number && (i.transferTo = l.number)),
    ...
    Character({ value: t }, e) {
      ...
      if (r !== n) return r;
      if (e.useAppliedIgnoreCase && e.currentFlags.ignoreCase && tn(n)) {
        const s = xr(n);
        return e.inCharClass
          ? s.join("")
          : s.length > 1
            ? `[${s.join("")}]`
            : s[0];
    ...
    CharacterClass(t, e, n) {
      ...
      ee.bugFlagVLiteralHyphenIsRange &&
        e.useFlagV &&
        i.some($n) &&
        (i = [at(45), ...i.filter((c) => !$n(c))]);
      const l = () =>
        `[${s ? "^" : ""}${i.map(n).join(r === "intersection" ? "&&" : "")}]`;
      if (!e.inCharClass) {
        if ((!e.useFlagV || ee.bugNestedClassIgnoresNegation) && !s) {
          const u = i.filter(
            (h) =>
              h.type === "CharacterClass" && h.kind === "union" && h.negate,
          );
          if (u.length) {
            const h = K(),
              d = h.body[0];
            return (
              (h.parent = o),
              (d.parent = h),
              (i = i.filter((f) => !u.includes(f))),
              (t.body = i),
              i.length ? ((t.parent = d), d.body.push(t)) : h.body.pop(),
              u.forEach((f) => {
                const p = ue({ body: [f] });
                ((f.parent = p), (p.parent = h), h.body.push(p));
              }),
              n(h)
            );
          }
      ...
      if (
        ...
        (((!e.useFlagV || !e.verbose) &&
          o.kind === "union" &&
          !(ee.bugFlagVLiteralHyphenIsRange && e.useFlagV)) ||
          (!e.verbose &&
            o.kind === "intersection" &&
            i.length === 1 &&
    ...
    CharacterClassRange(t, e) {
      ...
      if (e.useAppliedIgnoreCase && e.currentFlags.ignoreCase) {
        const a = Pr(t);
        Ho(a).forEach((u) => {
          l.add(Array.isArray(u) ? `${fe(u[0], s)}-${fe(u[1], s)}` : fe(u, s));
        });
      }
      return `${o}-${i}${[...l].join("")}`;
    },
      ...
      if (t === "dot")
        return s.currentFlags.dotAll
          ? s.appliedGlobalFlags.dotAll || s.useFlagMods
            ...
            : "[^]"
          : v`[^\n]`;
      if (t === "digit") return e ? v`\D` : v`\d`;
      if (t === "property") {
        if (s.useAppliedIgnoreCase && s.currentFlags.ignoreCase && Er.has(n))
          throw new Error(
            `Unicode property "${n}" can't be case-insensitive when other chars have specific case`,
          );
        return `${e ? v`\P` : v`\p`}{${r ? `${r}=` : ""}${n}}`;
      }
      if (t === "word") return e ? v`\W` : v`\w`;
    ...
    Group({ atomic: t, body: e, flags: n, parent: r }, s, o) {
      ...
      n && (s.currentFlags = Ze(i, n));
      const l = e.map(o).join("|"),
        a =
          !s.verbose &&
          e.length === 1 &&
          r.type !== "Quantifier" &&
...
function Pr(t, e) {
  ...
  for (let i = r; i <= s; i++) {
    const l = O(i);
    if (!tn(l)) continue;
    const a = xr(l).filter((c) => {
      const u = c.codePointAt(0);
      return u < r || u > s;
    });
    if (a.length && (o.push(...a), n)) break;
  }
  return o;
}
function fe(t, { escDigit: e, inCharClass: n, useFlagV: r }) {
  if (Ln.has(t)) return Ln.get(t);
  if (t < 32 || (t > 126 && t < 160) || t > 262143 || (e && Ko(t)))
    return t > 255
      ? `\\u{${t.toString(16).toUpperCase()}}`
      : `\\x${t.toString(16).toUpperCase().padStart(2, "0")}`;
  const s = n ? (r ? zo : Wo) : Uo,
    o = O(t);
  return (s.has(o) ? "\\" : "") + o;
}
function Ho(t) {
...
function Xo({ kind: t, max: e, min: n }) {
  let r;
  return (
    !n && e === 1
      ? (r = "?")
...
function $n({ type: t, value: e }) {
  return t === "Character" && e === 45;
}
var Zo = class Ot extends RegExp {
  #t = new Map();
  #e = null;
  #r;
  #n = null;
  ...
  exec(e) {
    if (!this.#e) {
      ...
      this.#e = new Ot(this.#r, this.flags, o);
    }
    ...
    if (this.#s === "clip_search" && n && r) {
      ...
      return (s && (Qo(s, r, e, this.hasIndices), (this.lastIndex += r)), s);
    }
    return this.#o(e);
  }
  #o(e) {
    ...
    for (let i = 1; i < r.length; i++) {
      const { hidden: l, transferTo: a } = this.#t.get(i) ?? {};
      if (
        (l
          ? o.push(null)
          : (o.push(n.length),
        ...
        if (
          ((n[c] = r[i]), this.hasIndices && (n.indices[c] = s[i]), n.groups)
        ) {
          this.#n || (this.#n = Jo(this.source));
...
function Yo(t, e) {
  ...
  for (const [r, s] of e) for (const o of s) Le(n, o, {}).transferTo = r;
  return n;
}
function Jo(t) {
...
function ei(t, e) {
  const n = ti(t, e);
  return n.options
    ? new Zo(n.pattern, n.flags, n.options)
...
function ti(t, e) {
  ...
  if (n.avoidSubclass) {
    ...
    const u = a.hiddenCaptures.sort((p, b) => p - b),
      h = Array.from(a.captureTransfers),
      d = s._strategy,
      f = c.pattern.length >= n.lazyCompileLength;
    (u.length || h.length || d || f) &&
      (c.options = {
...
class ni {
  ...
  findNextMatchSync(e, n, r) {
    ...
    if (o.length) {
      const l = Math.min(...o.map((a) => a[1].index));
      for (const [a, c, u] of o) if (c.index === l) return i(a, c, u);
    }
    return null;
  }
}
...
function ii(t) {
  let e = [];
  for (let n = 0, r = t.length; n < r; n++) e[n] = nn(t[n]);
  return e;
}
function ai(t) {
  let e = {};
  for (let n in t) e[n] = nn(t[n]);
  return e;
}
function Tr(t, ...e) {
  return (
...
function Mr(t) {
  ...
  return e === 0
    ? t
    : ~e === t.length - 1
      ? Mr(t.substring(0, t.length - 1))
      : t.substr(~e + 1);
}
var _t = /\$(\d+)|\${(\d+):\/(downcase|upcase)}/g,
  We = class {
    static hasCaptures(t) {
      return t === null ? !1 : ((_t.lastIndex = 0), _t.test(t));
    }
    static replaceCaptures(t, e, n) {
      return t.replace(_t, (r, s, o, i) => {
...
var Br = class {
  ...
  Qe = class {
    ...
    static createFromRawTheme(t, e) {
      return this.createFromParsedTheme(ui(t), e);
    }
    static createFromParsedTheme(t, e) {
      return di(t, e);
    }
    _cachedMatchRoot = new Br((t) => this._root.match(t));
    getColorMap() {
    ...
    match(t) {
      ...
      const e = t.scopeName,
        r = this._cachedMatchRoot
          .get(e)
          .find((s) => li(t.parent, s.parentScopes));
  ...
  St = class Xe {
    ...
    static push(e, n) {
      for (const r of n) e = new Xe(e, r);
      return e;
    }
    static from(...e) {
      let n = null;
      for (let r = 0; r < e.length; r++) n = new Xe(n, e[r]);
      return n;
    }
    push(e) {
...
function di(t, e) {
  t.sort((a, c) => {
    let u = Or(a.scope, c.scope);
    return u !== 0 || ((u = Dr(a.parentScopes, c.parentScopes)), u !== 0)
      ? u
      : a.index - c.index;
  });
  let n = 0,
  ...
  for (; t.length >= 1 && t[0].scope === ""; ) {
    ...
    (a.fontStyle !== -1 && (n = a.fontStyle),
      ...
      a.background !== null && (s = a.background));
  }
  let o = new fi(e),
    i = new Fr(n, o.getId(r), o.getId(s)),
    l = new gi(new Dt(0, null, -1, 0, 0), []);
...
var fi = class {
  ...
  gi = class Gt {
    ...
    match(e) {
      ...
      return (n.sort(Gt._cmpBySpecificity), n);
    }
    insert(e, n, r, s, o, i) {
      if (n === "") {
      ...
      (this._children.hasOwnProperty(a)
        ...
        : ((u = new Gt(
            ...
            Dt.cloneArr(this._rulesWithParentScopes),
          )),
          (this._children[a] = u)),
  ...
  we = class H {
    ...
    static set(e, n, r, s, o, i, l) {
      let a = H.getLanguageId(e),
        c = H.getTokenType(e),
        u = H.containsBalancedBrackets(e) ? 1 : 0,
        h = H.getFontStyle(e),
        d = H.getForeground(e),
        f = H.getBackground(e);
      return (
...
function Ye(t, e) {
  ...
  for (; s !== null; ) {
    ...
    let c = i();
    if ((n.push({ matcher: c, priority: a }), s !== ",")) break;
    s = r.next();
  }
  return n;
  function o() {
...
var Ne = class {
  ...
  wi = class {
    ...
    processQueue() {
      ...
      this.Q = [];
      const e = new bi();
      for (const n of t) Ci(n, this.initialScopeName, this.repo, e);
...
function Ci(t, e, n, r) {
  ...
  if (i) for (const l of i) r.add(new Ne(l));
}
function Bt(t, e, n) {
...
function Je(t, e, n) {
  for (const r of t) {
    ...
    n.visitedRule.add(r);
    const s = r.repository ? Tr({}, e.repository, r.repository) : e.repository;
    Array.isArray(r.patterns) && Je(r.patterns, { ...e, repository: s }, n);
    const o = r.include;
    if (!o) continue;
    const i = Wr(o);
    switch (i.kind) {
      case 0:
        Ke({ ...e, selfGrammar: e.baseGrammar }, n);
        break;
      case 1:
        Ke(e, n);
        break;
      case 2:
        Bt(i.ruleName, { ...e, repository: s }, n);
        break;
      case 3:
      case 4:
        const l =
        ...
        if (l) {
          ...
          i.kind === 4 ? Bt(i.ruleName, a, n) : Ke(a, n);
        } else
          i.kind === 4
...
function Wr(t) {
  if (t === "$base") return new _i();
  if (t === "$self") return new Si();
  const e = t.indexOf("#");
  if (e === -1) return new vi(t);
  if (e === 0) return new ki(t.substring(1));
  {
...
var De = class {
    ...
    get debugName() {
      const t = this.$location
        ? `${Mr(this.$location.filename)}:${this.$location.line}`
        : "unknown";
    ...
    getName(t, e) {
      return !this._nameIsCapturing ||
        ...
        e === null
        ? this._name
        : We.replaceCaptures(this._name, t, e);
    }
    getContentName(t, e) {
      return !this._contentNameIsCapturing || this._contentName === null
        ? this._contentName
        : We.replaceCaptures(this._contentName, t, e);
    }
  },
  Ai = class extends De {
          ...
          n.registerRule((s) => {
            if (((e.id = s), e.match))
              return new Ri(
                ...
                e.name,
                e.match,
                F._compileCaptures(e.captures, n, r),
              );
            if (typeof e.begin > "u") {
              e.repository && (r = Tr({}, r, e.repository));
              let o = e.patterns;
              return (
            ...
            return e.while
              ? new et(
                  ...
                  e.contentName,
                  e.begin,
                  F._compileCaptures(e.beginCaptures || e.captures, n, r),
                  e.while,
                  F._compileCaptures(e.whileCaptures || e.captures, n, r),
                  F._compilePatterns(e.patterns, n, r),
                )
              : new Ft(
                  e.$vscodeTextmateLocation,
                  e.id,
                  ...
                  F._compileCaptures(e.beginCaptures || e.captures, n, r),
                  e.end,
                  F._compileCaptures(e.endCaptures || e.captures, n, r),
    ...
    static _compileCaptures(e, n, r) {
      ...
      if (e) {
        ...
        for (const i in e) {
          ...
          const l = parseInt(i, 10);
          let a = 0;
          (e[i].patterns && (a = F.getCompiledRuleId(e[i], n, r)),
            (s[l] = F.createCaptureRule(
              n,
    ...
    static _compilePatterns(e, n, r) {
      ...
      if (e)
        for (let o = 0, i = e.length; o < i; o++) {
          ...
          let a = -1;
          if (l.include) {
            const c = Wr(l.include);
            switch (c.kind) {
              case 0:
              case 1:
                a = F.getCompiledRuleId(r[l.include], n, r);
                break;
              case 2:
                let u = r[c.ruleName];
                u && (a = F.getCompiledRuleId(u, n, r));
                break;
              case 3:
              case 4:
                const h = c.scopeName,
                ...
                if (f)
                  if (d) {
                    ...
                    p && (a = F.getCompiledRuleId(p, n, f.repository));
                  } else
                    a = F.getCompiledRuleId(
                      f.repository.$self,
                      n,
                      f.repository,
                    );
          ...
          } else a = F.getCompiledRuleId(l, n, r);
          if (a !== -1) {
            const c = n.getRule(a);
            let u = !1;
            if (
              ((c instanceof Dn || c instanceof Ft || c instanceof et) &&
  ...
  $e = class Hr {
    ...
    constructor(e, n) {
      if (e && typeof e == "string") {
        ...
        ((this.hasAnchor = i),
          s === 0
            ? (this.source = e)
            : (o.push(e.substring(s, r)), (this.source = o.join(""))));
    ...
    clone() {
      return new Hr(this.source, this.ruleId);
    }
    setSource(e) {
      this.source !== e &&
        ((this.source = e),
    ...
    resolveBackReferences(e, n) {
      ...
      return (
        (On.lastIndex = 0),
        this.source.replace(On, (s, o) => Gr(r[parseInt(o, 10)] || ""))
      );
    }
    _buildAnchorCache() {
      if (typeof this.source != "string")
  ...
  Pe = class {
    ...
    setSource(t, e) {
      this._items[t].source !== e &&
        (this._disposeCaches(), this._items[t].setSource(e));
    }
    compile(t) {
      if (!this._cached) {
...
`);
  ...
  Li = class jt {
    ...
    getBasicScopeAttributes(e) {
      return e === null
        ? jt._NULL_SCOPE_METADATA
        : this._getBasicScopeAttributes.get(e);
    }
    static _NULL_SCOPE_METADATA = new kt(0, 0);
    _getBasicScopeAttributes = new Br((e) => {
    ...
    _toStandardTokenType(e) {
      const n = e.match(jt.STANDARD_TOKEN_TYPE_REGEXP);
      if (!n) return 8;
      switch (n[1]) {
        case "comment":
          return 1;
...
function Vr(t, e, n, r, s, o, i, l) {
  ...
  const h = Date.now();
  for (; !c; ) {
    if (l !== 0 && Date.now() - h > l) return new Bn(s, !0);
    d();
  }
  return new Bn(s, !1);
  function d() {
    const f = Pi(t, e, n, r, s, u);
    if (!f) {
      (o.produce(s, a), (c = !0));
      return;
    }
    ...
    if (b === Ii) {
      ...
      const y = s;
      if (
        ((s = s.parent), (u = y.getAnchorPos()), !C && y.getEnterPos() === r)
      ) {
        ((s = y), o.produce(s, a), (c = !0));
        return;
      }
    } else {
      const g = t.getRule(b);
      o.produce(s, p[0].start);
      const y = s,
        m = g.getName(e.content, p),
        _ = s.contentNameScopesList.pushAttributed(m, t);
      if (
        ((s = s.push(b, r, u, p[0].end === a, null, _, _)), g instanceof Ft)
      ) {
        const k = g;
        ...
        const I = k.getContentName(e.content, p),
          S = _.pushAttributed(I, t);
        if (
          ((s = s.withContentNameScopesList(S)),
          k.endHasBackReferences &&
            (s = s.withEndRule(
              k.getEndWithResolvedBackReferences(e.content, p),
            )),
          !C && y.hasSameRuleAs(s))
        ) {
        ...
        if (
          ...
          k.whileHasBackReferences &&
            (s = s.withEndRule(
              k.getWhileWithResolvedBackReferences(e.content, p),
            )),
          !C && y.hasSameRuleAs(s))
        ) {
          ((s = s.pop()), o.produce(s, a), (c = !0));
...
function $i(t, e, n, r, s, o) {
  ...
  for (let a = s; a; a = a.pop()) {
    const c = a.getRule(t);
    c instanceof et && l.push({ rule: c, stack: a });
  }
  for (let a = l.pop(); a; a = l.pop()) {
    const { ruleScanner: c, findOptions: u } = Oi(
        a.rule,
        t,
        a.stack.endRule,
        n,
    ...
    if (h) {
      ...
      h.captureIndices &&
        ...
        h.captureIndices[0].end > r &&
          ((r = h.captureIndices[0].end), (n = !1)));
    } else {
      s = a.stack.pop();
      break;
    }
...
function Ti(t, e, n, r, s, o) {
  const i = s.getRule(t),
    { ruleScanner: l, findOptions: a } = Xr(i, t, s.endRule, n, r === o),
...
function Mi(t, e, n, r, s, o, i) {
  ...
  for (let d = 0, f = t.length; d < f; d++) {
    ...
    const b = e.getRule(p.ruleId),
      { ruleScanner: C, findOptions: g } = Xr(b, e, null, r, s === i),
      y = C.findNextMatchSync(n, s, g);
    if (!y) continue;
    const m = y.captureIndices[0].start;
    if (
      !(m >= l) &&
      ((l = m),
      (a = y.captureIndices),
  ...
  return a
    ? { priorityMatch: u === -1, captureIndices: a, matchedRuleId: c }
    : null;
}
  ...
  for (let h = 0; h < a; h++) {
    ...
    if (
      ...
      const b = d.getName(l, i),
        C = r.contentNameScopesList.pushAttributed(b, t),
        g = d.getContentName(l, i),
        y = C.pushAttributed(g, t),
        m = r.push(d.retokenizeCapturedWithRuleId, f.start, -1, !1, null, C, y),
        _ = t.createOnigString(l.substring(0, f.end));
      (Vr(t, _, n && f.start === 0, f.start, m, s, !1, 0), Ur(_));
      continue;
    }
    const p = d.getName(l, i);
    if (p !== null) {
      const C = (
        c.length > 0 ? c[c.length - 1].scopes : r.contentNameScopesList
      ).pushAttributed(p, t);
      c.push(new Di(C, f.end));
    }
  }
  for (; c.length > 0; )
    (s.produceFromScopes(c[c.length - 1].scopes, c[c.length - 1].endPos),
...
function Gi(t, e, n, r, s, o, i, l) {
  return new Fi(t, e, n, r, s, o, i, l);
}
function Fn(t, e, n, r, s) {
  const o = Ye(e, tt),
    i = qr.getCompiledRuleId(n, r, s.repository);
  for (const l of o)
    t.push({
      debugSelector: e,
      matcher: l.matcher,
...
var Fi = class {
  ...
  _collectInjections() {
    ...
    if (r) {
      ...
      if (s) for (let i in s) Fn(e, i, s[i], this, r);
  ...
  _tokenize(t, e, n, r) {
    this._rootId === -1 &&
      ((this._rootId = qr.getCompiledRuleId(
    ...
    if (!e || e === Ut.NULL) {
      ...
      (d
        ...
        (e = new Ut(null, this._rootId, -1, -1, !1, null, f, f)));
    } else ((s = !1), e.reset());
    t =
      t +
      `
`;
    const o = this.createOnigString(t),
      i = o.content.length,
      l = new Ui(n, t, this._tokenTypeMatchers, this.balancedBracketSelectors),
      a = Vr(this, o, s, 0, e, l, !0, r);
    return (
      Ur(o),
      {
        lineLength: i,
...
var Re = class Z {
    ...
    static mergeAttributes(e, n, r) {
      ...
      return (
        r !== null &&
          ((s = r.fontStyle), (o = r.foregroundId), (i = r.backgroundId)),
        we.set(e, n.languageId, n.tokenType, null, s, o, i)
      );
    }
    pushAttributed(e, n) {
      if (e === null) return this;
      if (e.indexOf(" ") === -1) return Z._pushAttributed(this, e, n);
      const r = e.split(/ /g);
      let s = this;
      for (const o of r) s = Z._pushAttributed(s, o, n);
      return s;
    }
    static _pushAttributed(e, n, r) {
      const s = r.getMetadataForScope(n),
        ...
        i = r.themeProvider.themeMatch(o),
        l = Z.mergeAttributes(e.tokenAttributes, s, i);
      return new Z(e, o, l);
    }
    getScopeNames() {
  ...
  Ut = class ie {
    ...
    static NULL = new ie(null, 0, 0, 0, !1, null, null, null);
    _enterPos;
    _anchorPos;
    depth;
    equals(e) {
    ...
    static _equals(e, n) {
      return e === n
        ...
        : this._structuralEquals(e, n)
          ? Re.equals(e.contentNameScopesList, n.contentNameScopesList)
          : !1;
    }
    ...
    push(e, n, r, s, o, i, l) {
      return new ie(this, e, n, r, s, o, i, l);
    }
    getEnterPos() {
    ...
    static pushFrame(e, n) {
      const r = Re.fromExtension(e?.nameScopesList ?? null, n.nameScopesList);
      return new ie(
        e,
        n.ruleId,
        n.enterPos ?? -1,
        ...
        n.endRule,
        r,
        Re.fromExtension(r, n.contentNameScopesList),
      );
    }
  },
  ji = class {
    ...
    constructor(t, e) {
      ((this.balancedBracketScopes = t.flatMap((n) =>
        n === "*"
          ? ((this.allowAny = !0), [])
          : Ye(n, tt).map((r) => r.matcher),
      )),
        (this.unbalancedBracketScopes = e.flatMap((n) =>
          Ye(n, tt).map((r) => r.matcher),
        )));
    }
    get matchesAlways() {
      ...
      if (this._emitBinaryTokens) {
        ...
        if (
          ...
          for (const i of this._tokenTypeOverrides)
            i.matcher(o) && (r = we.set(r, 0, i.type, null, -1, 0, 0));
          this.balancedBracketSelectors &&
            (s = this.balancedBracketSelectors.match(o));
        }
        if (
          (s && (r = we.set(r, 0, 8, s, -1, 0, 0)),
  ...
  Wi = class {
    ...
    grammarForScopeName(t, e, n, r, s) {
      if (!this._grammars.has(t)) {
        ...
        if (!o) return null;
        this._grammars.set(t, Gi(t, o, e, n, r, s, this, this._onigLib));
      }
  ...
  zi = class {
    ...
    constructor(e) {
      ((this._options = e),
        (this._syncRegistry = new Wi(
          Qe.createFromRawTheme(e.theme, e.colorMap),
          e.onigLib,
        )),
    ...
    setTheme(e, n) {
      this._syncRegistry.setTheme(Qe.createFromRawTheme(e, n));
    }
    getColorMap() {
    ...
    addGrammar(e, n = [], r = 0, s = null) {
      return (
        ...
        this._grammarForScopeName(e.scopeName, r, s)
      );
    }
...
const vt = Object.keys(Ht);
class rn extends W {
  constructor(e, n, r, s) {
    let o = -1;
    if ((super(e, n), Un(this, "space", s), typeof r == "number"))
      for (; ++o < vt.length; ) {
        const i = vt[o];
        Un(this, vt[o], (r & Ht[i]) === Ht[i]);
      }
  }
}
...
function Qi(t, e) {
  ...
  if (n.length > 4 && n.slice(0, 4) === "data" && Zi.test(e)) {
    if (e.charAt(4) === "-") {
      const o = e.slice(5).replace(Wn, Ji);
...
const na = /["&'<>`]/g,
  ra = /[\uD800-\uDBFF][\uDC00-\uDFFF]/g,
  sa = /[\x01-\t\v\f\x0E-\x1F\x7F\x81\x8D\x8F\x90\x9D\xA0-\uFFFF]/g,
  oa = /[|\\{}()[\]^$+*?.]/g,
  qn = new WeakMap();
function ia(t, e) {
  if (
    ((t = t.replace(e.subset ? aa(e.subset) : na, r)), e.subset || e.escapeOnly)
  )
    return t;
  return t.replace(ra, n).replace(sa, r);
  function n(s, o, i) {
    return e.format(
...
function aa(t) {
  let e = qn.get(t);
  return (e || ((e = la(t)), qn.set(t, e)), e);
}
function la(t) {
  const e = [];
  let n = -1;
  for (; ++n < t.length; ) e.push(t[n].replace(oa, "\\$&"));
...
function da(t, e, n) {
  const r = "&#" + String(t);
  return n && e && !ha.test(String.fromCharCode(e)) ? r : r + ";";
}
const fa = [
    "AElig",
    "AMP",
  ...
  pa = ["cent", "copy", "divide", "gt", "lt", "not", "para", "times"],
  rs = {}.hasOwnProperty,
  Vt = {};
let ze;
for (ze in xt) rs.call(xt, ze) && (Vt[xt[ze]] = ze);
const ga = /[^\dA-Za-z]/;
function ma(t, e, n, r) {
  ...
  if (rs.call(Vt, s)) {
    ...
    return n &&
      fa.includes(o) &&
      !pa.includes(o) &&
      (!r || (e && e !== 61 && ga.test(String.fromCharCode(e))))
      ? i
      : i + ";";
  }
  return "";
...
function be(t, e) {
  return ia(t, Object.assign({ format: ya }, e));
}
const ba = /^>|^->|<!--|-->|--!>|<!-$/g,
  wa = [">"],
  Ca = ["<", ">"];
function _a(t, e, n, r) {
  return r.settings.bogusComments
    ? "<?" +
        be(
          t.value,
          Object.assign({}, r.settings.characterReferences, { subset: wa }),
        ) +
        ">"
    : "<!--" + t.value.replace(ba, s) + "-->";
  function s(o) {
    return be(
      o,
      Object.assign({}, r.settings.characterReferences, { subset: Ca }),
    );
  }
}
function Sa(t, e, n, r) {
...
const xa = /[ \t\n\f\r]/g;
function sn(t) {
  return typeof t == "object" ? (t.type === "text" ? Vn(t.value) : !1) : Vn(t);
}
function Vn(t) {
  return t.replace(xa, "") === "";
}
...
function is(t) {
  return e;
  function e(n, r, s) {
    return Ia.call(t, n.tagName) && t[n.tagName](n, r, s);
  }
}
const on = is({
  body: Ra,
...
function Et(t, e, n) {
  ...
  return (
    !r ||
    (r.type !== "comment" && !(r.type === "text" && sn(r.value.charAt(0))))
  );
}
function Aa(t, e, n) {
  const r = D(n, e);
...
const Fa = is({ body: Wa, colgroup: za, head: Ua, html: ja, tbody: qa });
function ja(t) {
  const e = D(t, -1);
...
function Wa(t) {
  ...
  return (
    !e ||
    (e.type !== "comment" &&
      !(e.type === "text" && sn(e.value.charAt(0))) &&
      !(
        e.type === "element" &&
        (e.tagName === "meta" ||
          e.tagName === "link" ||
...
function Ha(t, e, n, r) {
  ...
  const l = [];
  let a;
  s.space === "html" && t.tagName === "svg" && (r.schema = ns);
...
function Va(t, e) {
  ...
  for (; ++r < n.length; ) {
    const o = t.settings.tightAttributes
  ...
  return n === !0 ||
    ...
    : (t.settings.preferUnquoted &&
        (l = be(
          ...
          Object.assign({}, t.settings.characterReferences, {
            attribute: !0,
            subset: qe.unquoted[s][o],
          }),
        )),
      l !== n &&
        (t.settings.quoteSmart &&
          Hn(n, i) > Hn(n, t.alternative) &&
          (i = t.alternative),
        (l =
          i +
          be(
            n,
            Object.assign({}, t.settings.characterReferences, {
              subset: (i === "'" ? qe.single : qe.double)[s][o],
              attribute: !0,
            }),
          ) +
          i)),
...
function as(t, e, n, r) {
  return n &&
    ...
    : be(
        t.value,
        Object.assign({}, r.settings.characterReferences, { subset: Ka }),
      );
}
function Za(t, e, n, r) {
  return r.settings.allowDangerousHtml ? t.value : as(t, e, n, r);
}
function Qa(t, e, n, r) {
  return r.all(t);
}
...
async function ls(t) {
  return Promise.resolve(typeof t == "function" ? t() : t).then(
    (e) => e.default || e,
  );
}
function an(t) {
...
function ul(t) {
  ...
  function r(s, o) {
    let i = 0;
    for (let l = 0; l < s; l++) i += e[l].length;
    return ((i += o), i);
  }
  return { lines: e, indexToPos: n, posToIndex: r };
}
const cn = "light-dark()",
  hl = ["color", "background-color"];
function dl(t, e) {
  let n = 0;
  const r = [];
  for (const s of e)
    ...
    ? t.map((r) =>
        r.flatMap((s) => {
          const o = n
            ...
            .map((i) => i - s.offset)
            .sort((i, l) => i - l);
          return o.length ? dl(s, o) : s;
        }),
      )
    : t;
}
function pl(t, e, n, r, s = "css-vars") {
  const o = {
      content: t.content,
      explanation: t.explanation,
      offset: t.offset,
    },
    i = e.map((u) => rt(t.variants[u])),
  ...
  return (
    i.forEach((u, h) => {
      for (const d of l) {
        const f = u[d] || "inherit";
        if (h === 0 && r && hl.includes(d))
          if (r === cn && i.length > 1) {
            const p = e.findIndex((y) => y === "light"),
              b = e.findIndex((y) => y === "dark");
            if (p === -1 || b === -1)
              throw new G(
            ...
            const C = i[p][d] || "inherit",
              g = i[b][d] || "inherit";
            ((a[d] = `light-dark(${C}, ${g})`),
              s === "css-vars" && (a[c(h, d)] = f));
          } else a[d] = f;
        else s === "css-vars" && (a[c(h, d)] = f);
      }
    }),
    (o.htmlStyle = a),
    o
...
function rt(t) {
  ...
  if (
    ...
    (t.fontStyle & j.Italic && (e["font-style"] = "italic"),
      t.fontStyle & j.Bold && (e["font-weight"] = "bold"));
    const n = [];
    (t.fontStyle & j.Underline && n.push("underline"),
      t.fontStyle & j.Strikethrough && n.push("line-through"),
...
class ve {
  ...
  static initial(e, n) {
    return new ve(Object.fromEntries(al(n).map((r) => [r, Wt])), e);
  }
  constructor(...e) {
    if (e.length === 2) {
      const [n, r] = e;
...
function ml(t, e) {
  if (!(t instanceof ve)) throw new G("Invalid grammar state");
...
function yl() {
  ...
  return {
    ...
    tokens(n) {
      ...
      const s = e(this).decorations.flatMap((i) => [
        i.start.offset,
        i.end.offset,
      ]);
      return fl(n, s);
    ...
    code(n) {
      if (!this.options.decorations?.length) return;
      const r = e(this),
        s = Array.from(n.children).filter(
      ...
      function o(u, h, d, f) {
        ...
        if (
          (h === 0 && (C = 0),
          d === 0 && (g = 0),
          d === Number.POSITIVE_INFINITY && (g = p.children.length),
          C === -1 || g === -1)
        )
          for (let m = 0; m < p.children.length; m++)
            ((b += hs(p.children[m])),
              C === -1 && b.length === h && (C = m + 1),
              g === -1 && b.length === d && (g = m + 1));
        if (C === -1)
          throw new G(
            `Failed to find start index for decoration ${JSON.stringify(f.start)}`,
          );
        if (g === -1)
          throw new G(
            `Failed to find end index for decoration ${JSON.stringify(f.end)}`,
          );
        const y = p.children.slice(C, g);
        if (!f.alwaysWrap && y.length === p.children.length) l(p, f, "line");
          ...
          (l(m, f, "wrapper"), p.children.splice(C, y.length, m));
        }
      }
      function i(u, h) {
        s[u] = l(s[u], h, "line");
      ...
      function l(u, h, d) {
        ...
        return (
          ...
          h.properties?.class && cs(u, h.properties.class),
          (u = p(u, d) || u),
          u
        );
      }
      const a = [],
        c = r.decorations.sort(
          (u, h) =>
            h.start.offset - u.start.offset || u.end.offset - h.end.offset,
        );
      for (const u of c) {
        const { start: h, end: d } = u;
        if (h.line === d.line) o(h.line, h.character, d.character, u);
        else if (h.line < d.line) {
          o(h.line, h.character, Number.POSITIVE_INFINITY, u);
          for (let f = h.line + 1; f < d.line; f++) a.unshift(() => i(f, u));
  ...
  for (let e = 0; e < t.length; e++) {
    ...
    for (let r = e + 1; r < t.length; r++) {
      const s = t[r],
        ...
        l = s.start.offset <= n.start.offset && n.start.offset < s.end.offset,
        a = s.start.offset < n.end.offset && n.end.offset <= s.end.offset;
      if (o || i || l || a) {
        if (
          (o && i) ||
          (l && a) ||
...
function hs(t) {
  return t.type === "text"
    ? t.value
    : t.type === "element"
      ? t.children.map(hs).join("")
      : "";
}
const wl = [yl()];
function st(t) {
  const e = Cl(t.transformers || []);
  return [...e.pre, ...e.normal, ...e.post, ...wl];
}
function Cl(t) {
  const e = [],
    n = [],
...
function Zn(t) {
  ...
  if (e === "2") {
    ...
    return n.length !== 3 || n.some((r) => Number.isNaN(r))
      ? void 0
      : { type: "rgb", rgb: n };
  } else if (e === "5") {
    const n = t.shift();
...
function Sl(t) {
  ...
  for (; t.length > 0; ) {
    ...
    if (!Number.isNaN(r))
      ...
      else if (r <= 9) It[r] && e.push({ type: "setDecoration", value: It[r] });
      else if (r <= 29) {
        const s = It[r - 20];
        s &&
          ...
          : r === 53
            ...
            : r === 55
              ...
              : r >= 90 && r <= 97
                ? e.push({
                    type: "setForegroundColor",
                    value: { type: "named", name: ce[r - 90 + 8] },
                  })
                : r >= 100 &&
                  r <= 107 &&
                  e.push({
                    type: "setBackgroundColor",
                    value: { type: "named", name: ce[r - 100 + 8] },
                  });
  }
  return e;
}
function kl() {
  ...
  return {
    parse(r) {
      ...
      do {
        const i = _l(r, o),
          l = i.sequence ? r.substring(o, i.startPosition) : r.substring(o);
        if (
          (l.length > 0 &&
            s.push({
              value: l,
...
function xl(t = vl) {
  ...
  function s() {
    if (r) return r;
    r = [];
    for (let c = 0; c < ce.length; c++) r.push(e(ce[c]));
    let l = [0, 95, 135, 175, 215, 255];
    for (let c = 0; c < 6; c++)
      for (let u = 0; u < 6; u++)
        for (let h = 0; h < 6; h++) r.push(n([l[c], l[u], l[h]]));
    let a = 8;
  ...
  return s.map((a) =>
    l.parse(a[0]).map((c) => {
      ...
      (c.decorations.has("reverse")
        ...
        (u = se(u, r)),
        (h = se(h, r)),
        c.decorations.has("dim") && (u = Al(u)));
      let d = j.None;
      return (
        c.decorations.has("bold") && (d |= j.Bold),
        c.decorations.has("italic") && (d |= j.Italic),
        c.decorations.has("underline") && (d |= j.Underline),
        c.decorations.has("strikethrough") && (d |= j.Strikethrough),
        { content: c.value, offset: a[1], color: u, bgColor: h, fontStyle: d }
      );
    }),
  );
}
...
function Rl(...t) {
  if (t.length === 2) return Te(t[1]);
  const [e, n, r = {}] = t,
    { lang: s = "text", theme: o = e.getLoadedThemes()[0] } = r;
  if (an(s) || ln(o)) throw new G("Plain language does not have grammar state");
  if (s === "ansi") throw new G("ANSI language does not have grammar state");
  const { theme: i, colorMap: l } = e.setTheme(o),
    a = e.getLanguage(s);
  return new ve(hn(n, a, i, l, r).stateStack, a.name, i.name);
}
function Ll(t, e, n, r, s) {
  const o = hn(t, e, n, r, s),
    i = new ve(o.stateStack, e.name, n.name);
  return (ht(o.tokens, i), o.tokens);
}
function hn(t, e, n, r, s) {
  const o = nt(n, s),
    { tokenizeMaxLineLength: i = 0, tokenizeTimeLimit: l = 500 } = s,
    a = ut(t);
  let c = s.grammarState
      ? (ml(s.grammarState, n.name) ?? Wt)
      : s.grammarContextCode != null
        ? hn(s.grammarContextCode, e, n, r, {
            ...s,
            grammarState: void 0,
  ...
  for (let d = 0, f = a.length; d < f; d++) {
    ...
    if (i > 0 && p.length >= i) {
      ((u = []), h.push([{ content: p, offset: b, color: "", fontStyle: 0 }]));
      continue;
    }
    let C, g, y;
    s.includeExplanation &&
      ((C = e.tokenizeLine(p, c, l)), (g = C.tokens), (y = 0));
    const m = e.tokenizeLine2(p, c, l),
      _ = m.tokens.length / 2;
    for (let k = 0; k < _; k++) {
      const I = m.tokens[2 * k],
        S = k + 1 < _ ? m.tokens[2 * k + 2] : p.length;
      if (I === S) continue;
      const A = m.tokens[2 * k + 1],
        E = se(r[we.getForeground(A)], o),
        R = we.getFontStyle(A),
        L = {
          content: p.substring(I, S),
          offset: b + I,
          color: E,
          fontStyle: R,
        };
      if (s.includeExplanation) {
        ...
        if (s.includeExplanation !== "scopeName")
          for (const U of n.settings) {
            let te;
            switch (typeof U.scope) {
              case "string":
                te = U.scope.split(/,/).map((ft) => ft.trim());
                break;
              case "object":
                te = U.scope;
                break;
        ...
        for (; I + $ < S; ) {
          const U = g[y],
            te = p.substring(U.startIndex, U.endIndex);
          (($ += te.length),
            L.explanation.push({
              content: te,
              scopes:
                s.includeExplanation === "scopeName"
                  ? Nl(U.scopes)
                  : $l(M, U.scopes),
            }),
            (y += 1));
...
function $l(t, e) {
  ...
  for (let r = 0, s = e.length; r < s; r++) {
    const o = e[r];
    n[r] = { scopeName: o, themeMatches: Tl(t, o, e.slice(0, r)) };
  }
  return n;
}
function Qn(t, e) {
...
function Pl(t, e, n) {
  ...
  let r = t.length - 2,
    s = n.length - 1;
  for (; r >= 0 && s >= 0; ) (Qn(t[r], n[s]) && (r -= 1), (s -= 1));
  return r === -1;
}
function Tl(t, e, n) {
  const r = [];
  ...
  const r = Object.entries(n.themes)
    ...
    s = r.map((a) => {
      const c = un(t, e, { ...n, theme: a.theme }),
        u = Te(c),
        h = typeof a.theme == "string" ? a.theme : a.theme.name;
      return { tokens: c, state: u, theme: h };
    }),
    o = Ml(...s.map((a) => a.tokens)),
    i = o[0].map((a, c) =>
      a.map((u, h) => {
        ...
        return (
          ...
          o.forEach((f, p) => {
            const { content: b, explanation: C, offset: g, ...y } = f[c][h];
            d.variants[r[p].color] = y;
          }),
          d
        );
      }),
    ...
    l = s[0].state
      ? new ve(
          Object.fromEntries(
            s.map((a) => [a.theme, a.state?.getInternalStack(a.theme)]),
          ),
          s[0].state.lang,
        )
      : void 0;
  ...
  if ("themes" in n) {
    const {
      ...
      d = Object.entries(n.themes)
        ...
        .sort((g, y) => (g.color === c ? -1 : y.color === c ? 1 : 0));
    if (d.length === 0) throw new G("`themes` option must not be empty");
    const f = ds(t, e, n);
    if (((a = Te(f)), c && cn !== c && !d.find((g) => g.color === c)))
      throw new G(
        `\`themes\` option must contain the defaultColor key \`${c}\``,
      );
    const p = d.map((g) => t.getTheme(g.theme)),
      b = d.map((g) => g.color);
    ((o = f.map((g) => g.map((y) => pl(y, b, u, c, h)))), a && ht(o, a));
    ...
    const c = nt(n.theme, n);
    o = un(t, e, n);
    const u = t.getTheme(n.theme);
    ((r = se(u.bg, c)), (s = se(u.fg, c)), (i = u.name), (a = Te(o)));
  } else
      ...
      if (a === 0 && s) {
        if (s === cn && t.length > 1) {
          const h = t.findIndex((b) => b.color === "light"),
            d = t.findIndex((b) => b.color === "dark");
          if (h === -1 || d === -1)
            throw new G(
              'When using `defaultColor: "light-dark()"`, you must provide both `light` and `dark` themes',
            );
          const f = se(e[h][o], n[h]) || "inherit",
            p = se(e[d][o], n[d]) || "inherit";
...
function it(
  ...
  r = {
    meta: {},
    options: n,
    codeToHast: (s, o) => it(t, s, o),
    codeToTokens: (s, o) => ot(t, s, o),
  },
) {
  let s = e;
  for (const p of st(n)) s = p.preprocess?.call(r, s, n) || s;
  let {
    tokens: o,
    fg: i,
    bg: l,
  ...
  const { mergeWhitespaces: h = !0, mergeSameStyleTokens: d = !1 } = n;
  (h === !0 ? (o = Dl(o)) : h === "never" && (o = Gl(o)), d && (o = Bl(o)));
  const f = {
    ...r,
    get source() {
      return s;
  ...
  for (const p of st(n)) o = p.tokens?.call(f, o) || o;
  return Ol(
    o,
    {
      ...n,
...
`,
      ...
      for (const m of b) {
        ...
        const k = Xt(m.htmlStyle || rt(m));
        k && (_.properties.style = k);
        for (const I of s) _ = I?.span?.call(f, _, C + 1, y, g, m) || _;
        (l === "inline"
          ? i.children.push(_)
          : l === "classic" && g.children.push(_),
          (y += m.content.length));
      }
      if (l === "classic") {
        for (const m of s) g = m?.line?.call(f, g, C + 1) || g;
        (d.push(g), o.push(g));
      } else l === "inline" && d.push(g);
    }),
    l === "classic")
  ) {
    for (const b of s) h = b?.code?.call(f, h) || h;
    u.children.push(h);
    for (const b of s) u = b?.pre?.call(f, u) || u;
    i.children.push(u);
  } else if (l === "inline") {
    const b = [];
    let C = {
    ...
    for (const m of i.children)
      m.type === "element" && m.tagName === "br"
        ...
        : (m.type === "element" || m.type === "text") && C.children.push(m);
    b.push(C);
    let y = { type: "element", tagName: "code", properties: {}, children: b };
    for (const m of s) y = m?.code?.call(f, y) || y;
    i.children = [];
  ...
  let p = i;
  for (const b of s) p = b?.root?.call(f, p) || p;
  return (r && ht(p, r), p);
}
function Dl(t) {
  return t.map((e) => {
    ...
    return (
      e.forEach((o, i) => {
        const a = !(
          o.fontStyle &&
          (o.fontStyle & j.Underline || o.fontStyle & j.Strikethrough)
        );
        a && o.content.match(/^\s+$/) && e[i + 1]
...
function Gl(t) {
  return t.map((e) =>
    e.flatMap((n) => {
      ...
      return (
        s && l.unshift({ content: s, offset: n.offset }),
        i && l.push({ content: i, offset: n.offset + s.length + o.length }),
        l
      );
    }),
  );
  ...
  return t.map((e) => {
    ...
    for (const r of e) {
      ...
      const s = n[n.length - 1],
        o = Xt(s.htmlStyle || rt(s)),
        i = Xt(r.htmlStyle || rt(r)),
        l =
          s.fontStyle &&
          (s.fontStyle & j.Underline || s.fontStyle & j.Strikethrough),
        a =
          r.fontStyle &&
          (r.fontStyle & j.Underline || r.fontStyle & j.Strikethrough);
...
function jl(t, e, n) {
  const r = {
    meta: {},
    options: n,
    codeToHast: (o, i) => it(t, o, i),
    codeToTokens: (o, i) => ot(t, o, i),
  };
  let s = Fl(it(t, e, n, r));
  for (const o of st(n)) s = o.postprocess?.call(r, s, n) || s;
  return s;
}
const Jn = { light: "#333333", dark: "#bbbbbb" },
  er = { light: "#fffffe", dark: "#1e1e1e" },
  tr = "__shiki_resolved";
function dn(t) {
  if (t?.[tr]) return t;
  const e = { ...t };
  ...
  if (!n || !r) {
    ...
    (l?.settings?.foreground && (r = l.settings.foreground),
      ...
      r || (r = e.type === "light" ? Jn.light : Jn.dark),
      n || (n = e.type === "light" ? er.light : er.dark),
      (e.fg = r),
      (e.bg = n));
  }
  ...
  return (
    Object.defineProperty(e, tr, { enumerable: !1, writable: !1, value: !0 }),
    e
  );
}
async function Ul(t) {
      ...
      (
        await Promise.all(
          t
            ...
            .map(
              async (e) =>
                await ls(e).then((n) => (Array.isArray(n) ? n : [n])),
            ),
        )
      ).flat(),
    ),
...
async function Wl(t) {
  return (
    await Promise.all(t.map(async (n) => (cl(n) ? null : dn(await ls(n)))))
  ).filter((n) => !!n);
}
...
class zl extends zi {
  ...
  setTheme(e) {
    ...
    (n || ((n = Qe.createFromRawTheme(e)), this._textmateThemeCache.set(e, n)),
      this._syncRegistry.setTheme(n));
  }
  getGrammar(e) {
    return ((e = fs(e, this._alias)), this._resolvedGrammars.get(e));
  }
  loadLanguage(e) {
  ...
  loadLanguages(e) {
    ...
    if (r.length) {
      const s = n
        .filter(([o, i]) =>
          i
            ? (i.embeddedLanguages || i.embeddedLangs)?.some((a) =>
                r.map(([c]) => c).includes(a),
              )
            : !1,
        )
...
function Hl(t) {
  ((xe += 1),
    t.warnings !== !1 &&
      ...
      xe % 10 === 0 &&
      console.warn(
        `[Shiki] ${xe} instances have been created. Shiki is supposed to be used as a singleton, consider refactoring your code to cache your highlighter instance; Or call \`highlighter.dispose()\` to release unused instances.`,
      ));
  let e = !1;
  if (!t.engine)
    throw new me("`engine` option is required for synchronous mode");
  const n = (t.langs || []).flat(1),
    r = (t.themes || []).flat(1).map(dn),
    s = new ql(t.engine, n),
    o = new zl(s, r, n, t.langAlias);
  let i;
  function l(m) {
    return fs(m, t.langAlias);
  }
  function a(m) {
    g();
    ...
    if (!_)
      throw new me(
        `Language \`${m}\` not found, you may need to load it first`,
      );
    return _;
  }
  function c(m) {
  ...
  async function C(...m) {
    return (g(), b(await Wl(m)));
  }
  function g() {
    if (e) throw new me("Shiki instance has been disposed");
  }
  function y() {
    e || ((e = !0), o.dispose(), (xe -= 1));
  }
  return {
    setTheme: u,
    getTheme: c,
...
function Vl(t) {
  ...
  return {
    ...
    codeToTokensBase: (n, r) => un(e, n, r),
    codeToTokensWithThemes: (n, r) => ds(e, n, r),
...
class ps {
  diff(e, n, r = {}) {
    ...
    typeof r == "function"
      ? ((s = r), (r = {}))
      : "callback" in r && (s = r.callback);
    const o = this.castInput(e, r),
      i = this.castInput(n, r),
      l = this.removeEmpty(this.tokenize(o, r)),
      a = this.removeEmpty(this.tokenize(i, r));
    return this.diffWithOptionsObj(l, a, r, s);
  }
  diffWithOptionsObj(e, n, r, s) {
    var o;
    const i = (y) => {
        if (((y = this.postProcess(y, r)), s)) {
          setTimeout(function () {
            s(y);
          }, 0);
          return;
    ...
    const h = (o = r.timeout) !== null && o !== void 0 ? o : 1 / 0,
      d = Date.now() + h,
      f = [{ oldPos: -1, lastComponent: void 0 }];
    let p = this.extractCommon(f[0], n, e, 0, r);
    if (f[0].oldPos + 1 >= a && p + 1 >= l)
      return i(this.buildValues(f[0].lastComponent, n, e));
    let b = -1 / 0,
      C = 1 / 0;
    const g = () => {
      for (let y = Math.max(b, -c); y <= Math.min(C, c); y += 2) {
        let m;
        const _ = f[y - 1],
          k = f[y + 1];
        _ && (f[y - 1] = void 0);
        ...
        const S = _ && _.oldPos + 1 < a;
        if (!I && !S) {
          f[y] = void 0;
          continue;
        }
        if (
          (!S || (I && _.oldPos < k.oldPos)
            ? (m = this.addToPath(k, !0, !1, 0, r))
            : (m = this.addToPath(_, !1, !0, 1, r)),
          (p = this.extractCommon(m, n, e, y, r)),
          m.oldPos + 1 >= a && p + 1 >= l)
        )
          return i(this.buildValues(m.lastComponent, n, e)) || !0;
        ((f[y] = m),
          m.oldPos + 1 >= a && (C = Math.min(C, y - 1)),
          p + 1 >= l && (b = Math.max(b, y + 1)));
      }
      c++;
    };
    if (s)
      (function y() {
        setTimeout(function () {
          if (c > u || Date.now() > d) return s(void 0);
          g() || y();
        }, 0);
      })();
    else
  ...
  addToPath(e, n, r, s, o) {
    ...
    return i && !o.oneChangePerToken && i.added === n && i.removed === r
      ? {
          oldPos: e.oldPos + s,
          lastComponent: {
            count: i.count + 1,
  ...
  extractCommon(e, n, r, s, o) {
    const i = n.length,
      l = r.length;
    let a = e.oldPos,
      c = a - s,
      u = 0;
    for (; c + 1 < i && a + 1 < l && this.equals(r[a + 1], n[c + 1], o); )
      (c++,
        a++,
        u++,
        o.oneChangePerToken &&
  ...
  equals(e, n, r) {
    return r.comparator
      ? r.comparator(e, n)
      : e === n || (!!r.ignoreCase && e.toLowerCase() === n.toLowerCase());
  }
  removeEmpty(e) {
    const n = [];
    ...
    for (; l < i; l++) {
      ...
      if (u.removed)
        ...
        if (!u.added && this.useLongestToken) {
          ...
          ((h = h.map(function (d, f) {
            const p = r[c + f];
            return p.length > d.length ? p : d;
          })),
            (u.value = this.join(h)));
        } else u.value = this.join(n.slice(a, a + u.count));
...
const Yl = new Ql();
function Jl(t, e, n) {
  return Yl.diff(t, e, n);
}
function ec(t = {}) {
  const {
      classPrefix: e = "__shiki_",
      classSuffix: n = "",
      classReplacer: r = (l) => l,
    } = t,
    s = new Map();
  ...
  function i(l) {
    const a = typeof l == "string" ? l : o(l);
    let c = e + tc(a) + n;
    return (
      (c = r(c)),
      s.has(c) || s.set(c, typeof l == "string" ? l : { ...l }),
      c
    );
  }
  return {
    ...
    pre(l) {
      if (!l.properties.style) return;
      const a = i(l.properties.style);
      (delete l.properties.style, this.addClassToHast(l, a));
    },
    tokens(l) {
      for (const a of l)
        for (const c of a) {
          if (!c.htmlStyle) continue;
...
function fn(t, e) {
  ...
  for (const n of t) {
    if (sr.has(n.name)) continue;
    let r = rr.get(n.name);
    (r == null && ((r = n), rr.set(n.name, r)),
      sr.add(r.name),
...
function gs(t, e) {
  ...
  for (let n of t) {
    let r;
    if (typeof n == "string") {
      if (((r = At.get(n)), r == null))
        throw new Error(
          `loadResolvedThemes: ${n} is not resolved, you must resolve it before calling loadResolvedThemes`,
        );
    } else ((r = n), (n = n.name), At.has(n) || At.set(n, r));
    or.has(n) || (or.add(n), e.loadThemeSync(r));
  }
}
function Me(t) {
  return t.replace(/\n$|\r\n$/, "");
...
function Rt({ tagName: t, children: e = [], properties: n = {} }) {
  return { type: "element", tagName: t, properties: n, children: e };
}
function rc(t) {
  let e = t.children[0];
  for (; e != null; ) {
    if (e.type === "element" && e.tagName === "code") return e;
    "children" in e ? (e = e.children[0]) : (e = null);
  }
}
function sc(t, e, n) {
  const r = typeof n.lineInfo == "function" ? n.lineInfo(e) : n.lineInfo[e - 1];
  if (r == null) {
    const s = `processLine: line ${e}, contains no state.lineInfo`;
    throw (console.error(s, { node: t, line: e, state: n }), new Error(s));
  }
  return (
    (t.tagName = "span"),
...
`),
    ...
    Rt({
      ...
      children: [
        Rt({
          ...
          children: [
            Rt({
              tagName: "span",
              children: [{ type: "text", value: `${r.lineNumber}` }],
      ...
      properties: {
        ...
        "data-alt-line": r.altLineNumber,
        "data-line-type": r.type,
        "data-line-index": r.lineIndex,
      },
    })
  );
}
function ms(t = !1) {
  const e = { lineInfo: [] },
    n = [
      {
        line(r) {
          return (delete r.properties.class, r);
        },
        pre(r) {
          const s = rc(r),
            o = [];
          if (s != null) {
            ...
            for (const l of s.children)
              l.type === "element" && (o.push(sc(l, i, e)), i++);
            s.children = o;
          }
          return r;
        },
  ...
  return (t && n.push(oc, ir), { state: e, transformers: n, toClass: ir });
}
const ir = ec({ classPrefix: "hl-" }),
  oc = {
    ...
    tokens(t) {
      for (const e of t)
        for (const n of e) {
          if (n.htmlStyle != null) continue;
          const r = {};
          (n.color != null && (r.color = n.color),
            n.bgColor != null && (r["background-color"] = n.bgColor),
            n.fontStyle != null &&
              n.fontStyle !== 0 &&
              ((n.fontStyle & 1) !== 0 && (r["font-style"] = "italic"),
              (n.fontStyle & 2) !== 0 && (r["font-weight"] = "bold"),
              (n.fontStyle & 4) !== 0 && (r["text-decoration"] = "underline")),
            Object.keys(r).length > 0 && (n.htmlStyle = r));
        }
    },
  };
function q(t) {
  return `--${t === "token" ? "diffs-token" : "diffs"}-`;
}
const Ee = {
  "1c": "1c",
  abap: "abap",
...
function Kt(t) {
  if (Ee[t] != null) return Ee[t];
  const e = t.match(/\.([^/\\]+\.[^/\\]+)$/);
  return e != null && Ee[e[1]] != null
    ? (Ee[e[1]] ?? "text")
    : (Ee[t.match(/\.([^.]+)$/)?.[1] ?? ""] ?? "text");
}
function ys({ theme: t = Be, highlighter: e, prefix: n }) {
  let r = "";
  if (typeof t == "string") {
    const s = e.getTheme(t);
    ((r += `color:${s.fg};`),
    ...
    let s = e.getTheme(t.dark);
    ((r += `${q("global")}dark:${s.fg};`),
      (r += `${q("global")}dark-bg:${s.bg};`),
      (r += Lt(s, "dark")),
      (s = e.getTheme(t.light)),
...
function Lt(t, e) {
  ...
  let n = "";
  const r =
    t.colors?.["gitDecoration.addedResourceForeground"] ??
    t.colors?.["terminal.ansiGreen"];
  r != null && (n += `${q("global")}${e}addition-color:${r};`);
  const s =
    t.colors?.["gitDecoration.deletedResourceForeground"] ??
    t.colors?.["terminal.ansiRed"];
  s != null && (n += `${q("global")}${e}deletion-color:${s};`);
  const o =
    t.colors?.["gitDecoration.modifiedResourceForeground"] ??
    t.colors?.["terminal.ansiBlue"];
  return (o != null && (n += `${q("global")}${e}modified-color:${o};`), n);
}
function Zt(t) {
  let e = t.children[0];
  for (; e != null; ) {
    if (e.type === "element" && e.tagName === "code") return e.children;
    "children" in e ? (e = e.children[0]) : (e = null);
  }
  throw (console.error(t), new Error("getLineNodes: Unable to find children"));
}
function ic({
  diff: t,
  diffStyle: e,
  ...
  const i = {
    ...
    unifiedCount: 0,
    shouldBreak() {
      if (!i.isWindowedHighlight) return !1;
      const c = i.unifiedCount >= n + r,
        u = i.splitCount >= n + r;
      return c && u;
    },
    shouldSkip(c, u) {
      if (!i.isWindowedHighlight) return !1;
      const h = i.unifiedCount + c < n,
        d = i.splitCount + u < n;
      return h && d;
    },
    incrementCounts(c, u) {
      ((i.unifiedCount += c), (i.splitCount += u));
    },
    isInWindow(c, u) {
      if (!i.isWindowedHighlight) return !0;
      const h = i.isInUnifiedWindow(c),
        d = i.isInSplitWindow(u);
      return h || d;
    },
    isInUnifiedWindow(c) {
      return (
        !i.isWindowedHighlight ||
        (i.unifiedCount >= n - c && i.unifiedCount < n + r)
      );
    },
    isInSplitWindow(c) {
      return (
        !i.isWindowedHighlight ||
        (i.splitCount >= n - c && i.splitCount < n + r)
      );
    },
    emit(c, u = !1) {
      return (u || i.incrementCounts(1, 1), o(c) ?? !1);
    },
  };
  e: for (const [c, u] of t.hunks.entries()) {
    let p = function (S, A) {
        return d == null || d.collapsedLines <= 0 || d.fromStart + d.fromEnd > 0
          ? 0
          : A === u.splitLineStart + u.splitLineCount - 1
            ? d.collapsedLines
            : 0;
      },
      b = function () {
        if (h.collapsedLines === 0) return 0;
        const S = h.collapsedLines;
        return ((h.collapsedLines = 0), S);
      };
    var l = p,
      a = b;
    if (i.shouldBreak()) break;
    const h = ar(t.isPartial, u.collapsedBefore, s, c),
      d = (() => {
        if (u !== i.finalHunk || !ac(t)) return;
        const S =
            t.additionLines.length - (u.additionLineIndex + u.additionCount),
          A = t.deletionLines.length - (u.deletionLineIndex + u.deletionCount);
        if (S !== A)
          throw new Error(
            `iterateOverDiff: trailing context mismatch (additions=${S}, deletions=${A}) for ${t.name}`,
          );
        const E = Math.min(S, A);
        return ar(t.isPartial, E, s, t.hunks.length);
      })(),
      f = h.fromStart + h.fromEnd;
    if (i.shouldSkip(f, f)) (i.incrementCounts(f, f), b());
    else {
      let S = u.unifiedLineStart - h.rangeSize,
        A = u.splitLineStart - h.rangeSize,
        E = u.deletionLineIndex - h.rangeSize,
        R = u.additionLineIndex - h.rangeSize,
        L = u.deletionStart - h.rangeSize,
        M = u.additionStart - h.rangeSize,
        $ = 0;
      for (; $ < h.fromStart; ) {
        if (i.isInWindow(0, 0)) {
          if (
            i.emit({
              ...
              collapsedBefore: 0,
              collapsedAfter: 0,
              unifiedDeletionLineIndex: S + $,
              unifiedAdditionLineIndex: S + $,
              splitLineIndex: A + $,
              deletionLineIndex: E + $,
              additionLineIndex: R + $,
              deletionLineNumber: L + $,
              additionLineNumber: M + $,
    ...
    let C = u.unifiedLineStart,
      g = u.splitLineStart,
      y = u.deletionLineIndex,
      m = u.additionLineIndex,
      _ = u.deletionStart,
      k = u.additionStart;
    const I = u.hunkContent.at(-1);
    for (const S of u.hunkContent) {
      if (i.shouldBreak()) break e;
      const A = S === I;
      if (S.type === "context") {
        if (i.shouldSkip(S.lines, S.lines))
          (i.incrementCounts(S.lines, S.lines), b());
        else {
          let E = 0;
          for (; E < S.lines; ) {
            if (i.isInWindow(0, 0)) {
              ...
              if (
                i.emit({
                  ...
                  hunk: u,
                  collapsedBefore: b(),
                  collapsedAfter: p(L, M),
                  unifiedDeletionLineIndex: L,
                  unifiedAdditionLineIndex: L,
                  splitLineIndex: M,
                  deletionLineIndex: y + E,
                  additionLineIndex: m + E,
                  deletionLineNumber: _ + E,
                  additionLineNumber: k + E,
                  type: "context",
                  noEOFCRAddition: R && u.noEOFCRAdditions,
                  noEOFCRDeletion: R && u.noEOFCRDeletions,
                })
              )
                break e;
            } else i.incrementCounts(1, 1);
    ...
    if (d != null) {
      const { collapsedLines: S, fromStart: A, fromEnd: E } = d,
        R = A + E;
      let L = 0;
      for (; L < R; ) {
        if (i.shouldBreak()) break e;
        if (i.isInWindow(0, 0)) {
          ...
          if (
            i.emit({
              hunkIndex: t.hunks.length,
              hunk: void 0,
              collapsedBefore: 0,
              collapsedAfter: M ? S : 0,
              unifiedDeletionLineIndex: C + L,
              unifiedAdditionLineIndex: C + L,
              splitLineIndex: g + L,
              additionLineIndex: m + L,
              deletionLineIndex: y + L,
              additionLineNumber: k + L,
              deletionLineNumber: _ + L,
              type: "context-expanded",
              noEOFCRAddition: !1,
              noEOFCRDeletion: !1,
            })
...
function ar(t, e, n, r) {
  if (((e = Math.max(e, 0)), e === 0 || t))
    return {
      fromStart: 0,
      fromEnd: 0,
      rangeSize: e,
      collapsedLines: Math.max(e, 0),
    };
  if (n === !0)
    return { fromStart: e, fromEnd: 0, rangeSize: e, collapsedLines: 0 };
  const s = n?.get(r),
    o = Math.min(Math.max(s?.fromStart ?? 0, 0), e),
    i = Math.min(Math.max(s?.fromEnd ?? 0, 0), e),
    l = o + i,
    a = l >= e;
  return {
    fromStart: a ? e : o,
    fromEnd: a ? 0 : i,
    rangeSize: e,
    collapsedLines: Math.max(e - l, 0),
  };
}
function ac(t) {
  const e = t.hunks.at(-1);
  return e == null ||
    t.isPartial ||
    t.additionLines.length === 0 ||
    t.deletionLines.length === 0
    ? !1
    : e.additionLineIndex + e.additionCount < t.additionLines.length ||
        e.deletionLineIndex + e.deletionCount < t.deletionLines.length;
}
function lc(t, e, n) {
  if (!t.isWindowedHighlight) return [[0, Math.max(e.deletions, e.additions)]];
  const r = [];
  function s(a, c) {
    if (a + c <= t.viewportStart || a >= t.viewportEnd) return;
    const u = Math.max(0, t.viewportStart - a),
      h = Math.min(c, t.viewportEnd - a);
  ...
  r.sort((a, c) => a[0] - c[0]);
  const l = [r[0]];
  for (const [a, c] of r.slice(1)) {
    const u = l[l.length - 1];
    a <= u[1] ? (u[1] = Math.max(u[1], c)) : l.push([a, c]);
  }
  return l;
}
function cc({
  ...
  return {
    ...
    collapsedAfter: n,
    collapsedBefore: r,
    unifiedDeletionLineIndex: o < d.deletions ? i + o : void 0,
    unifiedAdditionLineIndex: o < d.additions ? i + d.deletions + o : void 0,
    splitLineIndex: l + o,
    additionLineIndex: o < d.additions ? a + o : void 0,
    additionLineNumber: o < d.additions ? u + o : void 0,
    deletionLineIndex: o < d.deletions ? c + o : void 0,
    deletionLineNumber: o < d.deletions ? h + o : void 0,
    noEOFCRDeletion: f && o === b - 1 && e.noEOFCRDeletions,
    noEOFCRAddition: f && o === b - 1 && e.noEOFCRAdditions,
  };
}
function lr({ line: t, spanStart: e, spanLength: n }) {
  return {
    start: { line: t, character: e },
    end: { line: t, character: e + n },
...
function He({
  ...
  if (o == null || s || !n) {
    e.push([r ? 0 : 1, t.value]);
    return;
  }
  const i = o[0] === 0;
  if (r === i || (r && t.value.length === 1 && !i)) {
    o[1] += t.value;
    return;
  }
  e.push([r ? 0 : 1, t.value]);
}
const uc = { forcePlainText: !1 };
function hc(
  t,
  e,
  n,
  { forcePlainText: r, startingLine: s, totalLines: o, expandedHunks: i } = uc,
) {
  r ? ((s ??= 0), (o ??= 1 / 0)) : ((s = 0), (o = 1 / 0));
  const l = s > 0 || o < 1 / 0,
    a = (() => {
      const g = n.theme ?? Be;
      if (typeof g == "string") return e.getTheme(g).type;
    })(),
    c = ys({ theme: n.theme, highlighter: e }),
    u =
      r && !l && (t.unifiedLineCount > 1e3 || t.splitLineCount > 1e3)
        ? "none"
        : n.lineDiffType,
    h = { deletionLines: [], additionLines: [] },
    d = !r && !t.isPartial,
    f = r ? i : void 0,
    p = new Map();
  function b(g) {
  ...
  function C(g, y, m, _) {
    if (l) {
      let k = m.at(-1);
      ((k == null || k.targetIndex + k.count !== y) &&
  ...
  ic({
    ...
    callback: ({
      ...
      deletionLineNumber: k,
      unifiedAdditionLineIndex: I,
      unifiedDeletionLineIndex: S,
      splitLineIndex: A,
      type: E,
    }) => {
      ...
      (E === "change" &&
        ...
        m != null &&
        dc({
          additionLine: t.additionLines[y],
          deletionLine: t.deletionLines[m],
          deletionLineIndex: R.deletionContent.length,
          additionLineIndex: R.additionContent.length,
          deletionDecorations: R.deletionDecorations,
          additionDecorations: R.additionDecorations,
          lineDiffType: u,
        }),
        m != null &&
          k != null &&
          S != null &&
          (C(t.deletionLines[m], m, R.deletionSegments, R.deletionContent),
          R.deletionInfo.push({
            type: E === "change" ? "change-deletion" : E,
            lineNumber: k,
            altLineNumber: E === "change" ? void 0 : (_ ?? void 0),
            lineIndex: `${S},${A}`,
          })),
        y != null &&
          _ != null &&
          I != null &&
          (C(t.additionLines[y], y, R.additionSegments, R.additionContent),
          R.additionInfo.push({
            type: E === "change" ? "change-addition" : E,
            lineNumber: _,
            altLineNumber: E === "change" ? void 0 : (k ?? void 0),
            lineIndex: `${I},${A}`,
          })));
    },
  });
  for (const g of p.values()) {
    ...
    const y = { name: t.prevName ?? t.name, contents: g.deletionContent.value },
      m = { name: t.name, contents: g.additionContent.value },
      { deletionLines: _, additionLines: k } = pc({
        deletionFile: y,
        deletionInfo: g.deletionInfo,
        deletionDecorations: g.deletionDecorations,
        additionFile: m,
        additionInfo: g.additionInfo,
        additionDecorations: g.additionDecorations,
        highlighter: e,
        options: n,
        languageOverride: r ? "text" : t.lang,
      });
    if (d) {
      ((h.deletionLines = _), (h.additionLines = k));
      continue;
    }
    if (g.deletionSegments.length > 0)
      for (const I of g.deletionSegments)
        for (let S = 0; S < I.count; S++)
          h.deletionLines[I.targetIndex + S] = _[I.originalOffset + S];
    else h.deletionLines.push(..._);
    if (g.additionSegments.length > 0)
      for (const I of g.additionSegments)
        for (let S = 0; S < I.count; S++)
          h.additionLines[I.targetIndex + S] = k[I.originalOffset + S];
    else h.additionLines.push(...k);
  }
...
function dc({
  ...
  deletionLineIndex: n,
  additionLineIndex: r,
  deletionDecorations: s,
  additionDecorations: o,
  lineDiffType: i,
}) {
  if (t == null || e == null || i === "none") return;
  ((t = Me(t)), (e = Me(e)));
  const l = i === "char" ? Zl(t, e) : Jl(t, e),
    a = [],
    c = [],
    u = i === "word-alt",
    h = l.at(-1);
  for (const f of l) {
    const p = f === h;
    !f.added && !f.removed
      ? (He({ item: f, arr: a, enableJoin: u, isNeutral: !0, isLastItem: p }),
        He({ item: f, arr: c, enableJoin: u, isNeutral: !0, isLastItem: p }))
      : f.removed
  ...
  for (const f of a)
    (f[0] === 1 &&
      s.push(lr({ line: n, spanStart: d, spanLength: f[1].length })),
      (d += f[1].length));
  d = 0;
  for (const f of c)
    (f[0] === 1 &&
      o.push(lr({ line: r, spanStart: d, spanLength: f[1].length })),
      (d += f[1].length));
}
function fc() {
  return {
...
function pc({
  ...
  additionDecorations: i,
  languageOverride: l,
  options: { theme: a = Be, ...c },
}) {
  const u = l ?? Kt(t.name),
    h = l ?? Kt(e.name),
    { state: d, transformers: f } = ms(),
    p =
      typeof a == "string"
        ? {
            ...c,
    ...
    deletionLines:
      t.contents === ""
        ...
        : ((p.lang = u),
          (d.lineInfo = n),
          (p.decorations = o),
          Zt(s.codeToHast(Me(t.contents), p))),
    additionLines:
      e.contents === ""
        ? []
        : ((p.lang = h),
          (p.decorations = i),
          (d.lineInfo = r),
          Zt(s.codeToHast(Me(e.contents), p))),
  };
}
function gc(t, e, { theme: n = Be, tokenizeMaxLineLength: r }, s = !1) {
  const { state: o, transformers: i } = ms(),
    l = s ? "text" : (t.lang ?? Kt(t.name)),
    a = (() => {
      if (typeof n == "string") return e.getTheme(n).type;
    })(),
    c = ys({ theme: n, highlighter: e });
  o.lineInfo = (h) => ({ type: "context", lineIndex: h - 1, lineNumber: h });
  const u =
    typeof n == "string"
      ? {
          lang: l,
  ...
  return {
    code: Zt(e.codeToHast(Me(t.contents), u)),
    themeStyles: c,
    baseThemeType: a,
  };
}
let cr,
  Ce = { theme: Be, tokenizeMaxLineLength: 1e3, lineDiffType: "word-alt" };
self.addEventListener("error", (t) => {
  console.error("[Shiki Worker] Unhandled error:", t.error);
});
self.addEventListener("message", (t) => {
  ...
  try {
    ...
    (console.error("Worker error:", n), Sc(e.id, n));
  }
});
function mc({
  id: t,
...
function yc({ id: t, renderOptions: e, resolvedThemes: n }) {
  (gs(n, dt()),
    (Ce = e),
    postMessage({
      type: "success",
...
function bc({ id: t, file: e, resolvedLanguages: n }) {
  const r = dt();
  n != null && fn(n, r);
  const s = {
    theme: Ce.theme,
    tokenizeMaxLineLength: Ce.tokenizeMaxLineLength,
  };
  Cc(t, gc(e, r, s), s);
}
function wc({ id: t, diff: e, resolvedLanguages: n }) {
  const r = dt();
  (n != null && fn(n, r), _c(t, hc(e, r, Ce), Ce));
}
function dt() {
  return ((cr ??= Vl({ themes: [], langs: [], engine: si() })), cr);
}
function Cc(t, e, n) {
  postMessage({
    type: "success",
