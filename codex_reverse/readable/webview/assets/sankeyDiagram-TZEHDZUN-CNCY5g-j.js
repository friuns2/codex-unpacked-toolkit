  ...
  ((v.update = function (n) {
    ...
    (v.nodeId = function (n) {
      return arguments.length
        ? ((k = typeof n == "function" ? n : q(n)), v)
        : k;
    }),
    (v.nodeAlign = function (n) {
      return arguments.length
        ? ((s = typeof n == "function" ? n : q(n)), v)
        : s;
    }),
    ...
    (v.nodes = function (n) {
      return arguments.length
        ? ((_ = typeof n == "function" ? n : q(n)), v)
        : _;
    }),
    (v.links = function (n) {
      return arguments.length
        ? ((x = typeof n == "function" ? n : q(n)), v)
        : x;
    }),
...
function Yt(t) {
  ...
  return (
    ...
    (p.x = function (k) {
      return arguments.length
        ? ((a = typeof k == "function" ? k : dt(+k)), p)
        : a;
    }),
    (p.y = function (k) {
      return arguments.length
        ? ((h = typeof k == "function" ? k : dt(+k)), p)
        : h;
    }),
...
var K = at,
  ...
  le = g(function (t, e, i, a) {
    const { securityLevel: h, sankey: b } = lt(),
      p = Lt.sankey;
    let k;
    h === "sandbox" && (k = X("#i" + e));
    const s =
        h === "sandbox" ? X(k.nodes()[0].contentDocument.body) : X("body"),
      o = h === "sandbox" ? s.select(`[id="${e}"]`) : X(`[id="${e}"]`),
      l = b?.width ?? p.width,
      _ = b?.height ?? p.width,
      x = b?.useMaxWidth ?? p.useMaxWidth,
      y = b?.nodeAlignment ?? p.nodeAlignment,
      v = b?.prefix ?? p.prefix,
      M = b?.suffix ?? p.suffix,
      T = b?.showValues ?? p.showValues,
      N = a.db.getGraph(),
      C = ae[y];
    Bt()
      .nodeId((d) => d.id)
    ...
    o.append("g")
      ...
      .join("g")
      .attr("class", "node")
      .attr("id", (d) => (d.uid = gt.next("node-")).id)
...
${v}${Math.round(E * 100) / 100}${M}`
    ...
    switch (O) {
      case "gradient":
        D = g((d) => d.uid, "coloring");
        break;
      case "source":
        D = g((d) => S(d.source.id), "coloring");
        break;
      case "target":
        D = g((d) => S(d.target.id), "coloring");
        break;
      default:
        D = O;
    }
...
//# sourceMappingURL=sankeyDiagram-TZEHDZUN-CNCY5g-j.js.map
