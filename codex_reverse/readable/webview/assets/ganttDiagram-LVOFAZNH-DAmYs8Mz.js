...
import {
  ...
  a as Gn,
  l as Qn,
} from "./linear-LHrec7-C.js";
import { i as $n } from "./init-Gi6I4Gst.js";
...
function on(t, e) {
  ...
  function C(x) {
    var X = r ?? (e.ticks ? e.ticks.apply(e, n) : e.domain()),
      ...
      V = +I[0] + _,
      W = +I[I.length - 1] + _,
      q = (e.bandwidth ? rr : nr)(e.copy(), _),
      $ = x.selection ? x.selection() : x,
      D = $.selectAll(".domain").data([null]),
      H = $.selectAll(".tick").data(X, e).order(),
      b = H.exit(),
...
function fa(t, e) {
  return B(1 + Ce.count(bt(t), t), e, 3);
}
function bn(t, e) {
...
var Ci = h(function () {
  ...
  _i = h(function (t, e, n, r) {
    ...
    i === "sandbox" && (s = qt("#i" + e));
    const y =
        i === "sandbox" ? qt(s.nodes()[0].contentDocument.body) : qt("body"),
...
//# sourceMappingURL=ganttDiagram-LVOFAZNH-DAmYs8Mz.js.map
