import { G as g } from "./graph-Bl_xYyBC.js";
import {
  b as Te,
  p as ce,
  q as le,
...
function an(e, n, r) {
  for (
    var t = -1, a = e.criteria, i = n.criteria, o = a.length, u = r.length;
    ++t < o;
  ) {
    var d = tn(a[t], i[t]);
    if (d) {
...
function te(e, n, r, t) {
  ...
  return (
    arguments.length >= 4 && ((a.rank = r), (a.order = t)),
    L(e, "border", a, n)
  );
}
function me(e) {
...
function _n(e) {
  function n(r) {
    var t = e.children(r),
      a = e.node(r);
    if (
      (t.length && f(t, n), Object.prototype.hasOwnProperty.call(a, "minRank"))
    ) {
...
function ur(e) {
  ...
  function r(i) {
    return function (o) {
      o.merged ||
        ((m(o.barycenter) || m(i.barycenter) || o.barycenter >= i.barycenter) &&
          dr(i, o));
    };
  }
  function t(i) {
...
function _e(e, n, r, t) {
  ...
  f(s, function (p) {
    if (e.children(p.v).length) {
      var b = _e(e, p.v, r, t);
      ((d[p.v] = b),
        Object.prototype.hasOwnProperty.call(b, "barycenter") && lr(p, b));
    }
  });
  var c = or(s, r);
  cr(c, d);
  ...
  if (o && ((l.vs = O([o, l.vs, u])), e.predecessors(o).length)) {
    ...
    (Object.prototype.hasOwnProperty.call(l, "barycenter") ||
      ((l.barycenter = 0), (l.weight = 0)),
      (l.barycenter =
        (l.barycenter * l.weight + h.order + v.order) / (l.weight + 2)),
      (l.weight += 2));
  }
  return l;
}
    ...
    return (
      f(o, function (c, l) {
        if (e.node(c).dummy === "border") {
          ...
          h.length &&
            ((d = e.node(h[0]).order), t(o, s, l, u, d), (s = l), (u = d));
        }
    ...
    f(n, function (u) {
      ...
      f(u, function (s) {
        ...
        if (c.length) {
          ...
          for (
            var l = (c.length - 1) / 2, h = Math.floor(l), v = Math.ceil(l);
            h <= v;
            ++h
          ) {
            var p = c[h];
...
function Er(e, n, r, t, a) {
  ...
  function d(l, h) {
    for (var v = o.nodes(), p = v.pop(), b = {}; p; )
      (b[p] ? l(p) : ((b[p] = !0), v.push(p), (v = v.concat(h(p)))),
        (p = v.pop()));
  }
  function s(l) {
...
function _r(e, n, r) {
  return function (t, a, i) {
    var o = t.node(a),
      ...
      s;
    if (
      ((d += o.width / 2), Object.prototype.hasOwnProperty.call(o, "labelpos"))
    )
...
export { ot as l };
//# sourceMappingURL=layout-ENxq1fHm.js.map
